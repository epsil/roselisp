 ...
 */
declare function wrapInEstree(x: any, recursive?: any): any;
declare namespace wrapInEstree {
    var fsource: (symbol | (symbol | (boolean | symbol)[])[] | (symbol | (symbol | symbol[])[] | (symbol | (symbol | (symbol | symbol[])[])[])[][])[])[];
}
/**
 ...
 * of Lisp's `quote`.
 */
declare function estreeQuote(x: any): any;
declare namespace estreeQuote {
    var fsource: (symbol | symbol[])[];
}
/**

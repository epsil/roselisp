...
import { and_, cljTry_, defineMacro_, definePublic_, for_, or_, setq_, try_ } from './macros';
...
declare namespace decompile {
    var fsource: (symbol | (symbol | (string | symbol | symbol[])[])[])[];
}
/**
 * Compile a Lisp expression to JavaScript or TypeScript
...
declare namespace compileWithEnvironment {
    var fsource: (symbol | (symbol | (symbol | (symbol | (symbol | (symbol | symbol[])[])[])[])[])[] | (symbol | (boolean | symbol)[])[])[];
}
/**
...
declare namespace compileFilesX {
    var fsource: (symbol | (symbol | (string | symbol | (string | symbol)[])[])[] | (symbol | (symbol | (symbol | (symbol | (symbol | (symbol | (string | symbol | (string | symbol)[])[])[])[])[])[])[] | (symbol | (symbol | (boolean | symbol)[] | (symbol | (symbol | (symbol | (string | symbol)[])[])[] | (symbol | (symbol | symbol[])[] | (boolean | symbol)[])[])[])[])[])[] | (symbol | (symbol | (string | symbol | symbol[])[])[] | (symbol | (boolean | symbol)[])[])[])[];
}
/**
 * Compile a file.
 * This function writes to disk.
...
declare namespace interpret {
    var fsource: (symbol | (symbol | (string | symbol | symbol[])[])[] | (symbol | (symbol | (string | boolean | symbol)[])[])[])[];
}
/**
...
declare namespace interpretFiles {
    var fsource: (symbol | (symbol | (symbol | symbol[])[] | (symbol | undefined)[])[] | (symbol | (symbol | (symbol | (symbol | (string | symbol | (string | symbol)[])[])[])[])[])[])[];
}
/**
 * Interpret a string of Lisp code.
...
declare namespace macroexpandAllUntil {
    var fsource: (symbol | (symbol | (symbol | (symbol | (symbol | (symbol | symbol[])[])[])[])[] | (symbol | (symbol | (boolean | symbol)[])[])[])[] | (symbol | (symbol | undefined)[] | (symbol | (symbol | never[])[])[])[])[];
}
/**
...
declare namespace sendMethod {
    var fsource: (symbol | (symbol | (symbol | (symbol | (symbol | (string | symbol)[])[])[])[] | (string | symbol | symbol[])[][])[])[];
}
/**
 ...
 */
declare function jsRaw_(str: any): any;
declare namespace jsRaw_ {
...
declare namespace mapRose {
    var fsource: (symbol | (symbol | (symbol | symbol[])[] | (symbol | symbol[])[][])[] | (symbol | (symbol | (symbol | never[])[])[])[])[];
}
/**
 ...
 */
declare function optimizeSyntax(exp: any, env: any): any;
declare namespace optimizeSyntax {
    var fsource: (symbol | symbol[])[];
}
/**
 * Optimize a module.

...
function compileColon(node, env, options = {}) {
    ...
    if (continuationEnv) {
        continuationEnv.setLocalType(symExp, typeExp);
    }
    return compileNop(node, env, options);
}
compileColon.fsource = [Symbol.for('define'), [Symbol.for('compile-colon'), Symbol.for('node'), Symbol.for('env'), [Symbol.for('options'), [Symbol.for('js-obj')]]], [Symbol.for('define'), Symbol.for('continuation-env'), [Symbol.for('oget'), Symbol.for('options'), 'continuationEnv']], [Symbol.for('define'), Symbol.for('sym'), [Symbol.for('send'), Symbol.for('node'), Symbol.for('get'), 1]], [Symbol.for('define'), Symbol.for('sym-exp'), [Symbol.for('send'), Symbol.for('sym'), Symbol.for('get-value')]], [Symbol.for('define'), Symbol.for('type_'), [Symbol.for('send'), Symbol.for('node'), Symbol.for('get'), 2]], [Symbol.for('define'), Symbol.for('type-exp'), [Symbol.for('send'), Symbol.for('type_'), Symbol.for('get-value')]], [Symbol.for('when'), Symbol.for('continuation-env'), [Symbol.for('send'), Symbol.for('continuation-env'), Symbol.for('set-local-type'), Symbol.for('sym-exp'), Symbol.for('type-exp')]], [Symbol.for('compile-nop'), Symbol.for('node'), Symbol.for('env'), Symbol.for('options')]];
/**
...
function compileDefine(node, env, options = {}) {
    ...
    if (Array.isArray((Array.isArray(exp) && (exp.length >= 3) && (exp[exp.length - 2] === Symbol.for('.')) && (() => {
        ...
        const declaredType = continuationEnv.getType(sym);
        ...
        if (continuationEnv.has(sym, {
            ...
            type_ = continuationEnv.getType(sym);
        }
        else {
            continuationEnv.setLocal((Array.isArray(exp) && (exp.length >= 3) && (exp[exp.length - 2] === Symbol.for('.')) && (() => {
                const x = lastCdr(exp);

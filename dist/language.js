...
function compileTypeExp(exp, env, options = {}) {
    if (typeof exp === 'symbol') {
        ...
        let restParam = (0, plist_1.plistGet_)(plist, Symbol.for(':rest'));
        let pos = 0;
...
compileJsIsStrictlyEqual.fsource = [Symbol.for('define'), [Symbol.for('compile-js-is-strictly-equal'), Symbol.for('node'), Symbol.for('env'), [Symbol.for('options'), [Symbol.for('js-obj')]]], [Symbol.for('compile-binary-expression'), Symbol.for('node'), Symbol.for('env'), Symbol.for('options'), [Symbol.for('js-obj'), 'identity', true, 'operator', '===']]];
/**
 * Compile a `(js/== ...)` expression.
 */
...
compileJsIsLooselyEqual.fsource = [Symbol.for('define'), [Symbol.for('compile-js-is-loosely-equal'), Symbol.for('node'), Symbol.for('env'), [Symbol.for('options'), [Symbol.for('js-obj')]]], [Symbol.for('compile-binary-expression'), Symbol.for('node'), Symbol.for('env'), Symbol.for('options'), [Symbol.for('js-obj'), 'identity', true, 'operator', '==']]];
/**
...
compileRegexpMacro.fsource = [Symbol.for('define'), [Symbol.for('compile-regexp-macro'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define-values'), Symbol.for('args'), [Symbol.for('rest'), Symbol.for('exp')]], [Symbol.for('quasiquote'), [Symbol.for('new'), Symbol.for('RegExp'), [Symbol.for('unquote-splicing'), Symbol.for('args')]]]];
...
block_.fsource = [Symbol.for('define'), [Symbol.for('block_'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('compile-sexp'), Symbol.for('exp'), Symbol.for('env'), [Symbol.for('current-compilation-options')]]];
block_.ftype = 'macro';
/**
...
exports.scmNew = new_;
exports.new_ = new_;
new_.fsource = [Symbol.for('define'), [Symbol.for('new_'), Symbol.for('constructor'), Symbol.for('.'), Symbol.for('args')], [Symbol.for('apply'), Symbol.for('make-object'), Symbol.for('constructor'), Symbol.for('args')]];
/**
...
function mapVisitRose(f, node, env = new env_1.LispEnvironment(), stack = [], bindings = new env_1.LispEnvironment()) {
    ...
    visitMakeObjectP.fsource = [Symbol.for('define'), [Symbol.for('visit-make-object-p'), Symbol.for('node')], [Symbol.for('form?'), Symbol.for('node'), Symbol.for('new_'), Symbol.for('env')]];

...
const [interpret, flatten, buildList, keywordp, makeList, selfEvaluatingP, findf] = (() => {
    function interpret_(exp, ...options) {
        const options1 = ((options.length >= 1) && (options[0] instanceof env_1.Environment)) ? Object.assign({ environment: options[0] }, normalizeOptions(options.slice(1))) : normalizeOptions(options);
        let env = options1['environment'] || (0, env_1.defaultEnvironment)();
        const expressionType = options1['expressionType'] || 'statement';
        const inheritedOptions = Object.assign(Object.assign({}, options1), { case: 'none', expressionType, estree: true, shouldImport: false });
    ...
    return [interpret_, flatten_, buildList_, keywordp_, makeList_, selfEvaluatingP_, findf_];
})();
/**
 ...
 */
const inlinedFunctions = [procedures_1.abs_, procedures_1.add1_, procedures_1.arity_, array_1.arrayAt_, array_1.arrayCopy_, array_1.arrayEighth_, array_1.arrayFifth_, array_1.arrayFirst_, array_1.arrayFourth_, array_1.arrayLast_, array_1.arrayLength_, array_1.arrayNinth_, array_1.arrayNlast_, array_1.arrayPopLeftX_, array_1.arrayPopRightX_, array_1.arrayRest_, array_1.arrayReverseX_, array_1.arrayReverse_, array_1.arraySecond_, array_1.arraySeventh_, array_1.arraySixth_, array_1.arraySlice_, array_1.arrayTake_, array_1.arrayTenth_, array_1.arrayThird_, array_1.arrayp_, procedures_1.atomp_, procedures_1.booleanp_, procedures_1.const_, list_1.dottedListHead_, list_1.dottedListTail_, list_1.dottedListP_, list_1.dottedPairP_, equal_1.eqp_, equal_1.eqvp_, procedures_1.error_, procedures_1.evenp_, procedures_1.falsep_, object_1.fieldNames_, procedures_1.filter_, procedures_1.findfIndex_, procedures_1.forEach_, thunk_1.force_, symbol_1.gensymp_, symbol_1.gensym_, hash_1.hashToList_, hash_1.hashClearX_, hash_1.hashCopy_, hash_1.hashEntries_, hash_1.hashHasKeyP_, hash_1.hashKeys_, hash_1.hashRemoveX_, hash_1.hashSetX_, hash_1.hashSize_, hash_1.hashValues_, hash_1.hashp_, procedures_1.indexWhere_, procedures_1.isAP_, javascript_1.jsAbs_, javascript_1.jsAnd_, javascript_1.jsArrayP_, javascript_1.jsBitwiseAnd_, javascript_1.jsBitwiseNot_, javascript_1.jsBitwiseOr_, javascript_1.jsBitwiseShiftLeft_, javascript_1.jsBitwiseShiftRight_, javascript_1.jsBitwiseXor_, javascript_1.jsFindIndex_, javascript_1.jsFunctionObjectP_, javascript_1.jsFunctionTypeP_, javascript_1.jsFunctionP_, javascript_1.jsIn_, javascript_1.jsInstanceof_, javascript_1.jsKeys_, javascript_1.jsLength_, javascript_1.jsNanP_, javascript_1.jsNullP_, javascript_1.jsObjP_, javascript_1.jsObjectTypeP_, javascript_1.jsOr_, javascript_1.jsReduceRight_, javascript_1.jsReduce_, javascript_1.jsRegexpMatch_, javascript_1.jsRegexpReplace_, javascript_1.jsRegexpP_, javascript_1.jsSameValueP_, javascript_1.jsSlice_, javascript_1.jsSource_, javascript_1.jsStringLiteralP_, javascript_1.jsStringObjectP_, javascript_1.jsStringP_, javascript_1.jsToString_, javascript_1.jsTypeof_, javascript_1.jsUnsignedBitwiseShiftRight_, procedures_1.memfp_, procedures_1.memqp_, list_1.nullp_, string_1.numberToString_, procedures_1.numberp_, object_1.objectRef_, procedures_1.oddp_, procedures_1.onep_, list_1.pairp_, plist_1.plistCopy_, plist_1.plistp_, list_1.popLeftX_, list_1.popRightX_, procedures_1.procedurep_, thunk_1.promiseForcedP_, thunk_1.promiseRunningP_, thunk_1.promisep_, list_1.pushLeftX_, list_1.pushRightX_, regexp_1.regexpMatchP_, regexp_1.regexpMatch_, regexp_1.regexpQuote_, regexp_1.regexpReplace_, regexp_1.regexpp_, list_1.reversex_, scmEval_, string_1.stringToNumber_, symbol_1.stringToSymbol_, string_1.stringDowncase_, string_1.stringJoin_, string_1.stringLength_, string_1.stringRef_, string_1.stringRepeat_, string_1.stringSplit_, string_1.stringUpcase_, procedures_1.sub1_, symbol_1.symbolToString_, symbol_1.symbolp_, thunk_1.thunkp_, procedures_1.truep_, procedures_1.typeOf_, procedures_1.undefinedp_, procedures_1.zerop_];
/**
 ...
 */
const compilationVariablesEnv = new CompilationEnvironment([[Symbol.for('#f'), new estree_1.Literal(false), Symbol.for('Any')], [Symbol.for('#t'), new estree_1.Literal(true), Symbol.for('Any')], [Symbol.for('#n'), new estree_1.Literal(null), Symbol.for('Any')], [Symbol.for('#u'), new estree_1.Identifier('undefined'), Symbol.for('Any')], [Symbol.for('js-null'), new estree_1.Literal(null), Symbol.for('Any')], [Symbol.for('js-undefined'), new estree_1.Identifier('undefined'), Symbol.for('Any')], [Symbol.for('js/arguments'), new estree_1.Identifier('arguments'), Symbol.for('Any')], [Symbol.for('js/null'), new estree_1.Literal(null), Symbol.for('Any')], [Symbol.for('js/require'), new estree_1.Identifier('require'), Symbol.for('Any')], [Symbol.for('js/undefined'), new estree_1.Identifier('undefined'), Symbol.for('Any')], [Symbol.for('nil'), new estree_1.ArrayExpression(), Symbol.for('Any')], [Symbol.for('null'), new estree_1.ArrayExpression(), Symbol.for('Any')], [Symbol.for('t'), new estree_1.Literal(true), Symbol.for('Any')], [Symbol.for('undefined'), new estree_1.Identifier('undefined'), Symbol.for('Any')]]);
/**
 * Compiler procedures mapping environment.
 */
const compilationCompilerMappingEnv = new CompilationEnvironment([[procedures_1.add_, compileAdd, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [ann_, compileAnn, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [list_1.append_, compileAppend, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [procedures_1.apply_, compileApply, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [begin_, compileBegin, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [break_, compileBreak, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [class_, compileClass, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [colon_, compileColon, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [continue_, compileContinue, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [macros_1.declare_, compileDeclare, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [defineAsync_, compileDefineAsync, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [defineClass_, compileDefineClass, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [defineFields_, compileDefineFields, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [defineGenerator_, compileDefineGenerator, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [defineType_, compileDefineType, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [defineValues_, compileDefineValues, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [define_, compileDefine, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [procedures_1.div_, compileDiv, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [dot_, compileSend, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [procedures_1.funcall_, compileFuncall, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [procedures_1.gt_, compileGreaterThan, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [procedures_1.gte_, compileGreaterThanOrEqual, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [if_, compileIf, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [jsArrow_, compileJsArrow, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [jsAssignment_, compileJsAssignment, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [jsAsync_, compileJsAsync, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [jsAwait_, compileJsAwait, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [jsBlock_, compileJsBlock, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [jsConst_, compileJsConst, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [javascript_1.jsDelete_, compileJsDelete, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [jsDoWhile_, compileJsDoWhile, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [javascript_1.jsDot_, compileJsDot, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [javascript_1.jsEval_, compileJsEval, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [jsForIn_, compileJsForIn, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [jsForOf_, compileJsForOf, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [jsFor_, compileJsFor, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [jsFunction_, compileJsFunction, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [javascript_1.jsGet_, compileJsGet, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [javascript_1.jsGt_, compileGreaterThan, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [javascript_1.jsGte_, compileGreaterThanOrEqual, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [jsIf_, compileJsIf, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [jsLet_, compileJsLet, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [javascript_1.jsLooselyEqualP_, compileJsLooselyEqual, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [javascript_1.jsLt_, compileLessThan, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [javascript_1.jsLte_, compileLessThanOrEqual, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [javascript_1.jsMod_, compileModulo, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [javascript_1.jsNew_, compileJsNew, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [javascript_1.jsNot_, compileNot, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [javascript_1.jsObjAppend_, compileJsObjAppend, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [javascript_1.jsObjSpread_, compileJsObjSpread, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [javascript_1.jsObj_, compileJsObj, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [jsOp_, compileJsOp, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [javascript_1.jsOptionalChaining_, compileJsOptionalChaining, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [javascript_1.jsPlus_, compileAdd, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [jsRaw_, compileJsRaw, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [javascript_1.jsReturn_, compileReturn, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [jsSequence_, compileJsSequence, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [jsStatementOrExpression_, compileJsStatementOrExpression, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [javascript_1.jsStrictlyEqualP_, compileJsStrictlyEqual, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [jsSwitch_, compileJsSwitch, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [javascript_1.jsTaggedTemplate_, compileJsTaggedTemplate, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [jsTernaryOperator_, compileJsTernaryOperator, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [jsTry_, compileJsTry, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [jsVar_, compileJsVar, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [jsWhile_, compileJsWhile, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [javascript_1.jsYield_, compileYield, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [lambda_, compileLambda, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [letFields_, compileLetFields, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [letStar_, compileLet, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [letValues_, compileLetValues, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [list_1.list_, compileList, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [procedures_1.lt_, compileLessThan, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [procedures_1.lte_, compileLessThanOrEqual, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [module_, compileModule, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [procedures_1.modulo_, compileModulo, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [procedures_1.mul_, compileMul, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [procedures_1.not_, compileNot, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [provide_, compileProvide, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [quasiquote_, compileQuasiquote, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [quote_, compileQuote, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [require_, compileRequire, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [return_, compileReturn, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [sendApply_, compileSendApply, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [send_, compileSend, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [setx_, compileSet, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [setField_, compileSetField, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [setFields_, compileSetFields, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [setValues_, compileSetValues, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [procedures_1.sub_, compileSub, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [throw_, compileThrow, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [yield_, compileYield, [Symbol.for('compiler->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]]]);
/**
 * Compiler macros mapping environment.
 */
const compilationMacroMappingEnv = new CompilationEnvironment([[array_1.arrayConcat_, compileArrayConcatMacro, [Symbol.for('macro->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [array_1.arrayDropRight_, compileArrayDropRightMacro, [Symbol.for('macro->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [array_1.arrayDrop_, compileArrayDropMacro, [Symbol.for('macro->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [array_1.arrayPushLeftX_, compileArrayPushLeftXMacro, [Symbol.for('macro->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [array_1.arrayPushRightX_, compileArrayPushRightXMacro, [Symbol.for('macro->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [array_1.arrayRef_, compileArrayRefMacro, [Symbol.for('macro->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [array_1.arraySetX_, compileArraySetXMacro, [Symbol.for('macro->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [procedures_1.assert_, compileAssertMacro, [Symbol.for('macro->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [list_1.cdr_, compileCdrMacro, [Symbol.for('macro->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [list_1.cons_, compileConsMacro, [Symbol.for('macro->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [procedures_1.display_, compileDisplayMacro, [Symbol.for('macro->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [list_1.dottedListLink_, compileDottedListLinkMacro, [Symbol.for('macro->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [list_1.dropRight_, compileDropRightMacro, [Symbol.for('macro->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [list_1.drop_, compileDropMacro, [Symbol.for('macro->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [list_1.eighth_, compileEighthMacro, [Symbol.for('macro->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [list_1.fifth_, compileFifthMacro, [Symbol.for('macro->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [list_1.first_, compileFirstMacro, [Symbol.for('macro->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [procedures_1.foldl_, compileFoldlMacro, [Symbol.for('macro->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [procedures_1.foldr_, compileFoldrMacro, [Symbol.for('macro->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [list_1.fourth_, compileFourthMacro, [Symbol.for('macro->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [hash_1.hashClear_, compileHashClearMacro, [Symbol.for('macro->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [hash_1.hashRef_, compileHashRefMacro, [Symbol.for('macro->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [hash_1.hashRemoveX_, compileHashRemoveMacro, [Symbol.for('macro->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [hash_1.hashRemove_, compileHashRemoveMacro, [Symbol.for('macro->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [javascript_1.jsRegexp_, compileJsRegexpMacro, [Symbol.for('macro->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [javascript_1.jsStringConcat_, compileJsStringConcatMacro, [Symbol.for('macro->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [list_1.last_, compileLastMacro, [Symbol.for('macro->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [list_1.length_, compileLengthMacro, [Symbol.for('macro->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [list_1.listRef_, compileListRefMacro, [Symbol.for('macro->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [list_1.listSetX_, compileListSetXMacro, [Symbol.for('macro->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [list_1.listp_, compileListPMacro, [Symbol.for('macro->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [hash_1.makeHash_, compileMakeHashMacro, [Symbol.for('macro->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [procedures_1.map_, compileMapMacro, [Symbol.for('macro->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [procedures_1.memberp_, compileMemberPMacro, [Symbol.for('macro->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [list_1.ninth_, compileNinthMacro, [Symbol.for('macro->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [list_1.nth_, compileNthMacro, [Symbol.for('macro->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [object_1.objectSetX_, compileObjectSetXMacro, [Symbol.for('macro->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [list_1.pairOrListP_, compilePairOrListMacro, [Symbol.for('macro->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [printer_1.print, compileDisplayMacro, [Symbol.for('macro->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [list_1.rest_, compileRestMacro, [Symbol.for('macro->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [list_1.reverse_, compileReverseMacro, [Symbol.for('macro->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [list_1.second_, compileSecondMacro, [Symbol.for('macro->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [list_1.seventh_, compileSeventhMacro, [Symbol.for('macro->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [list_1.sixth_, compileSixthMacro, [Symbol.for('macro->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [string_1.stringAppend_, compileStringAppendMacro, [Symbol.for('macro->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [string_1.stringTrim_, compileStringTrimMacro, [Symbol.for('macro->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [string_1.stringp_, compileStringPMacro, [Symbol.for('macro->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [string_1.substring_, compileSubstringMacro, [Symbol.for('macro->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [list_1.take_, compileTakeMacro, [Symbol.for('macro->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [list_1.tenth_, compileTenthMacro, [Symbol.for('macro->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [list_1.third_, compileThirdMacro, [Symbol.for('macro->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], [procedures_1.values_, compileValuesMacro, [Symbol.for('macro->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]]]);
/**
...
function compileWithEnvironment(exp, env = new env_1.LispEnvironment(), options = {}) {
    ...
    const mappingEnv = compilationMap.get(toLanguageOption) || compilationMappingEnv;
...
function compileSyntax(node, env, options = {}) {
    ...
    if (Array.isArray(exp)) {
        if (exp.length === 0) {
            result = compileList(node, env, options);
        }
        else {
            let op = exp[0];
            if (typeof op !== 'symbol') {
                result = compileFunctionCall(node, env, options);
            }
                ...
                if ((0, procedures_1.macroTypeP)(opType)) {
                    ...
                    result = compileMacroCall(node, env, options);
                }
                else if ((0, procedures_1.fexprTypeP)(opType)) {
                    // Call to locally defined fexpr.
                    result = compileFexprCall(node, env, options);
                }
                else {
                ...
                result = compileDot(node, env, options);
            }
            else {
                ...
                if ((0, procedures_1.undefinedTypeP)(opType)) {
                    ...
                    if ((0, procedures_1.compilerTypeP)(compilationType)) {
                        // Compiler function.
                        result = compilationF(node, env, options);
                    }
                    else if ((0, procedures_1.macroTypeP)(compilationType)) {
                        // Compilation macro.
                        result = compileSyntax((0, rose_1.datumToSyntax)(node, compilationF(exp, env)), env, options);
                    }
        ...
        result = compileString(node, env, options);
    }
    else if (typeof exp === 'symbol') {
        result = compileVariable(node, env, options);
    }
    else if ((0, estree_1.estreep)(exp)) {
        result = exp;
    }
    else {
        result = compileAtom(node, env, options);
    }
    if (commentsOption && node.hasProperty('comments')) {
...
compileSyntax.fsource = [Symbol.for('define'), [Symbol.for('compile-syntax'), Symbol.for('node'), Symbol.for('env'), [Symbol.for('options'), [Symbol.for('js/obj')]]], [Symbol.for('define'), Symbol.for('language-env'), [Symbol.for('oget'), Symbol.for('options'), Symbol.for(':language-environment')]], [Symbol.for('define'), [Symbol.for('lang-filter'), Symbol.for('x')], [Symbol.for('not'), [Symbol.for('eq?'), Symbol.for('x'), Symbol.for('language-env')]]], [Symbol.for('define'), Symbol.for('comments-option'), [Symbol.for('oget'), Symbol.for('options'), Symbol.for(':comments')]], [Symbol.for('define'), Symbol.for('exp'), [Symbol.for('syntax->datum'), Symbol.for('node')]], [Symbol.for('define'), Symbol.for('result')], [Symbol.for('cond'), [[Symbol.for('pair-or-list?'), Symbol.for('exp')], [Symbol.for('cond'), [[Symbol.for('='), [Symbol.for('length'), Symbol.for('exp')], 0], [Symbol.for('set!'), Symbol.for('result'), [Symbol.for('compile-list'), Symbol.for('node'), Symbol.for('env'), Symbol.for('options')]]], [Symbol.for('else'), [Symbol.for('define'), Symbol.for('op'), [Symbol.for('first'), Symbol.for('exp')]], [Symbol.for('cond'), [[Symbol.for('not'), [Symbol.for('symbol?'), Symbol.for('op')]], [Symbol.for('set!'), Symbol.for('result'), [Symbol.for('compile-function-call'), Symbol.for('node'), Symbol.for('env'), Symbol.for('options')]]], [[Symbol.for('send'), Symbol.for('env'), Symbol.for('has-promise?'), Symbol.for('op'), [Symbol.for('js/obj'), Symbol.for(':filter'), Symbol.for('lang-filter')]], [Symbol.for('define'), Symbol.for('op-type'), [Symbol.for('send'), Symbol.for('env'), Symbol.for('get-type'), Symbol.for('op')]], [Symbol.for('cond'), [[Symbol.for('macro-type?'), Symbol.for('op-type')], [Symbol.for('set!'), Symbol.for('result'), [Symbol.for('compile-macro-call'), Symbol.for('node'), Symbol.for('env'), Symbol.for('options')]]], [[Symbol.for('fexpr-type?'), Symbol.for('op-type')], [Symbol.for('set!'), Symbol.for('result'), [Symbol.for('compile-fexpr-call'), Symbol.for('node'), Symbol.for('env'), Symbol.for('options')]]], [Symbol.for('else'), [Symbol.for('set!'), Symbol.for('result'), [Symbol.for('compile-function-call'), Symbol.for('node'), Symbol.for('env'), Symbol.for('options')]]]]], [[Symbol.for('regexp-match'), [Symbol.for('regexp'), '^\\.'], [Symbol.for('symbol->string'), Symbol.for('op')]], [Symbol.for('set!'), Symbol.for('result'), [Symbol.for('compile-dot'), Symbol.for('node'), Symbol.for('env'), Symbol.for('options')]]], [Symbol.for('else'), [Symbol.for('define-values'), [Symbol.for('f'), Symbol.for('op-type')], [Symbol.for('send'), Symbol.for('env'), Symbol.for('get-typed-value'), Symbol.for('op')]], [Symbol.for('cond'), [[Symbol.for('undefined-type?'), Symbol.for('op-type')], [Symbol.for('set!'), Symbol.for('result'), [Symbol.for('compile-function-call'), Symbol.for('node'), Symbol.for('env'), Symbol.for('options')]]], [[Symbol.for('inlined-function?'), Symbol.for('f')], [Symbol.for('set!'), Symbol.for('result'), [Symbol.for('compile-inlined-function-call'), Symbol.for('node'), Symbol.for('env'), Symbol.for('options')]]], [Symbol.for('else'), [Symbol.for('define'), Symbol.for('compilation-mapping-environment'), [Symbol.for('oget'), Symbol.for('options'), Symbol.for(':compilation-mapping-environment')]], [Symbol.for('define-values'), [Symbol.for('compilation-f'), Symbol.for('compilation-type')], [Symbol.for('send'), Symbol.for('compilation-mapping-environment'), Symbol.for('get-typed-value'), Symbol.for('f')]], [Symbol.for('cond'), [[Symbol.for('compiler-type?'), Symbol.for('compilation-type')], [Symbol.for('set!'), Symbol.for('result'), [Symbol.for('compilation-f'), Symbol.for('node'), Symbol.for('env'), Symbol.for('options')]]], [[Symbol.for('macro-type?'), Symbol.for('compilation-type')], [Symbol.for('set!'), Symbol.for('result'), [Symbol.for('compile-syntax'), [Symbol.for('datum->syntax'), Symbol.for('node'), [Symbol.for('compilation-f'), Symbol.for('exp'), Symbol.for('env')]], Symbol.for('env'), Symbol.for('options')]]], [[Symbol.for('or'), [Symbol.for('macro?_'), Symbol.for('f')], [Symbol.for('macro-type?'), Symbol.for('op-type')]], [Symbol.for('set!'), Symbol.for('result'), [Symbol.for('compile-macro-call'), Symbol.for('node'), Symbol.for('env'), Symbol.for('options')]]], [[Symbol.for('fexpr-type?'), Symbol.for('op-type')], [Symbol.for('set!'), Symbol.for('result'), [Symbol.for('compile-fexpr-call'), Symbol.for('node'), Symbol.for('env'), Symbol.for('options')]]], [Symbol.for('else'), [Symbol.for('set!'), Symbol.for('result'), [Symbol.for('compile-function-call'), Symbol.for('node'), Symbol.for('env'), Symbol.for('options')]]]]]]]]]]], [[Symbol.for('string?'), Symbol.for('exp')], [Symbol.for('set!'), Symbol.for('result'), [Symbol.for('compile-string'), Symbol.for('node'), Symbol.for('env'), Symbol.for('options')]]], [[Symbol.for('symbol?'), Symbol.for('exp')], [Symbol.for('set!'), Symbol.for('result'), [Symbol.for('compile-variable'), Symbol.for('node'), Symbol.for('env'), Symbol.for('options')]]], [[Symbol.for('estree?'), Symbol.for('exp')], [Symbol.for('set!'), Symbol.for('result'), Symbol.for('exp')]], [Symbol.for('else'), [Symbol.for('set!'), Symbol.for('result'), [Symbol.for('compile-atom'), Symbol.for('node'), Symbol.for('env'), Symbol.for('options')]]]], [Symbol.for('when'), [Symbol.for('and'), Symbol.for('comments-option'), [Symbol.for('send'), Symbol.for('node'), Symbol.for('has-property'), 'comments']], [Symbol.for('define'), Symbol.for('comments'), [Symbol.for('send'), Symbol.for('node'), Symbol.for('get-property'), 'comments']], [Symbol.for('when'), [Symbol.for('>'), [Symbol.for('length'), Symbol.for('comments')], 0], [Symbol.for('set-field!'), Symbol.for('comments'), Symbol.for('result'), [Symbol.for('compile-comments'), Symbol.for('comments')]]]], Symbol.for('result')];
/**
...
interpret_.fsource = [Symbol.for('define'), [Symbol.for('interpret_'), Symbol.for('exp'), Symbol.for('.'), Symbol.for('options')], [Symbol.for('define'), Symbol.for('options1'), [Symbol.for('if'), [Symbol.for('and'), [Symbol.for('>='), [Symbol.for('length'), Symbol.for('options')], 1], [Symbol.for('is-a?'), [Symbol.for('first'), Symbol.for('options')], Symbol.for('Environment')]], [Symbol.for('js/obj-append'), [Symbol.for('js/obj'), Symbol.for(':environment'), [Symbol.for('first'), Symbol.for('options')]], [Symbol.for('normalize-options'), [Symbol.for('rest'), Symbol.for('options')]]], [Symbol.for('normalize-options'), Symbol.for('options')]]], [Symbol.for('define'), Symbol.for('env'), [Symbol.for('or'), [Symbol.for('oget'), Symbol.for('options1'), Symbol.for(':environment')], [Symbol.for('default-environment')]]], [Symbol.for('define'), Symbol.for('expression-type'), [Symbol.for('or'), [Symbol.for('oget'), Symbol.for('options1'), Symbol.for(':expression-type')], 'statement']], [Symbol.for('define'), Symbol.for('inherited-options'), [Symbol.for('js/obj-append'), Symbol.for('options1'), [Symbol.for('js/obj'), Symbol.for(':case'), 'none', Symbol.for(':expression-type'), Symbol.for('expression-type'), Symbol.for(':estree'), true, Symbol.for(':should-import'), false]]], [Symbol.for('define'), Symbol.for('environment'), [Symbol.for('make-interpretation-environment'), Symbol.for('env'), Symbol.for('inherited-options')]], [Symbol.for('define'), Symbol.for('ast'), [Symbol.for('compile-with-environment'), Symbol.for('exp'), Symbol.for('environment'), Symbol.for('inherited-options')]], [Symbol.for('define'), Symbol.for('result'), [Symbol.for('eval-estree'), Symbol.for('ast'), Symbol.for('environment'), Symbol.for('inherited-options')]], Symbol.for('result')];
/**
 * Evaluate a Lisp expression `exp`.
 */
function scmEval_(exp, ...options) {
    return interpret(exp, ...options);
}
scmEval_.fsource = [Symbol.for('define'), [Symbol.for('scm/eval_'), Symbol.for('exp'), Symbol.for('.'), Symbol.for('options')], [Symbol.for('apply'), Symbol.for('interpret'), Symbol.for('exp'), Symbol.for('options')]];
/**
 ...
 * a `(js/function (...) ...)` form.
 */
function defineToFunction(node, options = {}) {
    ...
    if (shouldCurry) {
        ...
        if (Array.isArray(nameAndParams) && (nameAndParams.length >= 3) && (nameAndParams.at(-2) === Symbol.for('.')) && (params.length === 1)) {
            params = params[0];
        }
    }
    let body = node.drop(2);
    let returnType = [];
...
function definitionToMacro(exp, args) {
    ...
    if (paramsList.length === 0) {
        ...
        if (shouldMakeIife) {
            ...
            return [Symbol.for('js/iife'), [Symbol.for('js/arrow'), params, ...body], [Symbol.for('list'), ...args]];
        }
...
definitionToMacro.fsource = [Symbol.for('define'), [Symbol.for('definition->macro'), Symbol.for('exp'), Symbol.for('args')], [Symbol.for('define'), Symbol.for('params'), [Symbol.for('cdr'), [Symbol.for('second'), Symbol.for('exp')]]], [Symbol.for('define-values'), [Symbol.for('regular-params'), Symbol.for('rest-param')], [Symbol.for('parse-params-list'), Symbol.for('params')]], [Symbol.for('when'), Symbol.for('rest-param'), [Symbol.for('set!'), Symbol.for('params'), [Symbol.for('append'), Symbol.for('regular-params'), [Symbol.for('list'), Symbol.for('rest-param')]]]], [Symbol.for('define'), Symbol.for('params-list'), [Symbol.for('map'), [Symbol.for('lambda'), [Symbol.for('x')], [Symbol.for('if'), [Symbol.for('pair-or-list?'), Symbol.for('x')], [Symbol.for('first'), Symbol.for('x')], Symbol.for('x')]], Symbol.for('params')]], [Symbol.for('define'), Symbol.for('regular-args'), [Symbol.for('quote'), []]], [Symbol.for('define'), Symbol.for('rest-arg'), [Symbol.for('quote'), [Symbol.for('list')]]], [Symbol.for('for'), [[Symbol.for('i'), [Symbol.for('range'), 0, [Symbol.for('length'), Symbol.for('args')]]]], [Symbol.for('define'), Symbol.for('arg'), [Symbol.for('list-ref'), Symbol.for('args'), Symbol.for('i')]], [Symbol.for('cond'), [[Symbol.for('<'), Symbol.for('i'), [Symbol.for('length'), Symbol.for('regular-params')]], [Symbol.for('push-right!'), Symbol.for('regular-args'), Symbol.for('arg')]], [Symbol.for('rest-param'), [Symbol.for('push-right!'), Symbol.for('rest-arg'), Symbol.for('arg')]]]], [Symbol.for('define'), Symbol.for('args-list'), [Symbol.for('append'), Symbol.for('regular-args'), [Symbol.for('if'), [Symbol.for('and'), Symbol.for('rest-param'), [Symbol.for('>'), [Symbol.for('length'), Symbol.for('rest-arg'), 1]]], [Symbol.for('list'), Symbol.for('rest-arg')], [Symbol.for('quote'), []]]]], [Symbol.for('define'), Symbol.for('body'), [Symbol.for('drop'), Symbol.for('exp'), 2]], [Symbol.for('cond'), [[Symbol.for('='), [Symbol.for('length'), Symbol.for('params-list')], 0], [Symbol.for('cond'), [[Symbol.for('='), [Symbol.for('length'), Symbol.for('body')], 1], [Symbol.for('first'), Symbol.for('body')]], [Symbol.for('else'), [Symbol.for('quasiquote'), [Symbol.for('begin'), [Symbol.for('unquote-splicing'), Symbol.for('body')]]]]]], [Symbol.for('else'), [Symbol.for('define'), Symbol.for('counts'), [Symbol.for('build-list'), [Symbol.for('length'), Symbol.for('args-list')], [Symbol.for('const'), 0]]], [Symbol.for('define'), Symbol.for('should-make-iife'), false], [Symbol.for('define'), Symbol.for('result'), [Symbol.for('map'), [Symbol.for('lambda'), [Symbol.for('x')], [Symbol.for('map-tree'), [Symbol.for('lambda'), [Symbol.for('y')], [Symbol.for('define'), Symbol.for('idx'), [Symbol.for('js/find-index'), [Symbol.for('lambda'), [Symbol.for('z')], [Symbol.for('eq?'), Symbol.for('z'), Symbol.for('y')]], Symbol.for('params-list')]], [Symbol.for('cond'), [[Symbol.for('>='), Symbol.for('idx'), 0], [Symbol.for('list-set!'), Symbol.for('counts'), Symbol.for('idx'), [Symbol.for('+'), [Symbol.for('list-ref'), Symbol.for('counts'), Symbol.for('idx')], 1]], [Symbol.for('cond'), [[Symbol.for('<'), Symbol.for('idx'), [Symbol.for('length'), Symbol.for('args-list')]], [Symbol.for('list-ref'), Symbol.for('args-list'), Symbol.for('idx')]], [Symbol.for('else'), [Symbol.for('define'), Symbol.for('current-param'), [Symbol.for('list-ref'), Symbol.for('params'), Symbol.for('idx')]], [Symbol.for('cond'), [[Symbol.for('pair-or-list?'), Symbol.for('current-param')], [Symbol.for('second'), Symbol.for('current-param')]], [Symbol.for('else'), undefined]]]]], [Symbol.for('else'), Symbol.for('y')]]], Symbol.for('x')]], Symbol.for('body')]], [Symbol.for('for'), [[Symbol.for('i'), [Symbol.for('range'), 0, [Symbol.for('length'), Symbol.for('args-list')]]]], [Symbol.for('define'), Symbol.for('count'), [Symbol.for('list-ref'), Symbol.for('counts'), Symbol.for('i')]], [Symbol.for('define'), Symbol.for('arg'), [Symbol.for('list-ref'), Symbol.for('args-list'), Symbol.for('i')]], [Symbol.for('when'), [Symbol.for('and'), [Symbol.for('>'), Symbol.for('count'), 1], [Symbol.for('not'), [Symbol.for('or'), [Symbol.for('symbol?'), Symbol.for('arg')], [Symbol.for('boolean?'), Symbol.for('arg')], [Symbol.for('string?'), Symbol.for('arg')], [Symbol.for('number?'), Symbol.for('arg')]]]], [Symbol.for('set!'), Symbol.for('should-make-iife'), true], [Symbol.for('break')]]], [Symbol.for('cond'), [Symbol.for('should-make-iife'), [Symbol.for('quasiquote'), [Symbol.for('js/iife'), [Symbol.for('js/arrow'), [Symbol.for('unquote'), Symbol.for('params')], [Symbol.for('unquote-splicing'), Symbol.for('body')]], [Symbol.for('list'), [Symbol.for('unquote-splicing'), Symbol.for('args')]]]]], [[Symbol.for('='), [Symbol.for('length'), Symbol.for('result')], 1], [Symbol.for('first'), Symbol.for('result')]], [Symbol.for('else'), [Symbol.for('quasiquote'), [Symbol.for('begin'), [Symbol.for('unquote-splicing'), Symbol.for('result')]]]]]]]];
/**
...
compileAnn.fsource = [Symbol.for('define'), [Symbol.for('compile-ann'), Symbol.for('node'), Symbol.for('env'), [Symbol.for('options'), [Symbol.for('js/obj')]]], [Symbol.for('define'), Symbol.for('to-language'), [Symbol.for('oget'), Symbol.for('options'), Symbol.for(':to')]], [Symbol.for('define'), Symbol.for('e_'), [Symbol.for('send'), Symbol.for('node'), Symbol.for('get'), 1]], [Symbol.for('cond'), [[Symbol.for('eq?'), Symbol.for('to-language'), 'typescript'], [Symbol.for('define'), Symbol.for('t_'), [Symbol.for('send'), Symbol.for('node'), Symbol.for('get'), 2]], [Symbol.for('make-expression-or-statement'), [Symbol.for('new'), Symbol.for('TSAsExpression'), [Symbol.for('compile-expression'), Symbol.for('e_'), Symbol.for('env'), Symbol.for('options')], [Symbol.for('compile-type'), Symbol.for('t_'), Symbol.for('env'), Symbol.for('options')]], Symbol.for('options')]], [Symbol.for('else'), [Symbol.for('compile-syntax'), Symbol.for('e_'), Symbol.for('env'), Symbol.for('options')]]]];
/**
...
compileDefineType.fsource = [Symbol.for('define'), [Symbol.for('compile-define-type'), Symbol.for('node'), Symbol.for('env'), [Symbol.for('options'), [Symbol.for('js/obj')]]], [Symbol.for('define'), Symbol.for('to-language'), [Symbol.for('oget'), Symbol.for('options'), Symbol.for(':to')]], [Symbol.for('cond'), [[Symbol.for('eq?'), Symbol.for('to-language'), 'typescript'], [Symbol.for('define'), Symbol.for('id'), [Symbol.for('compile-expression'), [Symbol.for('send'), Symbol.for('node'), Symbol.for('get'), 1], Symbol.for('env'), Symbol.for('options')]], [Symbol.for('define'), Symbol.for('type_'), [Symbol.for('compile-type'), [Symbol.for('send'), Symbol.for('node'), Symbol.for('get'), 2], Symbol.for('env'), Symbol.for('options')]], [Symbol.for('transfer-and-compile-comments'), Symbol.for('node'), [Symbol.for('new'), Symbol.for('TSTypeAliasDeclaration'), Symbol.for('id'), Symbol.for('type_')], Symbol.for('options')]], [Symbol.for('else'), [Symbol.for('empty-program')]]]];
/**
...
function compileJsAssignment(node, env, options = {}) {
    ...
    if ((0, util_1.taggedListP)(left, [Symbol.for('aset!'), Symbol.for('define'), Symbol.for('define-fields'), Symbol.for('define-values'), Symbol.for('list-set!'), Symbol.for('oset!'), Symbol.for('set!'), Symbol.for('set!-fields'), Symbol.for('set!-values')])) {
        return compileSyntax((0, rose_1.datumToSyntax)(node, [...(0, rose_1.syntaxToList)(left), right]), env, options);
    }
    else {
...
function compilePattern(node, env, options = {}) {
    ...
    if (!exp) {
        ...
        if (Array.isArray(exp) && (exp.length >= 3) && (exp.at(-2) === Symbol.for('.'))) {
            ...
            return new estree_1.ArrayPattern((0, rose_1.syntaxToList)(node).map(function (x) {
                return compilePattern(x, env, options);
            }));
        }
    }
    else {
        return compileExpression(node, env, options);
    }
}
compilePattern.fsource = [Symbol.for('define'), [Symbol.for('compile-pattern'), Symbol.for('node'), Symbol.for('env'), [Symbol.for('options'), [Symbol.for('js/obj')]]], [Symbol.for('define'), Symbol.for('exp'), [Symbol.for('syntax->datum'), Symbol.for('node')]], [Symbol.for('cond'), [[Symbol.for('not'), Symbol.for('exp')], null], [[Symbol.for('symbol?'), Symbol.for('exp')], [Symbol.for('compile-symbol'), Symbol.for('node'), Symbol.for('env'), Symbol.for('options')]], [[Symbol.for('pair-or-list?'), Symbol.for('exp')], [Symbol.for('cond'), [[Symbol.for('dotted-list?'), Symbol.for('exp')], [Symbol.for('define'), Symbol.for('head'), [Symbol.for('send'), Symbol.for('node'), Symbol.for('drop-right'), 2]], [Symbol.for('define'), Symbol.for('tail'), [Symbol.for('send'), Symbol.for('node'), Symbol.for('last')]], [Symbol.for('new'), Symbol.for('ArrayPattern'), [Symbol.for('append'), [Symbol.for('map'), [Symbol.for('lambda'), [Symbol.for('x')], [Symbol.for('compile-pattern'), Symbol.for('x'), Symbol.for('env'), Symbol.for('options')]], Symbol.for('head')], [Symbol.for('list'), [Symbol.for('new'), Symbol.for('RestElement'), [Symbol.for('compile-pattern'), Symbol.for('tail'), Symbol.for('env'), Symbol.for('options')]]]]]], [Symbol.for('else'), [Symbol.for('new'), Symbol.for('ArrayPattern'), [Symbol.for('map'), [Symbol.for('lambda'), [Symbol.for('x')], [Symbol.for('compile-pattern'), Symbol.for('x'), Symbol.for('env'), Symbol.for('options')]], [Symbol.for('syntax->list'), Symbol.for('node')]]]]]], [Symbol.for('else'), [Symbol.for('compile-expression'), Symbol.for('node'), Symbol.for('env'), Symbol.for('options')]]]];
/**
 ...
 */
function compileObjectSetXMacro(exp, env) {
    let [obj, key, val] = exp.slice(1);
    return [Symbol.for('js/='), [Symbol.for('js/get'), obj, key], val];
}
compileObjectSetXMacro.fsource = [Symbol.for('define'), [Symbol.for('compile-object-set!-macro'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define-values'), [Symbol.for('obj'), Symbol.for('key'), Symbol.for('val')], [Symbol.for('rest'), Symbol.for('exp')]], [Symbol.for('quasiquote'), [Symbol.for('js/='), [Symbol.for('js/get'), [Symbol.for('unquote'), Symbol.for('obj')], [Symbol.for('unquote'), Symbol.for('key')]], [Symbol.for('unquote'), Symbol.for('val')]]]];
compileObjectSetXMacro.ftype = 'macro';
/**
...
function compileDefine(node, env, options = {}) {
    ...
    if (Array.isArray(exp[1])) {
        ...
        const functionExp = defineToFunction(node);
        let returnType = ((0, rose_1.syntaxToDatum)(node.get(2)) === Symbol.for(':')) ? (0, rose_1.syntaxToDatum)(node.get(3)) : Symbol.for('Any');
        ...
        if ((declaredType === Symbol.for('Any')) || (declaredType === Symbol.for('Undefined'))) {
            type_ = [Symbol.for('->'), ...((typeof params === 'symbol') ? [[Symbol.for('Listof'), Symbol.for('Any')]] : ((Array.isArray(params) && (params.length >= 3) && (params.at(-2) === Symbol.for('.'))) ? [...makeList(params.length - 2, Symbol.for('Any')), [Symbol.for('Listof'), Symbol.for('Any')]] : makeList(params.length, Symbol.for('Any')))), returnType];
        }
        else {
            type_ = declaredType;
        }
        ...
        let result = compileJsFunction(functionExp, env, makeExpressionOptions(options), {
            type: type_
        });
        ...
        return compileJsLet(node, env, options);
    }
...
function compileJsVar(node, env, options = {}) {
    ...
    if (exp.length === 2) {
        // Uninitialized variable.
        let sym = node.get(1);
        let result = assignmentExpressionToVariableDeclaration(compileJsAssignment((0, rose_1.datumToSyntax)(node, [Symbol.for('js/='), sym, undefined]), env, options));
        ...
        for (let i = 1; i < _end; i = i + 2) {
            ...
            const declarator = assignmentExpressionToVariableDeclarator(compileJsAssignment((0, rose_1.datumToSyntax)(node, [Symbol.for('js/='), sym, val]), env, options));
...
compileDiv.fsource = [Symbol.for('define'), [Symbol.for('compile-div'), Symbol.for('node'), Symbol.for('env'), [Symbol.for('options'), [Symbol.for('js/obj')]]], [Symbol.for('define'), Symbol.for('exp'), [Symbol.for('syntax->datum'), Symbol.for('node')]], [Symbol.for('cond'), [[Symbol.for('='), [Symbol.for('length'), Symbol.for('exp')], 1], [Symbol.for('compile-expression'), [Symbol.for('datum->syntax'), Symbol.for('node'), undefined], Symbol.for('env'), Symbol.for('options')]], [[Symbol.for('='), [Symbol.for('length'), Symbol.for('exp')], 2], [Symbol.for('compile-div'), [Symbol.for('datum->syntax'), Symbol.for('node'), [Symbol.for('quasiquote'), [Symbol.for('/'), 1, [Symbol.for('unquote'), [Symbol.for('send'), Symbol.for('node'), Symbol.for('get'), 1]]]]], Symbol.for('env'), Symbol.for('options')]], [Symbol.for('else'), [Symbol.for('compile-binary-expression'), Symbol.for('node'), Symbol.for('env'), Symbol.for('options'), [Symbol.for('js/obj'), Symbol.for(':identity'), 1, Symbol.for(':operator'), '/']]]]];
/**
 ...
 */
function compileListPMacro(exp, env) {
    let [x] = exp.slice(1);
    ...
    if (fdottedlists) {
        ...
        return definitionToMacro([Symbol.for('define'), [Symbol.for('list?_'), Symbol.for('x')], [Symbol.for('and'), [Symbol.for('array?'), Symbol.for('x')], [Symbol.for('not'), [Symbol.for('and'), [Symbol.for('>='), [Symbol.for('array-length'), Symbol.for('x')], 3], [Symbol.for('eq?'), [Symbol.for('array-at'), Symbol.for('x'), -2], [Symbol.for('quote'), Symbol.for('.')]], [Symbol.for('not'), [Symbol.for('array?'), [Symbol.for('array-last'), Symbol.for('x')]]]]]]], [x]);
    }
}
compileListPMacro.fsource = [Symbol.for('define'), [Symbol.for('compile-list?-macro'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define-values'), [Symbol.for('x')], [Symbol.for('rest'), Symbol.for('exp')]], [Symbol.for('define-fields'), [Symbol.for('fdottedlists')], [Symbol.for('current-compilation-options')]], [Symbol.for('cond'), [Symbol.for('fdottedlists'), [Symbol.for('quasiquote'), [Symbol.for('funcall'), Symbol.for('list?'), [Symbol.for('unquote'), Symbol.for('x')]]]], [Symbol.for('else'), [Symbol.for('definition->macro'), [Symbol.for('quote'), [Symbol.for('define'), [Symbol.for('list?_'), Symbol.for('x')], [Symbol.for('and'), [Symbol.for('array?'), Symbol.for('x')], [Symbol.for('not'), [Symbol.for('and'), [Symbol.for('>='), [Symbol.for('array-length'), Symbol.for('x')], 3], [Symbol.for('eq?'), [Symbol.for('array-at'), Symbol.for('x'), -2], [Symbol.for('quote'), Symbol.for('.')]], [Symbol.for('not'), [Symbol.for('array?'), [Symbol.for('array-last'), Symbol.for('x')]]]]]]]], [Symbol.for('list'), Symbol.for('x')]]]]];
compileListPMacro.ftype = 'macro';
/**
 * Compiler macro for `(length ...)` expressions.
 */
function compileLengthMacro(exp, env) {
    let [x] = exp.slice(1);
    const { fdottedlists } = currentCompilationOptions();
    if (fdottedlists) {
...
compileLengthMacro.fsource = [Symbol.for('define'), [Symbol.for('compile-length-macro'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define-values'), [Symbol.for('x')], [Symbol.for('rest'), Symbol.for('exp')]], [Symbol.for('define-fields'), [Symbol.for('fdottedlists')], [Symbol.for('current-compilation-options')]], [Symbol.for('cond'), [Symbol.for('fdottedlists'), [Symbol.for('quasiquote'), [Symbol.for('funcall'), Symbol.for('length'), [Symbol.for('unquote'), Symbol.for('x')]]]], [Symbol.for('else'), [Symbol.for('quasiquote'), [Symbol.for('js/length'), [Symbol.for('unquote'), Symbol.for('x')]]]]]];
compileLengthMacro.ftype = 'macro';
/**
 * Compiler macro for `(first ...)` expressions.
 */
function compileFirstMacro(exp, env) {
    let [x] = exp.slice(1);
    const { fdottedlists } = currentCompilationOptions();
    if (fdottedlists) {
...
compileFirstMacro.fsource = [Symbol.for('define'), [Symbol.for('compile-first-macro'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define-values'), [Symbol.for('x')], [Symbol.for('rest'), Symbol.for('exp')]], [Symbol.for('define-fields'), [Symbol.for('fdottedlists')], [Symbol.for('current-compilation-options')]], [Symbol.for('cond'), [Symbol.for('fdottedlists'), [Symbol.for('quasiquote'), [Symbol.for('funcall'), Symbol.for('first'), [Symbol.for('unquote'), Symbol.for('x')]]]], [Symbol.for('else'), [Symbol.for('quasiquote'), [Symbol.for('array-first'), [Symbol.for('unquote'), Symbol.for('x')]]]]]];
compileFirstMacro.ftype = 'macro';
/**
 * Compiler macro for `(second ...)` expressions.
 */
function compileSecondMacro(exp, env) {
    let [x] = exp.slice(1);
    const { fdottedlists } = currentCompilationOptions();
    if (fdottedlists) {
...
compileSecondMacro.fsource = [Symbol.for('define'), [Symbol.for('compile-second-macro'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define-values'), [Symbol.for('x')], [Symbol.for('rest'), Symbol.for('exp')]], [Symbol.for('define-fields'), [Symbol.for('fdottedlists')], [Symbol.for('current-compilation-options')]], [Symbol.for('cond'), [Symbol.for('fdottedlists'), [Symbol.for('quasiquote'), [Symbol.for('funcall'), Symbol.for('second'), [Symbol.for('unquote'), Symbol.for('x')]]]], [Symbol.for('else'), [Symbol.for('quasiquote'), [Symbol.for('array-second'), [Symbol.for('unquote'), Symbol.for('x')]]]]]];
compileSecondMacro.ftype = 'macro';
/**
 * Compiler macro for `(third ...)` expressions.
 */
function compileThirdMacro(exp, env) {
    let [x] = exp.slice(1);
    const { fdottedlists } = currentCompilationOptions();
    if (fdottedlists) {
...
compileThirdMacro.fsource = [Symbol.for('define'), [Symbol.for('compile-third-macro'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define-values'), [Symbol.for('x')], [Symbol.for('rest'), Symbol.for('exp')]], [Symbol.for('define-fields'), [Symbol.for('fdottedlists')], [Symbol.for('current-compilation-options')]], [Symbol.for('cond'), [Symbol.for('fdottedlists'), [Symbol.for('quasiquote'), [Symbol.for('funcall'), Symbol.for('third'), [Symbol.for('unquote'), Symbol.for('x')]]]], [Symbol.for('else'), [Symbol.for('quasiquote'), [Symbol.for('array-third'), [Symbol.for('unquote'), Symbol.for('x')]]]]]];
compileThirdMacro.ftype = 'macro';
/**
 * Compiler macro for `(fourth ...)` expressions.
 */
function compileFourthMacro(exp, env) {
    let [x] = exp.slice(1);
    const { fdottedlists } = currentCompilationOptions();
    if (fdottedlists) {
...
compileFourthMacro.fsource = [Symbol.for('define'), [Symbol.for('compile-fourth-macro'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define-values'), [Symbol.for('x')], [Symbol.for('rest'), Symbol.for('exp')]], [Symbol.for('define-fields'), [Symbol.for('fdottedlists')], [Symbol.for('current-compilation-options')]], [Symbol.for('cond'), [Symbol.for('fdottedlists'), [Symbol.for('quasiquote'), [Symbol.for('funcall'), Symbol.for('fourth'), [Symbol.for('unquote'), Symbol.for('x')]]]], [Symbol.for('else'), [Symbol.for('quasiquote'), [Symbol.for('array-fourth'), [Symbol.for('unquote'), Symbol.for('x')]]]]]];
compileFourthMacro.ftype = 'macro';
/**
 * Compiler macro for `(fifth ...)` expressions.
 */
function compileFifthMacro(exp, env) {
    let [x] = exp.slice(1);
    const { fdottedlists } = currentCompilationOptions();
    if (fdottedlists) {
...
compileFifthMacro.fsource = [Symbol.for('define'), [Symbol.for('compile-fifth-macro'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define-values'), [Symbol.for('x')], [Symbol.for('rest'), Symbol.for('exp')]], [Symbol.for('define-fields'), [Symbol.for('fdottedlists')], [Symbol.for('current-compilation-options')]], [Symbol.for('cond'), [Symbol.for('fdottedlists'), [Symbol.for('quasiquote'), [Symbol.for('funcall'), Symbol.for('fifth'), [Symbol.for('unquote'), Symbol.for('x')]]]], [Symbol.for('else'), [Symbol.for('quasiquote'), [Symbol.for('array-fifth'), [Symbol.for('unquote'), Symbol.for('x')]]]]]];
compileFifthMacro.ftype = 'macro';
/**
 * Compiler macro for `(sixth ...)` expressions.
 */
function compileSixthMacro(exp, env) {
    let [x] = exp.slice(1);
    const { fdottedlists } = currentCompilationOptions();
    if (fdottedlists) {
...
compileSixthMacro.fsource = [Symbol.for('define'), [Symbol.for('compile-sixth-macro'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define-values'), [Symbol.for('x')], [Symbol.for('rest'), Symbol.for('exp')]], [Symbol.for('define-fields'), [Symbol.for('fdottedlists')], [Symbol.for('current-compilation-options')]], [Symbol.for('cond'), [Symbol.for('fdottedlists'), [Symbol.for('quasiquote'), [Symbol.for('funcall'), Symbol.for('sixth'), [Symbol.for('unquote'), Symbol.for('x')]]]], [Symbol.for('else'), [Symbol.for('quasiquote'), [Symbol.for('array-sixth'), [Symbol.for('unquote'), Symbol.for('x')]]]]]];
compileSixthMacro.ftype = 'macro';
/**
 * Compiler macro for `(seventh ...)` expressions.
 */
function compileSeventhMacro(exp, env) {
    let [x] = exp.slice(1);
    const { fdottedlists } = currentCompilationOptions();
    if (fdottedlists) {
...
compileSeventhMacro.fsource = [Symbol.for('define'), [Symbol.for('compile-seventh-macro'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define-values'), [Symbol.for('x')], [Symbol.for('rest'), Symbol.for('exp')]], [Symbol.for('define-fields'), [Symbol.for('fdottedlists')], [Symbol.for('current-compilation-options')]], [Symbol.for('cond'), [Symbol.for('fdottedlists'), [Symbol.for('quasiquote'), [Symbol.for('funcall'), Symbol.for('seventh'), [Symbol.for('unquote'), Symbol.for('x')]]]], [Symbol.for('else'), [Symbol.for('quasiquote'), [Symbol.for('array-seventh'), [Symbol.for('unquote'), Symbol.for('x')]]]]]];
compileSeventhMacro.ftype = 'macro';
/**
 * Compiler macro for `(eighth ...)` expressions.
 */
function compileEighthMacro(exp, env) {
    let [x] = exp.slice(1);
    const { fdottedlists } = currentCompilationOptions();
    if (fdottedlists) {
...
compileEighthMacro.fsource = [Symbol.for('define'), [Symbol.for('compile-eighth-macro'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define-values'), [Symbol.for('x')], [Symbol.for('rest'), Symbol.for('exp')]], [Symbol.for('define-fields'), [Symbol.for('fdottedlists')], [Symbol.for('current-compilation-options')]], [Symbol.for('cond'), [Symbol.for('fdottedlists'), [Symbol.for('quasiquote'), [Symbol.for('funcall'), Symbol.for('eighth'), [Symbol.for('unquote'), Symbol.for('x')]]]], [Symbol.for('else'), [Symbol.for('quasiquote'), [Symbol.for('array-eighth'), [Symbol.for('unquote'), Symbol.for('x')]]]]]];
compileEighthMacro.ftype = 'macro';
/**
 * Compiler macro for `(ninth ...)` expressions.
 */
function compileNinthMacro(exp, env) {
    let [x] = exp.slice(1);
    const { fdottedlists } = currentCompilationOptions();
    if (fdottedlists) {
...
compileNinthMacro.fsource = [Symbol.for('define'), [Symbol.for('compile-ninth-macro'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define-values'), [Symbol.for('x')], [Symbol.for('rest'), Symbol.for('exp')]], [Symbol.for('define-fields'), [Symbol.for('fdottedlists')], [Symbol.for('current-compilation-options')]], [Symbol.for('cond'), [Symbol.for('fdottedlists'), [Symbol.for('quasiquote'), [Symbol.for('funcall'), Symbol.for('ninth'), [Symbol.for('unquote'), Symbol.for('x')]]]], [Symbol.for('else'), [Symbol.for('quasiquote'), [Symbol.for('array-ninth'), [Symbol.for('unquote'), Symbol.for('x')]]]]]];
compileNinthMacro.ftype = 'macro';
/**
 * Compiler macro for `(tenth ...)` expressions.
 */
function compileTenthMacro(exp, env) {
    let [x] = exp.slice(1);
    const { fdottedlists } = currentCompilationOptions();
    if (fdottedlists) {
...
compileTenthMacro.fsource = [Symbol.for('define'), [Symbol.for('compile-tenth-macro'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define-values'), [Symbol.for('x')], [Symbol.for('rest'), Symbol.for('exp')]], [Symbol.for('define-fields'), [Symbol.for('fdottedlists')], [Symbol.for('current-compilation-options')]], [Symbol.for('cond'), [Symbol.for('fdottedlists'), [Symbol.for('quasiquote'), [Symbol.for('funcall'), Symbol.for('tenth'), [Symbol.for('unquote'), Symbol.for('x')]]]], [Symbol.for('else'), [Symbol.for('quasiquote'), [Symbol.for('array-tenth'), [Symbol.for('unquote'), Symbol.for('x')]]]]]];
compileTenthMacro.ftype = 'macro';
/**
 * Compiler macro for `(pair-or-list? ...)` expressions.
 */
function compilePairOrListMacro(exp, env) {
    let [x] = exp.slice(1);
    return [Symbol.for('array?'), x];
}
compilePairOrListMacro.fsource = [Symbol.for('define'), [Symbol.for('compile-pair-or-list-macro'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define-values'), [Symbol.for('x')], [Symbol.for('rest'), Symbol.for('exp')]], [Symbol.for('quasiquote'), [Symbol.for('array?'), [Symbol.for('unquote'), Symbol.for('x')]]]];
compilePairOrListMacro.ftype = 'macro';
/**
 * Compiler macro for `(cons ...)` expressions.
 */
function compileConsMacro(exp, env) {
    let [x, y] = exp.slice(1);
    if (selfEvaluatingP(y)) {
        return [Symbol.for('quasiquote'), [[Symbol.for('unquote'), x], Symbol.for('.'), [Symbol.for('unquote'), y]]];
    }
    else if ((0, util_1.taggedListP)(y, Symbol.for('list')) || ((0, util_1.taggedListP)(y, Symbol.for('list*')) && (y.length > 2)) || ((0, util_1.taggedListP)(y, [Symbol.for('quote'), Symbol.for('quasiquote')]) && Array.isArray(y[1]))) {
        return [Symbol.for('quasiquote'), [[Symbol.for('unquote'), x], [Symbol.for('unquote-splicing'), y]]];
    }
    else {
        return definitionToMacro(source(list_1.cons_), [x, y]);
    }
}
compileConsMacro.fsource = [Symbol.for('define'), [Symbol.for('compile-cons-macro'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define-values'), [Symbol.for('x'), Symbol.for('y')], [Symbol.for('rest'), Symbol.for('exp')]], [Symbol.for('cond'), [[Symbol.for('self-evaluating?'), Symbol.for('y')], [Symbol.for('quasiquote'), [Symbol.for('quasiquote'), [[Symbol.for('unquote'), [Symbol.for('unquote'), Symbol.for('x')]], Symbol.for('.'), [Symbol.for('unquote'), [Symbol.for('unquote'), Symbol.for('y')]]]]]], [[Symbol.for('or'), [Symbol.for('tagged-list?'), Symbol.for('y'), [Symbol.for('quote'), Symbol.for('list')]], [Symbol.for('and'), [Symbol.for('tagged-list?'), Symbol.for('y'), [Symbol.for('quote'), Symbol.for('list*')]], [Symbol.for('>'), [Symbol.for('length'), Symbol.for('y')], 2]], [Symbol.for('and'), [Symbol.for('tagged-list?'), Symbol.for('y'), [Symbol.for('quote'), [Symbol.for('quote'), Symbol.for('quasiquote')]]], [Symbol.for('pair-or-list?'), [Symbol.for('second'), Symbol.for('y')]]]], [Symbol.for('quasiquote'), [Symbol.for('quasiquote'), [[Symbol.for('unquote'), [Symbol.for('unquote'), Symbol.for('x')]], [Symbol.for('unquote-splicing'), [Symbol.for('unquote'), Symbol.for('y')]]]]]], [Symbol.for('else'), [Symbol.for('definition->macro'), [Symbol.for('source'), Symbol.for('cons_')], [Symbol.for('list'), Symbol.for('x'), Symbol.for('y')]]]]];
compileConsMacro.ftype = 'macro';
/**
 * Compiler macro for `(dotted-list-link ...)` expressions.
 */
function compileDottedListLinkMacro(exp, env) {
    let [x] = exp.slice(1);
    if (selfEvaluatingP(x)) {
        return [Symbol.for('.'), x];
    }
    else if ((0, util_1.taggedListP)(x, Symbol.for('list')) || ((0, util_1.taggedListP)(x, Symbol.for('list*')) && (x.length > 2)) || ((0, util_1.taggedListP)(x, [Symbol.for('quote'), Symbol.for('quasiquote')]) && Array.isArray(x[1]))) {
        return x;
    }
    else {
        return definitionToMacro([Symbol.for('define'), [Symbol.for('dotted-list-link_'), Symbol.for('x')], [Symbol.for('js/?'), [Symbol.for('pair-or-list?'), Symbol.for('x')], Symbol.for('x'), [Symbol.for('list'), [Symbol.for('quote'), Symbol.for('.')], Symbol.for('x')]]], [x]);
    }
}
compileDottedListLinkMacro.fsource = [Symbol.for('define'), [Symbol.for('compile-dotted-list-link-macro'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define-values'), [Symbol.for('x')], [Symbol.for('rest'), Symbol.for('exp')]], [Symbol.for('cond'), [[Symbol.for('self-evaluating?'), Symbol.for('x')], [Symbol.for('list'), [Symbol.for('quote'), Symbol.for('.')], Symbol.for('x')]], [[Symbol.for('or'), [Symbol.for('tagged-list?'), Symbol.for('x'), [Symbol.for('quote'), Symbol.for('list')]], [Symbol.for('and'), [Symbol.for('tagged-list?'), Symbol.for('x'), [Symbol.for('quote'), Symbol.for('list*')]], [Symbol.for('>'), [Symbol.for('length'), Symbol.for('x')], 2]], [Symbol.for('and'), [Symbol.for('tagged-list?'), Symbol.for('x'), [Symbol.for('quote'), [Symbol.for('quote'), Symbol.for('quasiquote')]]], [Symbol.for('pair-or-list?'), [Symbol.for('second'), Symbol.for('x')]]]], Symbol.for('x')], [Symbol.for('else'), [Symbol.for('definition->macro'), [Symbol.for('quote'), [Symbol.for('define'), [Symbol.for('dotted-list-link_'), Symbol.for('x')], [Symbol.for('js/?'), [Symbol.for('pair-or-list?'), Symbol.for('x')], Symbol.for('x'), [Symbol.for('list'), [Symbol.for('quote'), Symbol.for('.')], Symbol.for('x')]]]], [Symbol.for('list'), Symbol.for('x')]]]]];
compileDottedListLinkMacro.ftype = 'macro';
/**
 * Compiler macro for `(cdr ...)` expressions.
 */
function compileCdrMacro(exp, env) {
    let [x] = exp.slice(1);
    const { fdottedlists } = currentCompilationOptions();
    if (fdottedlists) {
        ...
        return definitionToMacro([Symbol.for('define'), [Symbol.for('cdr_'), Symbol.for('x')], [Symbol.for('js/?'), [Symbol.for('and'), [Symbol.for('='), [Symbol.for('array-length'), Symbol.for('x')], 3], [Symbol.for('eq?'), [Symbol.for('array-ref'), Symbol.for('x'), 1], [Symbol.for('quote'), Symbol.for('.')]]], [Symbol.for('array-third'), Symbol.for('x')], [Symbol.for('array-rest'), Symbol.for('x')]]], [x]);
    }
}
compileCdrMacro.fsource = [Symbol.for('define'), [Symbol.for('compile-cdr-macro'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define-values'), [Symbol.for('x')], [Symbol.for('rest'), Symbol.for('exp')]], [Symbol.for('define-fields'), [Symbol.for('fdottedlists')], [Symbol.for('current-compilation-options')]], [Symbol.for('cond'), [Symbol.for('fdottedlists'), [Symbol.for('quasiquote'), [Symbol.for('funcall'), Symbol.for('cdr'), [Symbol.for('unquote'), Symbol.for('x')]]]], [Symbol.for('else'), [Symbol.for('definition->macro'), [Symbol.for('quote'), [Symbol.for('define'), [Symbol.for('cdr_'), Symbol.for('x')], [Symbol.for('js/?'), [Symbol.for('and'), [Symbol.for('='), [Symbol.for('array-length'), Symbol.for('x')], 3], [Symbol.for('eq?'), [Symbol.for('array-ref'), Symbol.for('x'), 1], [Symbol.for('quote'), Symbol.for('.')]]], [Symbol.for('array-third'), Symbol.for('x')], [Symbol.for('array-rest'), Symbol.for('x')]]]], [Symbol.for('list'), Symbol.for('x')]]]]];
compileCdrMacro.ftype = 'macro';
/**
 * Compiler macro for `(rest ...)` expressions.
 */
function compileRestMacro(exp, env) {
    let [x] = exp.slice(1);
    const { fdottedlists } = currentCompilationOptions();
    if (fdottedlists) {
...
compileRestMacro.fsource = [Symbol.for('define'), [Symbol.for('compile-rest-macro'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define-values'), [Symbol.for('x')], [Symbol.for('rest'), Symbol.for('exp')]], [Symbol.for('define-fields'), [Symbol.for('fdottedlists')], [Symbol.for('current-compilation-options')]], [Symbol.for('cond'), [Symbol.for('fdottedlists'), [Symbol.for('quasiquote'), [Symbol.for('funcall'), Symbol.for('rest'), [Symbol.for('unquote'), Symbol.for('x')]]]], [Symbol.for('else'), [Symbol.for('quasiquote'), [Symbol.for('array-rest'), [Symbol.for('unquote'), Symbol.for('x')]]]]]];
compileRestMacro.ftype = 'macro';
/**
 * Compiler macro for `(nth ...)` expressions.
 */
function compileNthMacro(exp, env) {
...
compileNthMacro.fsource = [Symbol.for('define'), [Symbol.for('compile-nth-macro'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define-values'), [Symbol.for('n'), Symbol.for('lst')], [Symbol.for('rest'), Symbol.for('exp')]], [Symbol.for('define-fields'), [Symbol.for('fdottedlists')], [Symbol.for('current-compilation-options')]], [Symbol.for('cond'), [Symbol.for('fdottedlists'), [Symbol.for('quasiquote'), [Symbol.for('funcall'), Symbol.for('nth'), [Symbol.for('unquote'), Symbol.for('n')], [Symbol.for('unquote'), Symbol.for('lst')]]]], [Symbol.for('else'), [Symbol.for('quasiquote'), [Symbol.for('list-ref'), [Symbol.for('unquote'), Symbol.for('lst')], [Symbol.for('unquote'), Symbol.for('n')]]]]]];
compileNthMacro.ftype = 'macro';
/**
 * Compiler macro for `(take ...)` expressions.
 */
function compileTakeMacro(exp, env) {
    ...
    if (fdottedlists) {
        ...
        return definitionToMacro([Symbol.for('define'), [Symbol.for('take_'), Symbol.for('lst'), Symbol.for('n')], [Symbol.for('drop-right'), Symbol.for('lst'), [Symbol.for('-'), [Symbol.for('length'), Symbol.for('lst')], Symbol.for('n')]]], [lst, n]);
    }
}
compileTakeMacro.fsource = [Symbol.for('define'), [Symbol.for('compile-take-macro'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define-values'), [Symbol.for('lst'), Symbol.for('n')], [Symbol.for('rest'), Symbol.for('exp')]], [Symbol.for('define-fields'), [Symbol.for('fdottedlists')], [Symbol.for('current-compilation-options')]], [Symbol.for('cond'), [Symbol.for('fdottedlists'), [Symbol.for('quasiquote'), [Symbol.for('funcall'), Symbol.for('take'), [Symbol.for('unquote'), Symbol.for('lst')], [Symbol.for('unquote'), Symbol.for('n')]]]], [[Symbol.for('eq?'), Symbol.for('n'), 0], [Symbol.for('quote'), []]], [Symbol.for('else'), [Symbol.for('definition->macro'), [Symbol.for('quote'), [Symbol.for('define'), [Symbol.for('take_'), Symbol.for('lst'), Symbol.for('n')], [Symbol.for('drop-right'), Symbol.for('lst'), [Symbol.for('-'), [Symbol.for('length'), Symbol.for('lst')], Symbol.for('n')]]]], [Symbol.for('list'), Symbol.for('lst'), Symbol.for('n')]]]]];
compileTakeMacro.ftype = 'macro';
/**
...
compileDropMacro.fsource = [Symbol.for('define'), [Symbol.for('compile-drop-macro'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define-values'), [Symbol.for('lst'), Symbol.for('n')], [Symbol.for('rest'), Symbol.for('exp')]], [Symbol.for('define-fields'), [Symbol.for('fdottedlists')], [Symbol.for('current-compilation-options')]], [Symbol.for('cond'), [Symbol.for('fdottedlists'), [Symbol.for('quasiquote'), [Symbol.for('funcall'), Symbol.for('drop'), [Symbol.for('unquote'), Symbol.for('lst')], [Symbol.for('unquote'), Symbol.for('n')]]]], [Symbol.for('else'), [Symbol.for('quasiquote'), [Symbol.for('array-drop'), [Symbol.for('unquote'), Symbol.for('lst')], [Symbol.for('unquote'), Symbol.for('n')]]]]]];
...
compileDropRightMacro.fsource = [Symbol.for('define'), [Symbol.for('compile-drop-right-macro'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define-values'), [Symbol.for('lst'), Symbol.for('n')], [Symbol.for('rest'), Symbol.for('exp')]], [Symbol.for('define-fields'), [Symbol.for('fdottedlists')], [Symbol.for('current-compilation-options')]], [Symbol.for('cond'), [Symbol.for('fdottedlists'), [Symbol.for('quasiquote'), [Symbol.for('funcall'), Symbol.for('drop-right'), [Symbol.for('unquote'), Symbol.for('lst')], [Symbol.for('unquote'), Symbol.for('n')]]]], [Symbol.for('else'), [Symbol.for('quasiquote'), [Symbol.for('array-drop-right'), [Symbol.for('unquote'), Symbol.for('lst')], [Symbol.for('unquote'), Symbol.for('n')]]]]]];
...
compileArrayDropMacro.fsource = [Symbol.for('define'), [Symbol.for('compile-array-drop-macro'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define-values'), [Symbol.for('arr'), Symbol.for('n')], [Symbol.for('rest'), Symbol.for('exp')]], [Symbol.for('cond'), [[Symbol.for('eq?'), Symbol.for('n'), 0], Symbol.for('arr')], [Symbol.for('else'), [Symbol.for('quasiquote'), [Symbol.for('array-slice'), [Symbol.for('unquote'), Symbol.for('arr')], [Symbol.for('unquote'), Symbol.for('n')]]]]]];
...
compileArrayDropRightMacro.fsource = [Symbol.for('define'), [Symbol.for('compile-array-drop-right-macro'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define-values'), [Symbol.for('arr'), Symbol.for('n')], [Symbol.for('rest'), Symbol.for('exp')]], [Symbol.for('cond'), [[Symbol.for('number?'), Symbol.for('n')], [Symbol.for('cond'), [[Symbol.for('='), Symbol.for('n'), 0], Symbol.for('arr')], [Symbol.for('else'), [Symbol.for('quasiquote'), [Symbol.for('array-slice'), [Symbol.for('unquote'), Symbol.for('arr')], 0, [Symbol.for('-'), [Symbol.for('unquote'), Symbol.for('n')]]]]]]], [Symbol.for('else'), [Symbol.for('definition->macro'), [Symbol.for('source'), Symbol.for('array-drop-right_')], [Symbol.for('list'), Symbol.for('arr'), Symbol.for('n')]]]]];
compileArrayDropRightMacro.ftype = 'macro';
/**
 * Compiler macro for `(array-push-left! ...)` expressions.
 */
function compileArrayPushLeftXMacro(exp, env) {
    let [arr, x] = exp.slice(1);
    return [Symbol.for('js/statement-or-expression'), Symbol.for(':statement'), [Symbol.for('send'), arr, Symbol.for('unshift'), x], Symbol.for(':expression'), definitionToMacro(source(array_1.arrayPushLeftX_), [arr, x])];
}
compileArrayPushLeftXMacro.fsource = [Symbol.for('define'), [Symbol.for('compile-array-push-left!-macro'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define-values'), [Symbol.for('arr'), Symbol.for('x')], [Symbol.for('rest'), Symbol.for('exp')]], [Symbol.for('quasiquote'), [Symbol.for('js/statement-or-expression'), Symbol.for(':statement'), [Symbol.for('send'), [Symbol.for('unquote'), Symbol.for('arr')], Symbol.for('unshift'), [Symbol.for('unquote'), Symbol.for('x')]], Symbol.for(':expression'), [Symbol.for('unquote'), [Symbol.for('definition->macro'), [Symbol.for('source'), Symbol.for('array-push-left!_')], [Symbol.for('list'), Symbol.for('arr'), Symbol.for('x')]]]]]];
compileArrayPushLeftXMacro.ftype = 'macro';
/**
 * Compiler macro for `(array-push-right! ...)` expressions.
 */
function compileArrayPushRightXMacro(exp, env) {
    let [arr, x] = exp.slice(1);
    return [Symbol.for('js/statement-or-expression'), Symbol.for(':statement'), [Symbol.for('send'), arr, Symbol.for('push'), x], Symbol.for(':expression'), definitionToMacro(source(array_1.arrayPushRightX_), [arr, x])];
}
compileArrayPushRightXMacro.fsource = [Symbol.for('define'), [Symbol.for('compile-array-push-right!-macro'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define-values'), [Symbol.for('arr'), Symbol.for('x')], [Symbol.for('rest'), Symbol.for('exp')]], [Symbol.for('quasiquote'), [Symbol.for('js/statement-or-expression'), Symbol.for(':statement'), [Symbol.for('send'), [Symbol.for('unquote'), Symbol.for('arr')], Symbol.for('push'), [Symbol.for('unquote'), Symbol.for('x')]], Symbol.for(':expression'), [Symbol.for('unquote'), [Symbol.for('definition->macro'), [Symbol.for('source'), Symbol.for('array-push-right!_')], [Symbol.for('list'), Symbol.for('arr'), Symbol.for('x')]]]]]];
compileArrayPushRightXMacro.ftype = 'macro';
/**
 * Compiler macro for `(array-concat ...)` expressions.
 */
function compileArrayConcatMacro(exp, env) {
...
compileArrayConcatMacro.fsource = [Symbol.for('define'), [Symbol.for('compile-array-concat-macro'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define-values'), Symbol.for('args'), [Symbol.for('rest'), Symbol.for('exp')]], [Symbol.for('cond'), [[Symbol.for('eq?'), [Symbol.for('length'), Symbol.for('args')], 0], [Symbol.for('quote'), []]], [[Symbol.for('eq?'), [Symbol.for('length'), Symbol.for('args')], 1], [Symbol.for('first'), Symbol.for('args')]], [Symbol.for('else'), [Symbol.for('quasiquote'), [Symbol.for('send'), [Symbol.for('unquote'), [Symbol.for('first'), Symbol.for('args')]], Symbol.for('concat'), [Symbol.for('unquote-splicing'), [Symbol.for('rest'), Symbol.for('args')]]]]]]];
compileArrayConcatMacro.ftype = 'macro';
/**
 * Compiler macro for `(reverse ...)` expressions.
 */
function compileReverseMacro(exp, env) {
...
compileReverseMacro.fsource = [Symbol.for('define'), [Symbol.for('compile-reverse-macro'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define-values'), [Symbol.for('lst')], [Symbol.for('rest'), Symbol.for('exp')]], [Symbol.for('define-fields'), [Symbol.for('fdottedlists')], [Symbol.for('current-compilation-options')]], [Symbol.for('cond'), [Symbol.for('fdottedlists'), [Symbol.for('quasiquote'), [Symbol.for('funcall'), Symbol.for('reverse'), [Symbol.for('unquote'), Symbol.for('lst')]]]], [Symbol.for('else'), [Symbol.for('quasiquote'), [Symbol.for('array-reverse'), [Symbol.for('unquote'), Symbol.for('lst')]]]]]];
compileReverseMacro.ftype = 'macro';
/**
 * Compiler macro for `(last ...)` expressions.
 */
function compileLastMacro(exp, env) {
    const [lst] = exp.slice(1);
    const { fdottedlists } = currentCompilationOptions();
    if (fdottedlists) {
...
compileLastMacro.fsource = [Symbol.for('define'), [Symbol.for('compile-last-macro'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define-values'), [Symbol.for('lst')], [Symbol.for('rest'), Symbol.for('exp')]], [Symbol.for('define-fields'), [Symbol.for('fdottedlists')], [Symbol.for('current-compilation-options')]], [Symbol.for('cond'), [Symbol.for('fdottedlists'), [Symbol.for('quasiquote'), [Symbol.for('funcall'), Symbol.for('last'), [Symbol.for('unquote'), Symbol.for('lst')]]]], [Symbol.for('else'), [Symbol.for('quasiquote'), [Symbol.for('array-last'), [Symbol.for('unquote'), Symbol.for('lst')]]]]]];
compileLastMacro.ftype = 'macro';
/**
 * Compiler macro for `(list-ref ...)` expressions.
 */
function compileListRefMacro(exp, env) {
...
compileListRefMacro.fsource = [Symbol.for('define'), [Symbol.for('compile-list-ref-macro'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define-values'), [Symbol.for('lst'), Symbol.for('.'), Symbol.for('indices')], [Symbol.for('rest'), Symbol.for('exp')]], [Symbol.for('define-fields'), [Symbol.for('fdottedlists')], [Symbol.for('current-compilation-options')]], [Symbol.for('cond'), [Symbol.for('fdottedlists'), [Symbol.for('quasiquote'), [Symbol.for('funcall'), Symbol.for('list-ref'), [Symbol.for('unquote'), Symbol.for('lst')], [Symbol.for('unquote-splicing'), Symbol.for('indices')]]]], [Symbol.for('else'), [Symbol.for('quasiquote'), [Symbol.for('array-ref'), [Symbol.for('unquote'), Symbol.for('lst')], [Symbol.for('unquote-splicing'), Symbol.for('indices')]]]]]];
compileListRefMacro.ftype = 'macro';
/**
 * Compiler macro for `(list-set! ...)` expressions.
 */
function compileListSetXMacro(exp, env) {
...
compileListSetXMacro.fsource = [Symbol.for('define'), [Symbol.for('compile-list-set!-macro'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define-values'), [Symbol.for('lst'), Symbol.for('.'), Symbol.for('indices-and-value')], [Symbol.for('rest'), Symbol.for('exp')]], [Symbol.for('define-fields'), [Symbol.for('fdottedlists')], [Symbol.for('current-compilation-options')]], [Symbol.for('cond'), [Symbol.for('fdottedlists'), [Symbol.for('quasiquote'), [Symbol.for('funcall'), Symbol.for('list-set!'), [Symbol.for('unquote'), Symbol.for('lst')], [Symbol.for('unquote-splicing'), Symbol.for('indices-and-value')]]]], [Symbol.for('else'), [Symbol.for('quasiquote'), [Symbol.for('array-set!'), [Symbol.for('unquote'), Symbol.for('lst')], [Symbol.for('unquote-splicing'), Symbol.for('indices-and-value')]]]]]];
compileListSetXMacro.ftype = 'macro';
/**
 * Compiler macro for `(array-ref ...)` expressions.
 */
function compileArrayRefMacro(exp, env) {
    const [arr, ...indices] = exp.slice(1);
    return [Symbol.for('js/get'), arr, ...indices];
}
compileArrayRefMacro.fsource = [Symbol.for('define'), [Symbol.for('compile-array-ref-macro'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define-values'), [Symbol.for('arr'), Symbol.for('.'), Symbol.for('indices')], [Symbol.for('rest'), Symbol.for('exp')]], [Symbol.for('quasiquote'), [Symbol.for('js/get'), [Symbol.for('unquote'), Symbol.for('arr')], [Symbol.for('unquote-splicing'), Symbol.for('indices')]]]];
compileArrayRefMacro.ftype = 'macro';
/**
 * Compiler macro for `(array-set! ...)` expressions.
 */
function compileArraySetXMacro(exp, env) {
    const [arr, ...indicesAndValue] = exp.slice(1);
    const indices = indicesAndValue.slice(0, -1);
    let value = indicesAndValue.at(-1);
    return [Symbol.for('js/='), [Symbol.for('js/get'), arr, ...indices], value];
}
compileArraySetXMacro.fsource = [Symbol.for('define'), [Symbol.for('compile-array-set!-macro'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define-values'), [Symbol.for('arr'), Symbol.for('.'), Symbol.for('indices-and-value')], [Symbol.for('rest'), Symbol.for('exp')]], [Symbol.for('define'), Symbol.for('indices'), [Symbol.for('drop-right'), Symbol.for('indices-and-value'), 1]], [Symbol.for('define'), Symbol.for('value'), [Symbol.for('last'), Symbol.for('indices-and-value')]], [Symbol.for('quasiquote'), [Symbol.for('js/='), [Symbol.for('js/get'), [Symbol.for('unquote'), Symbol.for('arr')], [Symbol.for('unquote-splicing'), Symbol.for('indices')]], [Symbol.for('unquote'), Symbol.for('value')]]]];
compileArraySetXMacro.ftype = 'macro';
/**
...
function flipFunctionExpression(exp, env) {
    ...
    else if ((0, util_1.formp)(exp, lambda_, env) && (exp[1].length >= 2)) {
...
compileFuncall.fsource = [Symbol.for('define'), [Symbol.for('compile-funcall'), Symbol.for('node'), Symbol.for('env'), [Symbol.for('options'), [Symbol.for('js/obj')]]], [Symbol.for('define-fields'), [Symbol.for('should-import')], Symbol.for('options')], [Symbol.for('compile-function-call'), [Symbol.for('slice-rose'), Symbol.for('node'), 1], Symbol.for('env'), Symbol.for('options'), [Symbol.for('js/obj'), Symbol.for(':should-import'), Symbol.for('should-import')]]];
/**
 * Compile a function call.
 */
function compileFunctionCall(node, env, options = {}, settings = {}) {
 ...
 */
function compileFunction(node, env, options = {}, settings = {}) {
    ...
    let returnType = settings['returnType'] || ((0, util_1.taggedListP)(type_, Symbol.for('->')) ? type_.at(-1) : undefined);
    ...
    let body = compileStatementOrReturnStatement((0, rose_1.datumToSyntax)(node, [Symbol.for('js/block'), ...bodyStatements]), env1, Object.assign(Object.assign({}, inheritedOptions), { expressionType: (returnType === Symbol.for('Void')) ? 'statement' : 'return' }));
    let result = undefined;
...
jsRename_.fsource = [Symbol.for('define'), [Symbol.for('js/rename_'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define-values'), [Symbol.for('renamings'), Symbol.for('.'), Symbol.for('body')], [Symbol.for('rest'), Symbol.for('exp')]], [Symbol.for('let'), [[Symbol.for('renaming-map'), [Symbol.for('new'), Symbol.for('Map'), Symbol.for('renamings')]]], [Symbol.for('quasiquote'), [Symbol.for('begin'), [Symbol.for('unquote-splicing'), [Symbol.for('map-tree'), [Symbol.for('lambda'), [Symbol.for('x')], [Symbol.for('cond'), [[Symbol.for('and'), [Symbol.for('symbol?'), Symbol.for('x')], [Symbol.for('hash-has-key?'), Symbol.for('renaming-map'), Symbol.for('x')]], [Symbol.for('hash-ref'), Symbol.for('renaming-map'), Symbol.for('x')]], [Symbol.for('else'), Symbol.for('x')]]], Symbol.for('body')]]]]]];
jsRename_.ftype = 'macro';
/**
 * Compile a `(js/statement-or-expression ...)` expression.
 */
function compileJsStatementOrExpression(node, env, options = {}) {
    const expressionType = options['expressionType'];
    let plist = node.drop(1).map(function (x) {
...
function compileLetStar(node, env, options = {}) {
    ...
    if (expressionType === 'expression') {
        ...
        const defineNodes = letNodes.map(function (x) {
            ...
            if (Array.isArray(exp)) {
                let sym = exp[0];
                if (!makeBlock && env.hasLocalP(// has?
                sym, {
                    filter: langFilter
                })) {
                    makeBlock = true;
...
function compileDefineValues(node, env, options = {}) {
    ...
    if (typeof variables === 'symbol') {
        ...
        if (Array.isArray(variables) && (variables.length >= 3) && (variables.at(-2) === Symbol.for('.'))) {
            const varList = flatten(variables);
            regularVars = varList.slice(0, -1);
            restVar = varList.at(-1);
        }
        else {
...
function compileSetValues(node, env, options = {}) {
    ...
    if (typeof variablesExp === 'symbol') {
        ...
        if (Array.isArray(variablesExp) && (variablesExp.length >= 3) && (variablesExp.at(-2) === Symbol.for('.'))) {
    ...
    return compileJsAssignment((0, rose_1.datumToSyntax)(node, [Symbol.for('js/='), [Symbol.for('quote'), left], right]), env, options);
}
...
function compileSetFields(node, env, options = {}) {
    ...
    return compileJsAssignment((0, rose_1.datumToSyntax)(node, [Symbol.for('js/='), [Symbol.for('js/obj'), ...properties], expression]), env, options);
}
...
function macroexpandstar1(exp, env = undefined) {
    ...
    let expansion = exp;
    let expanded = false;
    if (!(Array.isArray(exp1) && !((exp1.length >= 3) && (exp1.at(-2) === Symbol.for('.')) && !Array.isArray(exp1.at(-1))))) {
        expansion = exp1;
    }
...
compileBegin.fsource = [Symbol.for('define'), [Symbol.for('compile-begin'), Symbol.for('node'), Symbol.for('env'), [Symbol.for('options'), [Symbol.for('js/obj')]]], [Symbol.for('define'), Symbol.for('language-env'), [Symbol.for('oget'), Symbol.for('options'), Symbol.for(':language-environment')]], [Symbol.for('define'), [Symbol.for('lang-filter'), Symbol.for('x')], [Symbol.for('not'), [Symbol.for('eq?'), Symbol.for('x'), Symbol.for('language-env')]]], [Symbol.for('define'), Symbol.for('expression-type'), [Symbol.for('oget'), Symbol.for('options'), Symbol.for(':expression-type')]], [Symbol.for('define'), Symbol.for('exp'), [Symbol.for('syntax->datum'), Symbol.for('node')]], [Symbol.for('define'), Symbol.for('body'), [Symbol.for('send'), Symbol.for('node'), Symbol.for('drop'), 1]], [Symbol.for('define'), Symbol.for('compiled-body'), [Symbol.for('quote'), []]], [Symbol.for('for'), [[Symbol.for('i'), [Symbol.for('range'), 0, [Symbol.for('length'), Symbol.for('body')]]]], [Symbol.for('define'), Symbol.for('exp'), [Symbol.for('syntax->datum'), [Symbol.for('list-ref'), Symbol.for('body'), Symbol.for('i')]]], [Symbol.for('cond'), [[Symbol.for('form?'), Symbol.for('exp'), Symbol.for('define_'), Symbol.for('env')], [Symbol.for('define'), Symbol.for('sym'), [Symbol.for('if'), [Symbol.for('pair-or-list?'), [Symbol.for('second'), Symbol.for('exp')]], [Symbol.for('first'), [Symbol.for('second'), Symbol.for('exp')]], [Symbol.for('second'), Symbol.for('exp')]]], [Symbol.for('make-type-binding'), Symbol.for('env'), Symbol.for('sym'), [Symbol.for('quote'), Symbol.for('Any')], Symbol.for('lang-filter')]], [[Symbol.for('form?'), Symbol.for('exp'), Symbol.for('define-macro_'), Symbol.for('env')], [Symbol.for('define'), Symbol.for('sym'), [Symbol.for('first'), [Symbol.for('second'), Symbol.for('exp')]]], [Symbol.for('make-type-binding'), Symbol.for('env'), Symbol.for('sym'), [Symbol.for('quote'), [Symbol.for('macro->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], Symbol.for('lang-filter')]], [[Symbol.for('form?'), Symbol.for('exp'), Symbol.for('defmacro_'), Symbol.for('env')], [Symbol.for('define'), Symbol.for('sym'), [Symbol.for('second'), Symbol.for('exp')]], [Symbol.for('make-type-binding'), Symbol.for('env'), Symbol.for('sym'), [Symbol.for('quote'), [Symbol.for('macro->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]], Symbol.for('lang-filter')]]]], [Symbol.for('cond'), [[Symbol.for('eq?'), Symbol.for('expression-type'), 'expression'], [Symbol.for('cond'), [[Symbol.for('='), [Symbol.for('length'), Symbol.for('exp')], 2], [Symbol.for('compile-expression'), [Symbol.for('send'), Symbol.for('node'), Symbol.for('get'), 1], Symbol.for('env'), Symbol.for('options')]], [Symbol.for('else'), [Symbol.for('define'), Symbol.for('statements'), [Symbol.for('compile-statements'), Symbol.for('body'), Symbol.for('env'), [Symbol.for('make-statement-options'), Symbol.for('options')]]], [Symbol.for('define'), Symbol.for('only-expressions'), true], [Symbol.for('define'), Symbol.for('expressions'), [Symbol.for('quote'), []]], [Symbol.for('for'), [[Symbol.for('x'), Symbol.for('statements')]], [Symbol.for('cond'), [[Symbol.for('estree-type?'), Symbol.for('x'), 'ExpressionStatement'], [Symbol.for('push-right!'), Symbol.for('expressions'), [Symbol.for('get-field'), Symbol.for('expression'), Symbol.for('x')]]], [Symbol.for('else'), [Symbol.for('set!'), Symbol.for('only-expressions'), false], [Symbol.for('break')]]]], [Symbol.for('cond'), [Symbol.for('only-expressions'), [Symbol.for('new'), Symbol.for('SequenceExpression'), Symbol.for('expressions')]], [Symbol.for('else'), [Symbol.for('compile-expression'), [Symbol.for('make-iife'), Symbol.for('node')], Symbol.for('env'), Symbol.for('options')]]]]]], [Symbol.for('else'), [Symbol.for('define'), Symbol.for('statements'), [Symbol.for('compile-statements'), Symbol.for('body'), Symbol.for('env'), Symbol.for('options')]], [Symbol.for('make-program-fragment'), Symbol.for('statements')]]]];
/**
 ...
 */
function compileJsSequence(node, env, options = {}) {
    const expressions = node.drop(1);
    return makeExpressionOrStatement(new estree_1.SequenceExpression(expressions.map(function (x) {
        return compileExpression(x, env, options);
    })), options);
}
compileJsSequence.fsource = [Symbol.for('define'), [Symbol.for('compile-js/sequence'), Symbol.for('node'), Symbol.for('env'), [Symbol.for('options'), [Symbol.for('js/obj')]]], [Symbol.for('define'), Symbol.for('expressions'), [Symbol.for('send'), Symbol.for('node'), Symbol.for('drop'), 1]], [Symbol.for('make-expression-or-statement'), [Symbol.for('new'), Symbol.for('SequenceExpression'), [Symbol.for('map'), [Symbol.for('lambda'), [Symbol.for('x')], [Symbol.for('compile-expression'), Symbol.for('x'), Symbol.for('env'), Symbol.for('options')]], Symbol.for('expressions')]], Symbol.for('options')]];
/**
...
function makeInlinedValue(symbol, env, options) {
    ...
    if (globalEnvironmentExp.length > 1) {
        ...
        const valuesExp = lambdaExp.at(-1);
        let sym = valuesExp[1];
...
function compileQuasiquoteHelper(level, node, env, options = {}) {
    ...
    function compileUnquoteExp(node, level, splicing = false) {
        if (level > 1) {
            ...
            if (node.size() === 2) {
                let result = compileQuasiquoteHelper(level - 1, node.get(1), env, options);
                if (splicing) {
    ...
    compileUnquoteExp.fsource = [Symbol.for('define'), [Symbol.for('compile-unquote-exp'), Symbol.for('node'), Symbol.for('level'), [Symbol.for('splicing'), false]], [Symbol.for('cond'), [[Symbol.for('>'), Symbol.for('level'), 1], [Symbol.for('define'), Symbol.for('sym'), [Symbol.for('compile-symbol'), [Symbol.for('send'), Symbol.for('node'), Symbol.for('get'), 0], Symbol.for('env'), Symbol.for('options'), [Symbol.for('js/obj'), Symbol.for(':quoted-symbol'), true]]], [Symbol.for('define'), Symbol.for('result'), [Symbol.for('new'), Symbol.for('ArrayExpression'), [Symbol.for('list'), Symbol.for('sym')]]], [Symbol.for('for'), [[Symbol.for('x'), [Symbol.for('send'), Symbol.for('node'), Symbol.for('drop'), 1]]], [Symbol.for('insert-into-array-exp!'), [Symbol.for('compile-quasiquote-helper'), [Symbol.for('-'), Symbol.for('level'), 1], Symbol.for('x'), Symbol.for('env'), Symbol.for('options')], Symbol.for('result')]], [Symbol.for('define'), Symbol.for('elements'), [Symbol.for('get-field'), Symbol.for('elements'), Symbol.for('result')]], [Symbol.for('when'), [Symbol.for('>'), [Symbol.for('length'), Symbol.for('elements')], 2], [Symbol.for('set!'), Symbol.for('result'), [Symbol.for('new'), Symbol.for('SpreadElement'), [Symbol.for('new'), Symbol.for('ArrayExpression'), [Symbol.for('map'), [Symbol.for('lambda'), [Symbol.for('x')], [Symbol.for('new'), Symbol.for('ArrayExpression'), [Symbol.for('list'), Symbol.for('sym'), Symbol.for('x')]]], [Symbol.for('drop'), Symbol.for('elements'), 1]]]]]], Symbol.for('result')], [Symbol.for('else'), [Symbol.for('cond'), [[Symbol.for('='), [Symbol.for('send'), Symbol.for('node'), Symbol.for('size')], 2], [Symbol.for('define'), Symbol.for('result'), [Symbol.for('compile-quasiquote-helper'), [Symbol.for('-'), Symbol.for('level'), 1], [Symbol.for('send'), Symbol.for('node'), Symbol.for('get'), 1], Symbol.for('env'), Symbol.for('options')]], [Symbol.for('when'), Symbol.for('splicing'), [Symbol.for('set!'), Symbol.for('result'), [Symbol.for('new'), Symbol.for('SpreadElement'), Symbol.for('result')]]], Symbol.for('result')], [Symbol.for('else'), [Symbol.for('define'), Symbol.for('result'), [Symbol.for('new'), Symbol.for('ArrayExpression'), [Symbol.for('quote'), []]]], [Symbol.for('for'), [[Symbol.for('x'), [Symbol.for('send'), Symbol.for('node'), Symbol.for('drop'), 1]]], [Symbol.for('define'), Symbol.for('element'), [Symbol.for('compile-quasiquote-helper'), [Symbol.for('-'), Symbol.for('level'), 1], Symbol.for('x'), Symbol.for('env'), Symbol.for('options')]], [Symbol.for('when'), Symbol.for('splicing'), [Symbol.for('set!'), Symbol.for('element'), [Symbol.for('new'), Symbol.for('SpreadElement'), Symbol.for('element')]]], [Symbol.for('insert-into-array-exp!'), Symbol.for('element'), Symbol.for('result')]], [Symbol.for('new'), Symbol.for('SpreadElement'), Symbol.for('result')]]]]]];
    if (level === 0) {
        return compileExpression(node, env, options);
    }
    else {
        ...
        if (Array.isArray(exp)) {
            if ((0, util_1.taggedListP)(exp, Symbol.for('quasiquote'))) {
                return new estree_1.ArrayExpression([compileSymbol(node.get(0), env, options, {
                        quotedSymbol: true
                    }), compileQuasiquoteHelper(level + 1, node.get(1), env, options)]);
            }
            else if ((0, util_1.taggedListP)(exp, Symbol.for('unquote'))) {
                return compileUnquoteExp(node, level);
            }
            else if ((0, util_1.taggedListP)(exp, Symbol.for('unquote-splicing'))) {
                return compileUnquoteExp(node, level, true);
            }
            else {
                let result = new estree_1.ArrayExpression([]);
                for (let node1 of node.getNodes()) {
                    insertIntoArrayExpX(compileQuasiquoteHelper(level, node1, env, options), result);
                }
                return result;
            }
        }
...
compileQuasiquoteHelper.fsource = [Symbol.for('define'), [Symbol.for('compile-quasiquote-helper'), Symbol.for('level'), Symbol.for('node'), Symbol.for('env'), [Symbol.for('options'), [Symbol.for('js/obj')]]], [Symbol.for('define'), [Symbol.for('compile-unquote-exp'), Symbol.for('node'), Symbol.for('level'), [Symbol.for('splicing'), false]], [Symbol.for('cond'), [[Symbol.for('>'), Symbol.for('level'), 1], [Symbol.for('define'), Symbol.for('sym'), [Symbol.for('compile-symbol'), [Symbol.for('send'), Symbol.for('node'), Symbol.for('get'), 0], Symbol.for('env'), Symbol.for('options'), [Symbol.for('js/obj'), Symbol.for(':quoted-symbol'), true]]], [Symbol.for('define'), Symbol.for('result'), [Symbol.for('new'), Symbol.for('ArrayExpression'), [Symbol.for('list'), Symbol.for('sym')]]], [Symbol.for('for'), [[Symbol.for('x'), [Symbol.for('send'), Symbol.for('node'), Symbol.for('drop'), 1]]], [Symbol.for('insert-into-array-exp!'), [Symbol.for('compile-quasiquote-helper'), [Symbol.for('-'), Symbol.for('level'), 1], Symbol.for('x'), Symbol.for('env'), Symbol.for('options')], Symbol.for('result')]], [Symbol.for('define'), Symbol.for('elements'), [Symbol.for('get-field'), Symbol.for('elements'), Symbol.for('result')]], [Symbol.for('when'), [Symbol.for('>'), [Symbol.for('length'), Symbol.for('elements')], 2], [Symbol.for('set!'), Symbol.for('result'), [Symbol.for('new'), Symbol.for('SpreadElement'), [Symbol.for('new'), Symbol.for('ArrayExpression'), [Symbol.for('map'), [Symbol.for('lambda'), [Symbol.for('x')], [Symbol.for('new'), Symbol.for('ArrayExpression'), [Symbol.for('list'), Symbol.for('sym'), Symbol.for('x')]]], [Symbol.for('drop'), Symbol.for('elements'), 1]]]]]], Symbol.for('result')], [Symbol.for('else'), [Symbol.for('cond'), [[Symbol.for('='), [Symbol.for('send'), Symbol.for('node'), Symbol.for('size')], 2], [Symbol.for('define'), Symbol.for('result'), [Symbol.for('compile-quasiquote-helper'), [Symbol.for('-'), Symbol.for('level'), 1], [Symbol.for('send'), Symbol.for('node'), Symbol.for('get'), 1], Symbol.for('env'), Symbol.for('options')]], [Symbol.for('when'), Symbol.for('splicing'), [Symbol.for('set!'), Symbol.for('result'), [Symbol.for('new'), Symbol.for('SpreadElement'), Symbol.for('result')]]], Symbol.for('result')], [Symbol.for('else'), [Symbol.for('define'), Symbol.for('result'), [Symbol.for('new'), Symbol.for('ArrayExpression'), [Symbol.for('quote'), []]]], [Symbol.for('for'), [[Symbol.for('x'), [Symbol.for('send'), Symbol.for('node'), Symbol.for('drop'), 1]]], [Symbol.for('define'), Symbol.for('element'), [Symbol.for('compile-quasiquote-helper'), [Symbol.for('-'), Symbol.for('level'), 1], Symbol.for('x'), Symbol.for('env'), Symbol.for('options')]], [Symbol.for('when'), Symbol.for('splicing'), [Symbol.for('set!'), Symbol.for('element'), [Symbol.for('new'), Symbol.for('SpreadElement'), Symbol.for('element')]]], [Symbol.for('insert-into-array-exp!'), Symbol.for('element'), Symbol.for('result')]], [Symbol.for('new'), Symbol.for('SpreadElement'), Symbol.for('result')]]]]]], [Symbol.for('cond'), [[Symbol.for('zero?'), Symbol.for('level')], [Symbol.for('compile-expression'), Symbol.for('node'), Symbol.for('env'), Symbol.for('options')]], [Symbol.for('else'), [Symbol.for('define'), Symbol.for('exp'), [Symbol.for('syntax->datum'), Symbol.for('node')]], [Symbol.for('cond'), [[Symbol.for('pair-or-list?'), Symbol.for('exp')], [Symbol.for('cond'), [[Symbol.for('tagged-list?'), Symbol.for('exp'), [Symbol.for('quote'), Symbol.for('quasiquote')]], [Symbol.for('new'), Symbol.for('ArrayExpression'), [Symbol.for('list'), [Symbol.for('compile-symbol'), [Symbol.for('send'), Symbol.for('node'), Symbol.for('get'), 0], Symbol.for('env'), Symbol.for('options'), [Symbol.for('js/obj'), Symbol.for(':quoted-symbol'), true]], [Symbol.for('compile-quasiquote-helper'), [Symbol.for('+'), Symbol.for('level'), 1], [Symbol.for('send'), Symbol.for('node'), Symbol.for('get'), 1], Symbol.for('env'), Symbol.for('options')]]]], [[Symbol.for('tagged-list?'), Symbol.for('exp'), [Symbol.for('quote'), Symbol.for('unquote')]], [Symbol.for('compile-unquote-exp'), Symbol.for('node'), Symbol.for('level')]], [[Symbol.for('tagged-list?'), Symbol.for('exp'), [Symbol.for('quote'), Symbol.for('unquote-splicing')]], [Symbol.for('compile-unquote-exp'), Symbol.for('node'), Symbol.for('level'), true]], [Symbol.for('else'), [Symbol.for('define'), Symbol.for('result'), [Symbol.for('new'), Symbol.for('ArrayExpression'), [Symbol.for('quote'), []]]], [Symbol.for('for'), [[Symbol.for('node1'), [Symbol.for('send'), Symbol.for('node'), Symbol.for('get-nodes')]]], [Symbol.for('insert-into-array-exp!'), [Symbol.for('compile-quasiquote-helper'), Symbol.for('level'), Symbol.for('node1'), Symbol.for('env'), Symbol.for('options')], Symbol.for('result')]], Symbol.for('result')]]], [[Symbol.for('symbol?'), Symbol.for('exp')], [Symbol.for('compile-symbol'), Symbol.for('node'), Symbol.for('env'), Symbol.for('options'), [Symbol.for('js/obj'), Symbol.for(':quoted-symbol'), true]]], [Symbol.for('else'), [Symbol.for('compile-expression'), Symbol.for('node'), Symbol.for('env'), Symbol.for('options')]]]]]];
/**
...
compileString.fsource = [Symbol.for('define'), [Symbol.for('compile-string'), Symbol.for('node'), Symbol.for('env'), [Symbol.for('options'), [Symbol.for('js/obj')]]], [Symbol.for('define'), Symbol.for('str'), [Symbol.for('syntax->datum'), Symbol.for('node')]], [Symbol.for('cond'), [[Symbol.for('regexp-match'), [Symbol.for('regexp'), '\\n'], Symbol.for('str')], [Symbol.for('define'), Symbol.for('lines'), [Symbol.for('string-split'), Symbol.for('str'), [Symbol.for('regexp'), '^', 'gm']]], [Symbol.for('cond'), [[Symbol.for('<='), [Symbol.for('length'), Symbol.for('lines')], 1], [Symbol.for('compile-atom'), Symbol.for('node'), Symbol.for('env'), Symbol.for('options')]], [Symbol.for('else'), [Symbol.for('compile-syntax'), [Symbol.for('transfer-comments'), Symbol.for('node'), [Symbol.for('datum->syntax'), Symbol.for('node'), [Symbol.for('quasiquote'), [Symbol.for('string-append'), [Symbol.for('unquote-splicing'), Symbol.for('lines')]]]]], Symbol.for('env'), Symbol.for('options')]]]], [Symbol.for('else'), [Symbol.for('compile-atom'), Symbol.for('node'), Symbol.for('env'), Symbol.for('options')]]]];
/**
 * Compile a `(- ...)` expression.
 */
...
compileSub.fsource = [Symbol.for('define'), [Symbol.for('compile-sub'), Symbol.for('node'), Symbol.for('env'), [Symbol.for('options'), [Symbol.for('js/obj')]]], [Symbol.for('define'), Symbol.for('exp'), [Symbol.for('syntax->datum'), Symbol.for('node')]], [Symbol.for('cond'), [[Symbol.for('='), [Symbol.for('length'), Symbol.for('exp')], 2], [Symbol.for('define'), Symbol.for('num'), [Symbol.for('send'), Symbol.for('node'), Symbol.for('get'), 1]], [Symbol.for('define'), Symbol.for('num-compiled'), [Symbol.for('compile-expression'), Symbol.for('num'), Symbol.for('env'), Symbol.for('options')]], [Symbol.for('make-expression-or-statement'), [Symbol.for('new'), Symbol.for('UnaryExpression'), '-', true, Symbol.for('num-compiled')], Symbol.for('options')]], [Symbol.for('else'), [Symbol.for('compile-binary-expression'), Symbol.for('node'), Symbol.for('env'), Symbol.for('options'), [Symbol.for('js/obj'), Symbol.for(':identity'), 0, Symbol.for(':operator'), '-']]]]];
/**
...
function compileJsWhile(node, env, options = {}) {
    ...
    let body = (0, rose_1.beginWrapRose)(node.drop(2));
...
function compileJsFor(node, env, options = {}) {
    const env1 = (0, env_1.extendEnvironment)(new env_1.LispEnvironment(), env);
    let body = (0, rose_1.datumToSyntax)(node, [Symbol.for('js/block'), ...node.drop(2)]);
 ...
 */
function compileJsStringConcat(node, env, options = {}) {
    let exp = (0, rose_1.syntaxToDatum)(node);
    if (exp.length <= 1) {
        return compileSyntax((0, rose_1.datumToSyntax)(node, ''), env, options);
    }
    else if (exp.length === 2) {
        return compileSyntax(node.get(1), env, options);
    }
...
compileJsStringConcat.fsource = [Symbol.for('define'), [Symbol.for('compile-js/string-concat'), Symbol.for('node'), Symbol.for('env'), [Symbol.for('options'), [Symbol.for('js/obj')]]], [Symbol.for('define'), Symbol.for('exp'), [Symbol.for('syntax->datum'), Symbol.for('node')]], [Symbol.for('cond'), [[Symbol.for('<='), [Symbol.for('length'), Symbol.for('exp')], 1], [Symbol.for('compile-syntax'), [Symbol.for('datum->syntax'), Symbol.for('node'), ''], Symbol.for('env'), Symbol.for('options')]], [[Symbol.for('='), [Symbol.for('length'), Symbol.for('exp')], 2], [Symbol.for('compile-syntax'), [Symbol.for('send'), Symbol.for('node'), Symbol.for('get'), 1], Symbol.for('env'), Symbol.for('options')]], [Symbol.for('else'), [Symbol.for('compile-binary-expression'), Symbol.for('node'), Symbol.for('env'), Symbol.for('options'), [Symbol.for('js/obj'), Symbol.for(':identity'), '', Symbol.for(':operator'), '+']]]]];
/**
...
function compileClassHelper(node, env, options = {}) {
    ...
    let superClass = null;
    let id = hasName ? compileSymbol(classNameNode, env, inheritedOptions) : null;
...
compileJsObj.fsource = [Symbol.for('define'), [Symbol.for('compile-js/obj'), Symbol.for('node'), Symbol.for('env'), [Symbol.for('options'), [Symbol.for('js/obj')]]], [Symbol.for('define'), Symbol.for('exp'), [Symbol.for('syntax->datum'), Symbol.for('node')]], [Symbol.for('define'), Symbol.for('properties'), [Symbol.for('quote'), []]], [Symbol.for('define'), Symbol.for('i'), 1], [Symbol.for('while'), [Symbol.for('<'), Symbol.for('i'), [Symbol.for('length'), Symbol.for('exp')]], [Symbol.for('define'), Symbol.for('key-node'), [Symbol.for('send'), Symbol.for('node'), Symbol.for('get'), Symbol.for('i')]], [Symbol.for('cond'), [[Symbol.for('tagged-list?'), Symbol.for('key-node'), [Symbol.for('quote'), Symbol.for('js/obj-spread')]], [Symbol.for('define'), Symbol.for('compiled-key'), [Symbol.for('compile-expression'), Symbol.for('key-node'), Symbol.for('env'), Symbol.for('options')]], [Symbol.for('push-right!'), Symbol.for('properties'), Symbol.for('compiled-key')], [Symbol.for('set!'), Symbol.for('i'), [Symbol.for('+'), Symbol.for('i'), 1]]], [Symbol.for('else'), [Symbol.for('define'), Symbol.for('key-exp'), [Symbol.for('syntax->datum'), Symbol.for('key-node')]], [Symbol.for('define'), Symbol.for('computed'), [Symbol.for('not'), [Symbol.for('string?'), Symbol.for('key-exp')]]], [Symbol.for('define'), Symbol.for('val-node'), [Symbol.for('send'), Symbol.for('node'), Symbol.for('get'), [Symbol.for('+'), Symbol.for('i'), 1]]], [Symbol.for('define'), Symbol.for('is-quoted-symbol'), false], [Symbol.for('when'), [Symbol.for('and'), [Symbol.for('quoted-expression?'), Symbol.for('key-exp')], [Symbol.for('symbol?'), [Symbol.for('second'), Symbol.for('key-exp')]]], [Symbol.for('set!'), Symbol.for('key-exp'), [Symbol.for('second'), Symbol.for('key-exp')]], [Symbol.for('set!'), Symbol.for('key-node'), [Symbol.for('datum->syntax'), Symbol.for('key-node'), Symbol.for('key-exp')]], [Symbol.for('set!'), Symbol.for('is-quoted-symbol'), true], [Symbol.for('set!'), Symbol.for('computed'), false]], [Symbol.for('when'), [Symbol.for('keyword?'), Symbol.for('key-exp')], [Symbol.for('set!'), Symbol.for('key-exp'), [Symbol.for('keyword->symbol_'), Symbol.for('key-exp')]], [Symbol.for('set!'), Symbol.for('key-node'), [Symbol.for('datum->syntax'), Symbol.for('key-node'), Symbol.for('key-exp')]], [Symbol.for('set!'), Symbol.for('is-quoted-symbol'), true], [Symbol.for('set!'), Symbol.for('computed'), false]], [Symbol.for('define'), Symbol.for('compiled-key'), [Symbol.for('if'), Symbol.for('is-quoted-symbol'), [Symbol.for('compile-symbol'), Symbol.for('key-node'), Symbol.for('env'), Symbol.for('options')], [Symbol.for('compile-expression'), Symbol.for('key-node'), Symbol.for('env'), Symbol.for('options')]]], [Symbol.for('define'), Symbol.for('compiled-value'), [Symbol.for('compile-expression'), Symbol.for('val-node'), Symbol.for('env'), Symbol.for('options')]], [Symbol.for('when'), [Symbol.for('and'), [Symbol.for('string?'), Symbol.for('key-exp')], [Symbol.for('regexp-match'), [Symbol.for('regexp'), '^[a-z]+$', 'i'], Symbol.for('key-exp')]], [Symbol.for('set!'), Symbol.for('compiled-key'), [Symbol.for('new'), Symbol.for('Identifier'), Symbol.for('key-exp')]]], [Symbol.for('define'), Symbol.for('shorthand'), [Symbol.for('and'), [Symbol.for('not'), Symbol.for('computed')], [Symbol.for('estree-type?'), Symbol.for('compiled-key'), 'Identifier'], [Symbol.for('estree-type?'), Symbol.for('compiled-value'), 'Identifier'], [Symbol.for('eq?'), [Symbol.for('get-field'), Symbol.for('name'), Symbol.for('compiled-key')], [Symbol.for('get-field'), Symbol.for('name'), Symbol.for('compiled-value')]]]], [Symbol.for('push-right!'), Symbol.for('properties'), [Symbol.for('new'), Symbol.for('Property'), Symbol.for('compiled-key'), Symbol.for('compiled-value'), Symbol.for('computed'), Symbol.for('shorthand')]], [Symbol.for('set!'), Symbol.for('i'), [Symbol.for('+'), Symbol.for('i'), 2]]]]], [Symbol.for('make-expression-or-statement'), [Symbol.for('new'), Symbol.for('ObjectExpression'), Symbol.for('properties')], Symbol.for('options')]];
/**
...
function compileMakeHashMacro(exp, env) {
    ...
    if (assocs) {
        if (((0, util_1.taggedListP)(assocs, Symbol.for('quasiquote')) || (0, util_1.taggedListP)(assocs, Symbol.for('quote'))) && ((x) => {
            return Array.isArray(x) && !((x.length >= 3) && (x.at(-2) === Symbol.for('.')) && !Array.isArray(x.at(-1)));
...
function compileMapMacroHelper(fExp, env) {
    ...
    else if (((0, util_1.formp)(fExp, lambda_, env) || (0, util_1.formp)(fExp, jsFunction_, env) || (0, util_1.formp)(fExp, jsArrow_, env)) && Array.isArray(fExp[1]) && (fExp[1].length === 1)) {
...
compileStringPMacro.fsource = [Symbol.for('define'), [Symbol.for('compile-string?-macro'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define-values'), [Symbol.for('x')], [Symbol.for('rest'), Symbol.for('exp')]], [Symbol.for('define-fields'), [Symbol.for('fstringobjects')], [Symbol.for('current-compilation-options')]], [Symbol.for('cond'), [Symbol.for('fstringobjects'), [Symbol.for('quasiquote'), [Symbol.for('funcall'), Symbol.for('string?'), [Symbol.for('unquote'), Symbol.for('x')]]]], [Symbol.for('else'), [Symbol.for('quasiquote'), [Symbol.for('js/string-literal?'), [Symbol.for('unquote'), Symbol.for('x')]]]]]];
compileStringPMacro.ftype = 'macro';
/**
 * Compiler macro for `(string-append ...)` expressions.
 */
function compileStringAppendMacro(exp, env) {
    const args = exp.slice(1);
    return [Symbol.for('js/string-concat'), ...args];
}
compileStringAppendMacro.fsource = [Symbol.for('define'), [Symbol.for('compile-string-append-macro'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define-values'), Symbol.for('args'), [Symbol.for('rest'), Symbol.for('exp')]], [Symbol.for('quasiquote'), [Symbol.for('js/string-concat'), [Symbol.for('unquote-splicing'), Symbol.for('args')]]]];
compileStringAppendMacro.ftype = 'macro';
/**
 * Compiler macro for `(js/string-concat ...)` expressions.
 */
function compileJsStringConcatMacro(exp, env) {
    const args = exp.slice(1);
    return [Symbol.for('js/op/apply'), Symbol.for('+'), [Symbol.for('list'), ...args], Symbol.for(':identity'), ''];
}
compileJsStringConcatMacro.fsource = [Symbol.for('define'), [Symbol.for('compile-js/string-concat-macro'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define-values'), Symbol.for('args'), [Symbol.for('rest'), Symbol.for('exp')]], [Symbol.for('quasiquote'), [Symbol.for('js/op/apply'), Symbol.for('+'), [Symbol.for('list'), [Symbol.for('unquote-splicing'), Symbol.for('args')]], Symbol.for(':identity'), '']]];
compileJsStringConcatMacro.ftype = 'macro';
/**
...
jsSequence_.fsource = [Symbol.for('define'), [Symbol.for('js/sequence_'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('compile-sexp'), Symbol.for('exp'), Symbol.for('env'), [Symbol.for('current-compilation-options')]]];
...
jsVar_.fsource = [Symbol.for('define'), [Symbol.for('js/var_'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('compile-sexp'), Symbol.for('exp'), Symbol.for('env'), [Symbol.for('current-compilation-options')]]];
jsVar_.ftype = 'macro';
/**
...
jsLet_.fsource = [Symbol.for('define'), [Symbol.for('js/let_'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('compile-sexp'), Symbol.for('exp'), Symbol.for('env'), [Symbol.for('current-compilation-options')]]];
jsLet_.ftype = 'macro';
/**
...
jsConst_.fsource = [Symbol.for('define'), [Symbol.for('js/const_'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('compile-sexp'), Symbol.for('exp'), Symbol.for('env'), [Symbol.for('current-compilation-options')]]];
...
jsStatementOrExpression_.fsource = [Symbol.for('define'), [Symbol.for('js/statement-or-expression_'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('compile-sexp'), Symbol.for('exp'), Symbol.for('env'), [Symbol.for('current-compilation-options')]]];
 ...
 * in bottom-up order.
 */
function mapSyntax(f, node, env = new env_1.LispEnvironment(), stack = [], bindings = new env_1.LispEnvironment()) {
...
function mapVisitRose(f, node, env = new env_1.LispEnvironment(), stack = [], bindings = new env_1.LispEnvironment()) {
    ...
    function visitCondP(node) {
        return (0, util_1.formp)(node, macros_1.cond_, env);
    }
    ...
    function visitDefineMacro(node, stack, bindings) {
        ...
        const visitedBody = visitFormsList(body, [...stack, node], bindings2);
        if (!((id === visitedId) && (params === visitedParams) && (body === visitedBody))) {
            result = (0, rose_1.transferComments)(node, (0, rose_1.datumToSyntax)(false, [defineMacroSym, [visitedId, ...(Array.isArray(visitedParams) ? visitedParams : [Symbol.for('.'), visitedParams])], ...visitedBody]));
        }
        result = f(result, stack, bindings);
        makeTypeBinding(bindings, idSym, [Symbol.for('macro->'), Symbol.for('Any'), Symbol.for('*'), Symbol.for('Any')]);
        return result;
    ...
    visitNonatomicP.fsource = [Symbol.for('define'), [Symbol.for('visit-nonatomic-p'), Symbol.for('node')], [Symbol.for('let'), [[Symbol.for('exp'), [Symbol.for('syntax->datum'), Symbol.for('node')]]], [Symbol.for('pair-or-list?'), Symbol.for('exp')]]];
    // Atomic value.
...
function mapSexp(f, exp, env = new env_1.LispEnvironment(), stack = [], bindings = new env_1.LispEnvironment()) {
    ...
    let result = mapSyntax(f1, node, env, stack, bindings);
...
iterateRose.fsource = [Symbol.for('define'), [Symbol.for('iterate-rose'), Symbol.for('f'), Symbol.for('node'), [Symbol.for('env'), [Symbol.for('new'), Symbol.for('LispEnvironment')]]], [Symbol.for('map-syntax'), [Symbol.for('lambda'), [Symbol.for('x'), Symbol.for('stack')], [Symbol.for('f'), Symbol.for('x'), Symbol.for('stack')], Symbol.for('x')], Symbol.for('node'), Symbol.for('env')]];
/**
    ...
    if (expressionType === 'expression') {
        ...
        const casesCompiled = cases.map(function (x) {
            ...
            if (op === Symbol.for('case')) {
                ...
                const hasBreak = (0, util_1.formp)(consequent.at(-1), break_, env);
 ...
 */
class Module {
    constructor(nodes = [], parent = langEnvironment, name = '', modulePath = '') {
        this.name = '';
        this.modulePath = '';
        ...
        if (nodes.length > 0) {
            ...
            if (comments) {
                ...
                if (commentStrings.length > 0) {
                    ...
                    initialNodeCommentString = commentStrings.at(-1);
    ...
    makeEnvironment(parent = undefined) {
        ...
        let node of this.mainNodes) {
            ...
            if (definitionp(exp) || macroDefinitionP(exp)) {
                ...
                moduleEnv.setLocalX(name, new thunk_1.InternalPromise((() => {
                    const promiseF = function () {
                        if (promiseF.forced) {
                            return promiseF.value;
                        }
                            ...
                            promiseF.value = (() => {
                                ...
                                try {
                                    ...
                                    result = interpret_(beginExp, Symbol.for(':environment'), moduleInterpretationEnv);
                                }
                                catch (e) {
                                    if (e instanceof Error) {
                                    }
...
function moduleExpressionToModuleObject(node, env) {
    ...
    let modulePath = (0, rose_1.syntaxToDatum)(node.get(2));
    if (typeof modulePath === 'symbol') {
        modulePath = modulePath.description;
    }
...
function parseParamsList(params) {
    ...
    else if (Array.isArray(params) && (params.length >= 3) && (params.at(-2) === Symbol.for('.'))) {

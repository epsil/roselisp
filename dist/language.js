...
compile.fsource = [Symbol.for('define'), [Symbol.for('compile'), Symbol.for('exp'), Symbol.for('.'), Symbol.for('args')], [Symbol.for('define'), Symbol.for('options'), [Symbol.for('if'), [Symbol.for('='), [Symbol.for('js/length'), Symbol.for('args')], 1], [Symbol.for('js/first'), Symbol.for('args')], [Symbol.for('plist->object_'), Symbol.for('args'), true]]], [Symbol.for('define'), Symbol.for('to'), [Symbol.for('oget'), Symbol.for('options'), 'to']], [Symbol.for('define'), Symbol.for('language'), [Symbol.for('cond'), [[Symbol.for('eq?'), Symbol.for('to'), [Symbol.for('quote'), Symbol.for('typescript')]], 'TypeScript'], [Symbol.for('else'), Symbol.for('default-language')]]], [Symbol.for('oset!'), Symbol.for('options'), 'language', Symbol.for('language')], [Symbol.for('define'), Symbol.for('env'), [Symbol.for('or'), [Symbol.for('oget'), Symbol.for('options'), 'environment'], [Symbol.for('new'), Symbol.for('LispEnvironment')]]], [Symbol.for('compile-with-environment'), Symbol.for('exp'), Symbol.for('env'), Symbol.for('options')]];
/**
 * Compile a Lisp expression to JavaScript or TypeScript

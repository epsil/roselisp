...
function macroexpand(exp, env = undefined) {
    const [expansion] = macroexpandStar(exp, env);
    return expansion;
}
...
function macroexpand1(exp, env = undefined) {
    const [expansion] = macroexpandstar1(exp, env);
    return expansion;
}

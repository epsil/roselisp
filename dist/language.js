...
function compile(exp, ...args) {
    ...
    if (toLanguage === 'roselisp') {
        ...
        const inheritedOptions = Object.assign(Object.assign({}, options), { case: caseOption, language: toLanguage, expressionType });
...
function compileRose(node, env, options = {}) {
    ...
    if (Array.isArray(exp)) {
        if (exp.length === 0) {
            ...
            let op = exp[0];
            if ((typeof op === 'symbol') && env.hasp(op, {
                filter: langFilter
...
compileSexp.fsource = [Symbol.for('define'), [Symbol.for('compile-sexp'), Symbol.for('exp'), Symbol.for('env'), [Symbol.for('options'), [Symbol.for('js/obj')]]], [Symbol.for('~>'), Symbol.for('exp'), [Symbol.for('sexp->rose'), Symbol.for('_')], [Symbol.for('compile-rose'), Symbol.for('_'), Symbol.for('env'), Symbol.for('options')]]];
/**
...
interpret.fsource = [Symbol.for('define'), [Symbol.for('interpret'), Symbol.for('exp'), [Symbol.for('env'), [Symbol.for('default-environment')]], [Symbol.for('options'), [Symbol.for('js/obj')]]], [Symbol.for('define'), Symbol.for('expression-type'), [Symbol.for('or'), [Symbol.for('oget'), Symbol.for('options'), 'expressionType'], 'statement']], [Symbol.for('define'), Symbol.for('inherited-options'), [Symbol.for('js/obj-append'), Symbol.for('options'), [Symbol.for('js/obj'), 'case', 'none', 'expressionType', Symbol.for('expression-type'), 'estree', true, 'shouldInline', false]]], [Symbol.for('define'), Symbol.for('environment'), [Symbol.for('make-interpretation-environment'), Symbol.for('env'), Symbol.for('inherited-options')]], [Symbol.for('define'), Symbol.for('ast'), [Symbol.for('compile-with-environment'), Symbol.for('exp'), Symbol.for('environment'), Symbol.for('inherited-options')]], [Symbol.for('define'), Symbol.for('result'), [Symbol.for('eval-estree'), Symbol.for('ast'), Symbol.for('environment'), Symbol.for('inherited-options')]], Symbol.for('result')];
/**
 * Evaluate a Lisp expression `exp` with environment `env`.
 *
 * `env`, if specified, must be a Lisp environment as returned
...
makeExpressionOrStatement.fsource = [Symbol.for('define'), [Symbol.for('make-expression-or-statement'), Symbol.for('node'), [Symbol.for('options'), [Symbol.for('js/obj')]]], [Symbol.for('define'), Symbol.for('expression-type'), [Symbol.for('oget'), Symbol.for('options'), 'expressionType']], [Symbol.for('cond'), [[Symbol.for('or'), [Symbol.for('eq?'), Symbol.for('expression-type'), 'statement'], [Symbol.for('eq?'), Symbol.for('expression-type'), 'return']], [Symbol.for('make-statement'), Symbol.for('node'), Symbol.for('options')]], [Symbol.for('else'), Symbol.for('node')]]];
/**
...
transferAndCompileComments.fsource = [Symbol.for('define'), [Symbol.for('transfer-and-compile-comments'), Symbol.for('node1'), Symbol.for('node2'), [Symbol.for('options'), [Symbol.for('js/obj')]]], [Symbol.for('define'), Symbol.for('comments-option'), [Symbol.for('oget'), Symbol.for('options'), 'comments']], [Symbol.for('define'), Symbol.for('comments'), [Symbol.for('if'), [Symbol.for('is-a?'), Symbol.for('node1'), Symbol.for('Rose')], [Symbol.for('send'), Symbol.for('node1'), Symbol.for('get-property'), 'comments'], [Symbol.for('get-field'), Symbol.for('comments'), Symbol.for('node1')]]], [Symbol.for('when'), [Symbol.for('and'), Symbol.for('comments-option'), Symbol.for('comments')], [Symbol.for('cond'), [[Symbol.for('is-a?'), Symbol.for('node2'), Symbol.for('Rose')], [Symbol.for('send'), Symbol.for('node2'), Symbol.for('set-property'), 'comments', [Symbol.for('append'), Symbol.for('comments'), [Symbol.for('or'), [Symbol.for('send'), Symbol.for('node2'), Symbol.for('get-property'), 'comments'], [Symbol.for('quote'), []]]]]], [Symbol.for('else'), [Symbol.for('set!'), Symbol.for('comments'), [Symbol.for('compile-comments'), Symbol.for('comments')]], [Symbol.for('set-field!'), Symbol.for('comments'), Symbol.for('node2'), [Symbol.for('append'), Symbol.for('comments'), [Symbol.for('or'), [Symbol.for('get-field'), Symbol.for('comments'), Symbol.for('node2')], [Symbol.for('quote'), []]]]]]]], Symbol.for('node2')];
/**
 * Compile comments.
 */
...
compileArrayRef.fsource = [Symbol.for('define'), [Symbol.for('compile-array-ref'), Symbol.for('node'), Symbol.for('env'), [Symbol.for('options'), [Symbol.for('js/obj')]]], [Symbol.for('define'), Symbol.for('language'), [Symbol.for('oget'), Symbol.for('options'), 'language']], [Symbol.for('define'), Symbol.for('variable'), [Symbol.for('send'), Symbol.for('node'), Symbol.for('get'), 1]], [Symbol.for('define'), Symbol.for('indices'), [Symbol.for('send'), Symbol.for('node'), Symbol.for('drop'), 2]], [Symbol.for('define'), Symbol.for('indices-compiled'), [Symbol.for('map'), [Symbol.for('lambda'), [Symbol.for('x')], [Symbol.for('define'), Symbol.for('x-exp'), [Symbol.for('rose->sexp'), Symbol.for('x')]], [Symbol.for('define'), Symbol.for('is-quoted-symbol'), false], [Symbol.for('when'), [Symbol.for('and'), [Symbol.for('quoted-expression?'), Symbol.for('x-exp')], [Symbol.for('symbol?'), [Symbol.for('js/second'), Symbol.for('x-exp')]]], [Symbol.for('set!'), Symbol.for('x-exp'), [Symbol.for('js/second'), Symbol.for('x-exp')]], [Symbol.for('set!'), Symbol.for('x'), [Symbol.for('sexp->rose'), Symbol.for('x-exp'), Symbol.for('x')]], [Symbol.for('set!'), Symbol.for('is-quoted-symbol'), true]], [Symbol.for('when'), [Symbol.for('keyword?'), Symbol.for('x-exp')], [Symbol.for('set!'), Symbol.for('x-exp'), [Symbol.for('keyword->symbol_'), Symbol.for('x-exp')]], [Symbol.for('set!'), Symbol.for('x'), [Symbol.for('sexp->rose'), Symbol.for('x-exp'), Symbol.for('x')]], [Symbol.for('set!'), Symbol.for('is-quoted-symbol'), true]], [Symbol.for('cond'), [Symbol.for('is-quoted-symbol'), [Symbol.for('define'), Symbol.for('identifier'), [Symbol.for('compile-symbol'), Symbol.for('x'), Symbol.for('env'), Symbol.for('options')]], [Symbol.for('define'), Symbol.for('literal'), [Symbol.for('new'), Symbol.for('Literal'), [Symbol.for('get-field'), Symbol.for('name'), Symbol.for('identifier')]]], Symbol.for('literal')], [Symbol.for('else'), [Symbol.for('compile-expression'), Symbol.for('x'), Symbol.for('env'), Symbol.for('options')]]]], Symbol.for('indices')]], [Symbol.for('when'), [Symbol.for('and'), [Symbol.for('eq?'), Symbol.for('language'), 'typescript'], [Symbol.for('not'), [Symbol.for('form?'), Symbol.for('variable'), Symbol.for('ann_'), Symbol.for('env')]], [Symbol.for('not'), [Symbol.for('estree-type?'), [Symbol.for('js/first'), Symbol.for('indices-compiled')], [Symbol.for('quote'), ['Literal', 'UnaryExpression', 'BinaryExpression']]]]], [Symbol.for('set!'), Symbol.for('variable'), [Symbol.for('sexp->rose'), [Symbol.for('quasiquote'), [Symbol.for('ann'), [Symbol.for('unquote'), Symbol.for('variable')], Symbol.for('Any')]], Symbol.for('variable')]]], [Symbol.for('define'), Symbol.for('variable-compiled'), [Symbol.for('compile-expression'), Symbol.for('variable'), Symbol.for('env'), Symbol.for('options')]], [Symbol.for('define'), Symbol.for('computed'), true], [Symbol.for('define'), Symbol.for('optional'), [Symbol.for('form?'), Symbol.for('variable'), Symbol.for('js/optional-chaining_'), Symbol.for('env')]], [Symbol.for('define'), Symbol.for('result'), [Symbol.for('foldl'), [Symbol.for('lambda'), [Symbol.for('idx'), Symbol.for('arr')], [Symbol.for('new'), Symbol.for('MemberExpression'), Symbol.for('arr'), Symbol.for('idx'), Symbol.for('computed'), Symbol.for('optional')]], Symbol.for('variable-compiled'), Symbol.for('indices-compiled')]], [Symbol.for('make-expression-or-statement'), Symbol.for('result'), Symbol.for('options')]];
/**
...
function compileCond(node, env, options = {}) {
    ...
    function wrap(exps) {
        if (exps.length === 1) {
            ...
            return (0, rose_1.sexpToRose)([Symbol.for('begin'), ...exps]);
        }
    }
    wrap.fsource = [Symbol.for('define'), [Symbol.for('wrap'), Symbol.for('exps')], [Symbol.for('if'), [Symbol.for('='), [Symbol.for('js/length'), Symbol.for('exps')], 1], [Symbol.for('js/first'), Symbol.for('exps')], [Symbol.for('sexp->rose'), [Symbol.for('quasiquote'), [Symbol.for('begin'), [Symbol.for('unquote-splicing'), Symbol.for('exps')]]]]]];
    const clauses = node.drop(1).slice(0, -1);
    const finalClause = node.last();
    const finalExp = (0, util_1.taggedListP)(finalClause, Symbol.for('else')) ? (0, rose_1.sexpToRose)([(expressionType === 'expression') ? Symbol.for('begin') : Symbol.for('js/block'), ...finalClause.drop(1)]) : (0, rose_1.sexpToRose)([Symbol.for('if'), finalClause.get(0), wrap(finalClause.drop(1))]);
    const finalExpCompiled = transferAndCompileComments(finalClause, compileRose(finalExp, env, options), options);
    let result = clauses.reduceRight(function (alternate, clause) {
        const conditional = compileRose((0, rose_1.sexpToRose)([Symbol.for('if'), clause.get(0), (0, rose_1.transferComments)(clause, wrap(clause.drop(1)))]), env, options);
        conditional.alternate = alternate;
        return conditional;
    }, finalExpCompiled);
    return transferAndCompileComments(node, result, options);
}
compileCond.fsource = [Symbol.for('define'), [Symbol.for('compile-cond'), Symbol.for('node'), Symbol.for('env'), [Symbol.for('options'), [Symbol.for('js/obj')]]], [Symbol.for('define'), Symbol.for('expression-type'), [Symbol.for('oget'), Symbol.for('options'), 'expressionType']], [Symbol.for('define'), [Symbol.for('wrap'), Symbol.for('exps')], [Symbol.for('if'), [Symbol.for('='), [Symbol.for('js/length'), Symbol.for('exps')], 1], [Symbol.for('js/first'), Symbol.for('exps')], [Symbol.for('sexp->rose'), [Symbol.for('quasiquote'), [Symbol.for('begin'), [Symbol.for('unquote-splicing'), Symbol.for('exps')]]]]]], [Symbol.for('define'), Symbol.for('clauses'), [Symbol.for('~>'), Symbol.for('node'), [Symbol.for('send'), Symbol.for('_'), Symbol.for('drop'), 1], [Symbol.for('drop-right'), Symbol.for('_'), 1]]], [Symbol.for('define'), Symbol.for('final-clause'), [Symbol.for('send'), Symbol.for('node'), Symbol.for('last')]], [Symbol.for('define'), Symbol.for('final-exp'), [Symbol.for('if'), [Symbol.for('tagged-list?'), Symbol.for('final-clause'), [Symbol.for('quote'), Symbol.for('else')]], [Symbol.for('sexp->rose'), [Symbol.for('quasiquote'), [[Symbol.for('unquote'), [Symbol.for('if'), [Symbol.for('eq?'), Symbol.for('expression-type'), 'expression'], [Symbol.for('quote'), Symbol.for('begin')], [Symbol.for('quote'), Symbol.for('js/block')]]], [Symbol.for('unquote-splicing'), [Symbol.for('send'), Symbol.for('final-clause'), Symbol.for('drop'), 1]]]]], [Symbol.for('sexp->rose'), [Symbol.for('quasiquote'), [Symbol.for('if'), [Symbol.for('unquote'), [Symbol.for('send'), Symbol.for('final-clause'), Symbol.for('get'), 0]], [Symbol.for('unquote'), [Symbol.for('wrap'), [Symbol.for('send'), Symbol.for('final-clause'), Symbol.for('drop'), 1]]]]]]]], [Symbol.for('define'), Symbol.for('final-exp-compiled'), [Symbol.for('transfer-and-compile-comments'), Symbol.for('final-clause'), [Symbol.for('compile-rose'), Symbol.for('final-exp'), Symbol.for('env'), Symbol.for('options')], Symbol.for('options')]], [Symbol.for('define'), Symbol.for('result'), [Symbol.for('foldr'), [Symbol.for('lambda'), [Symbol.for('clause'), Symbol.for('alternate')], [Symbol.for('define'), Symbol.for('conditional'), [Symbol.for('compile-rose'), [Symbol.for('sexp->rose'), [Symbol.for('quasiquote'), [Symbol.for('if'), [Symbol.for('unquote'), [Symbol.for('send'), Symbol.for('clause'), Symbol.for('get'), 0]], [Symbol.for('unquote'), [Symbol.for('transfer-comments'), Symbol.for('clause'), [Symbol.for('wrap'), [Symbol.for('send'), Symbol.for('clause'), Symbol.for('drop'), 1]]]]]]], Symbol.for('env'), Symbol.for('options')]], [Symbol.for('set-field!'), Symbol.for('alternate'), Symbol.for('conditional'), Symbol.for('alternate')], Symbol.for('conditional')], Symbol.for('final-exp-compiled'), Symbol.for('clauses')]], [Symbol.for('transfer-and-compile-comments'), Symbol.for('node'), Symbol.for('result'), Symbol.for('options')]];
/**
...
compileIf.fsource = [Symbol.for('define'), [Symbol.for('compile-if'), Symbol.for('node'), Symbol.for('env'), [Symbol.for('options'), [Symbol.for('js/obj')]]], [Symbol.for('define'), Symbol.for('expression-type'), [Symbol.for('oget'), Symbol.for('options'), 'expressionType']], [Symbol.for('cond'), [[Symbol.for('eq?'), Symbol.for('expression-type'), 'expression'], [Symbol.for('compile-js/ternary-operator'), Symbol.for('node'), Symbol.for('env'), Symbol.for('options')]], [Symbol.for('else'), [Symbol.for('compile-js/if'), Symbol.for('node'), Symbol.for('env'), Symbol.for('options')]]]];
/**
...
function compileJsIf(node, env, options = {}) {
    ...
    if (expressionType === 'expression') {
        ...
        const thenExp = (0, rose_1.sexpToRose)([Symbol.for('js/block'), node.get(2)]);
        let elseExp = node.get(3);
        if (elseExp && !(0, util_1.formp)(elseExp, jsIf_, env)) {
            elseExp = (0, rose_1.sexpToRose)([Symbol.for('js/block'), elseExp]);
        }
...
function compileJsTernaryOperator(node, env, options = {}) {
    ...
    let elseExp = node.get(3) || (0, rose_1.sexpToRose)(undefined);
...
function compileFunctionCall(node, env, options = {}) {
    ...
    let op = (0, rose_1.roseToSexp)(callee);
...
compileUnaryExpression.fsource = [Symbol.for('define'), [Symbol.for('compile-unary-expression'), Symbol.for('node'), Symbol.for('env'), [Symbol.for('options'), [Symbol.for('js/obj')]], [Symbol.for('settings'), [Symbol.for('js/obj')]]], [Symbol.for('define'), Symbol.for('op'), [Symbol.for('oget'), Symbol.for('settings'), 'operator']], [Symbol.for('define'), Symbol.for('arg'), [Symbol.for('send'), Symbol.for('node'), Symbol.for('get'), 1]], [Symbol.for('define'), Symbol.for('arg-compiled'), [Symbol.for('compile-expression'), Symbol.for('arg'), Symbol.for('env'), Symbol.for('options')]], [Symbol.for('make-expression-or-statement'), [Symbol.for('new'), Symbol.for('UnaryExpression'), Symbol.for('op'), true, Symbol.for('arg-compiled')], Symbol.for('options')]];
/**
 * Compile a `(js/op ...)` expression.
 */
function compileJsOp(node, env, options = {}) {
    let op = (0, rose_1.roseToSexp)(node.get(1));
    if (typeof op === 'symbol') {
        op = op.description;
    }
    const logical = ['&&', '||'].includes(op);
    const node1 = (0, rose_1.sexpToRose)(node.drop(1), node);
    if (node.size() === 3) {
...
function compileDefineFields(node, env, options = {}) {
    ...
    const fieldsExp = (0, rose_1.roseToSexp)(fields);
    let obj = node.get(2);
    const objExp = (0, rose_1.roseToSexp)(obj);
...
function compileJsDot(node, env, options = {}) {
    if (node.size() > 3) {
        ...
        const propCompiled = (typeof (0, rose_1.roseToSexp)(prop) === 'symbol') ? compileSymbol(prop, env, options) : compileExpression(prop, env, options);
        // Kludge: prevent TypeScript errors with expressions
        // like `x[y]`, where `y` is `any`-typed.
...
compileJsDot.fsource = [Symbol.for('define'), [Symbol.for('compile-js/dot'), Symbol.for('node'), Symbol.for('env'), [Symbol.for('options'), [Symbol.for('js/obj')]]], [Symbol.for('cond'), [[Symbol.for('>'), [Symbol.for('send'), Symbol.for('node'), Symbol.for('size')], 3], [Symbol.for('compile-js/dot'), [Symbol.for('sexp->rose'), [Symbol.for('foldl'), [Symbol.for('lambda'), [Symbol.for('prop'), Symbol.for('obj')], [Symbol.for('quasiquote'), [Symbol.for('js/.'), [Symbol.for('unquote'), Symbol.for('obj')], [Symbol.for('unquote'), Symbol.for('prop')]]]], [Symbol.for('send'), Symbol.for('node'), Symbol.for('get'), 1], [Symbol.for('send'), Symbol.for('node'), Symbol.for('drop'), 2]], Symbol.for('node')], Symbol.for('env'), Symbol.for('options')]], [Symbol.for('else'), [Symbol.for('define'), Symbol.for('language'), [Symbol.for('oget'), Symbol.for('options'), 'language']], [Symbol.for('define'), Symbol.for('obj'), [Symbol.for('send'), Symbol.for('node'), Symbol.for('get'), 1]], [Symbol.for('define'), Symbol.for('prop'), [Symbol.for('send'), Symbol.for('node'), Symbol.for('get'), 2]], [Symbol.for('define'), Symbol.for('prop-exp'), [Symbol.for('rose->sexp'), Symbol.for('prop')]], [Symbol.for('define'), Symbol.for('computed'), [Symbol.for('not'), [Symbol.for('symbol?'), Symbol.for('prop-exp')]]], [Symbol.for('when'), [Symbol.for('and'), [Symbol.for('quoted-expression?'), Symbol.for('prop-exp')], [Symbol.for('symbol?'), [Symbol.for('js/second'), Symbol.for('prop-exp')]]], [Symbol.for('set!'), Symbol.for('prop-exp'), [Symbol.for('js/second'), Symbol.for('prop-exp')]], [Symbol.for('set!'), Symbol.for('prop'), [Symbol.for('sexp->rose'), Symbol.for('prop-exp'), Symbol.for('prop')]], [Symbol.for('set!'), Symbol.for('computed'), false]], [Symbol.for('when'), [Symbol.for('keyword?'), Symbol.for('prop-exp')], [Symbol.for('set!'), Symbol.for('prop-exp'), [Symbol.for('keyword->symbol_'), Symbol.for('prop-exp')]], [Symbol.for('set!'), Symbol.for('prop'), [Symbol.for('sexp->rose'), Symbol.for('prop-exp'), Symbol.for('prop')]], [Symbol.for('set!'), Symbol.for('computed'), false]], [Symbol.for('define'), Symbol.for('prop-compiled'), [Symbol.for('if'), [Symbol.for('symbol?'), [Symbol.for('rose->sexp'), Symbol.for('prop')]], [Symbol.for('compile-symbol'), Symbol.for('prop'), Symbol.for('env'), Symbol.for('options')], [Symbol.for('compile-expression'), Symbol.for('prop'), Symbol.for('env'), Symbol.for('options')]]], [Symbol.for('when'), [Symbol.for('and'), Symbol.for('computed'), [Symbol.for('eq?'), Symbol.for('language'), 'typescript'], [Symbol.for('not'), [Symbol.for('form?'), Symbol.for('obj'), Symbol.for('ann_'), Symbol.for('env')]], [Symbol.for('not'), [Symbol.for('estree-type?'), Symbol.for('prop-compiled'), [Symbol.for('quote'), ['Literal', 'UnaryExpression', 'BinaryExpression']]]]], [Symbol.for('set!'), Symbol.for('obj'), [Symbol.for('sexp->rose'), [Symbol.for('quasiquote'), [Symbol.for('ann'), [Symbol.for('unquote'), Symbol.for('obj')], Symbol.for('Any')]], Symbol.for('obj')]]], [Symbol.for('define'), Symbol.for('obj-compiled'), [Symbol.for('if'), [Symbol.for('symbol?'), [Symbol.for('rose->sexp'), Symbol.for('obj')]], [Symbol.for('compile-symbol'), Symbol.for('obj'), Symbol.for('env'), [Symbol.for('make-expression-options'), Symbol.for('options')]], [Symbol.for('compile-expression'), Symbol.for('obj'), Symbol.for('env'), Symbol.for('options')]]], [Symbol.for('make-expression-or-statement'), [Symbol.for('new'), Symbol.for('MemberExpression'), Symbol.for('obj-compiled'), Symbol.for('prop-compiled'), Symbol.for('computed')], Symbol.for('options')]]]];
/**
 * Compile a `(js/?. ...)` expression.
 */
...
makeGlobalEnvironmentExp.fsource = [Symbol.for('define'), [Symbol.for('make-global-environment-exp'), Symbol.for('symbols'), Symbol.for('env'), Symbol.for('options')], [Symbol.for('cond'), [[Symbol.for('='), [Symbol.for('js/length'), Symbol.for('symbols')], 0], false], [[Symbol.for('oget'), Symbol.for('options'), 'finlineFunctions'], [Symbol.for('make-define-values-exp'), Symbol.for('symbols'), Symbol.for('env'), Symbol.for('options')]], [Symbol.for('else'), [Symbol.for('make-require-exp'), Symbol.for('symbols'), Symbol.for('env'), Symbol.for('options')]]]];
/**
        ...
        if (!externalSymbols.includes(symbol) && env1.hasp(symbol)) {
            ...
            if (sourcep(value)) {
                ...
                if ((0, util_1.taggedListP)(exp, Symbol.for('define'))) {
                    ...
                    const compiledExpression = compileRose((0, rose_1.sexpToRose)(exp), env2, Object.assign(Object.assign({}, options), { currentModule, referencedSymbols: referencedSymbols1 }));
...
function compileRequire(node, env, options = {}) {
    ...
    if (fcommonjs) {
        if ((0, util_1.taggedListP)(xExp, Symbol.for('only-in'))) {
            return compileStatement((0, rose_1.sexpToRose)([Symbol.for('define-fields'), xExp.slice(2), [Symbol.for('js/require'), xExp[1]]]), env, options);
        }
        else {
            if (typeof xExp === 'string') {
                xExp = Symbol.for(xExp);
            }
            return compileStatement((0, rose_1.sexpToRose)([Symbol.for('define'), xExp, [Symbol.for('js/require'), yNode]]), env, options);
        }
    }
    else {
        let specifiers = [];
    ...
    if (fcommonjs) {
        ...
        for (let exp of expressions) {
            if ((0, util_1.taggedListP)(exp, Symbol.for('all-from-out'))) {
                let name = Symbol.for((0, rose_1.roseToSexp)(exp.get(1)));
        ...
        return compileStatement((0, rose_1.sexpToRose)([Symbol.for('set-field!'), Symbol.for('exports'), Symbol.for('module'), [Symbol.for('js/obj'), ...properties]]), env, options);
    }
    else {
...
function compileJsFor(node, env, options = {}) {
    const body = (0, rose_1.sexpToRose)([Symbol.for('js/block'), ...node.drop(2)], node);
    let init = node.get(1, 0);
    const initExp = (0, rose_1.roseToSexp)(init);
    const test = node.get(1, 1);
    const testExp = (0, rose_1.roseToSexp)(test);
    let update = node.get(1, 2);
    const updateExp = (0, rose_1.roseToSexp)(update);
    let sym = undefined;
    function bindingp(x) {
    ...
    if (bindingp(initExp)) {
        sym = initExp[0];
        init = (0, rose_1.sexpToRose)([Symbol.for('define'), ...init.drop(0)], init);
    }
    ...
    if (incrementp(updateExp)) {
        ...
        if (sym) {
            update = (0, rose_1.sexpToRose)([Symbol.for('set!'), sym, update], update);
        }
    }
...
compileJsForIn.fsource = [Symbol.for('define'), [Symbol.for('compile-js/for-in'), Symbol.for('node'), Symbol.for('env'), [Symbol.for('options'), [Symbol.for('js/obj')]]], [Symbol.for('define'), Symbol.for('left'), [Symbol.for('sexp->rose'), [Symbol.for('quasiquote'), [Symbol.for('define'), [Symbol.for('unquote'), [Symbol.for('send'), Symbol.for('node'), Symbol.for('get'), 1, 0, 0]]]], Symbol.for('node')]], [Symbol.for('define'), Symbol.for('right'), [Symbol.for('send'), Symbol.for('node'), Symbol.for('get'), 1, 0, 1]], [Symbol.for('define'), Symbol.for('body'), [Symbol.for('sexp->rose'), [Symbol.for('quasiquote'), [Symbol.for('js/block'), [Symbol.for('unquote-splicing'), [Symbol.for('send'), Symbol.for('node'), Symbol.for('drop'), 2]]]], Symbol.for('node')]], [Symbol.for('define'), Symbol.for('left-compiled'), [Symbol.for('compile-statement'), Symbol.for('left'), Symbol.for('env'), Symbol.for('options')]], [Symbol.for('define'), Symbol.for('right-compiled'), [Symbol.for('compile-expression'), Symbol.for('right'), Symbol.for('env'), Symbol.for('options')]], [Symbol.for('define'), Symbol.for('body-compiled'), [Symbol.for('compile-statement'), Symbol.for('body'), Symbol.for('env'), Symbol.for('options')]], [Symbol.for('new'), Symbol.for('ForInStatement'), Symbol.for('left-compiled'), Symbol.for('right-compiled'), Symbol.for('body-compiled')]];
/**
...
compileJsForOf.fsource = [Symbol.for('define'), [Symbol.for('compile-js/for-of'), Symbol.for('node'), Symbol.for('env'), [Symbol.for('options'), [Symbol.for('js/obj')]]], [Symbol.for('define'), Symbol.for('left'), [Symbol.for('sexp->rose'), [Symbol.for('quasiquote'), [Symbol.for('define'), [Symbol.for('unquote'), [Symbol.for('send'), Symbol.for('node'), Symbol.for('get'), 1, 0, 0]]]], Symbol.for('node')]], [Symbol.for('define'), Symbol.for('right'), [Symbol.for('send'), Symbol.for('node'), Symbol.for('get'), 1, 0, 1]], [Symbol.for('define'), Symbol.for('body'), [Symbol.for('sexp->rose'), [Symbol.for('quasiquote'), [Symbol.for('js/block'), [Symbol.for('unquote-splicing'), [Symbol.for('send'), Symbol.for('node'), Symbol.for('drop'), 2]]]], Symbol.for('node')]], [Symbol.for('define'), Symbol.for('left-compiled'), [Symbol.for('compile-statement'), Symbol.for('left'), Symbol.for('env'), Symbol.for('options')]], [Symbol.for('define'), Symbol.for('right-compiled'), [Symbol.for('compile-expression'), Symbol.for('right'), Symbol.for('env'), Symbol.for('options')]], [Symbol.for('define'), Symbol.for('body-compiled'), [Symbol.for('compile-statement'), Symbol.for('body'), Symbol.for('env'), Symbol.for('options')]], [Symbol.for('new'), Symbol.for('ForOfStatement'), Symbol.for('left-compiled'), Symbol.for('right-compiled'), Symbol.for('body-compiled')]];
/**
...
compileJsObj.fsource = [Symbol.for('define'), [Symbol.for('compile-js/obj'), Symbol.for('node'), Symbol.for('env'), [Symbol.for('options'), [Symbol.for('js/obj')]]], [Symbol.for('define'), Symbol.for('exp'), [Symbol.for('rose->sexp'), Symbol.for('node')]], [Symbol.for('define'), Symbol.for('properties'), [Symbol.for('quote'), []]], [Symbol.for('define'), Symbol.for('i'), 1], [Symbol.for('while'), [Symbol.for('<'), Symbol.for('i'), [Symbol.for('js/length'), Symbol.for('exp')]], [Symbol.for('define'), Symbol.for('key-node'), [Symbol.for('send'), Symbol.for('node'), Symbol.for('get'), Symbol.for('i')]], [Symbol.for('cond'), [[Symbol.for('tagged-list?'), Symbol.for('key-node'), [Symbol.for('quote'), Symbol.for('js/obj-spread')]], [Symbol.for('define'), Symbol.for('compiled-key'), [Symbol.for('compile-expression'), Symbol.for('key-node'), Symbol.for('env'), Symbol.for('options')]], [Symbol.for('push-right!'), Symbol.for('properties'), Symbol.for('compiled-key')], [Symbol.for('set!'), Symbol.for('i'), [Symbol.for('+'), Symbol.for('i'), 1]]], [Symbol.for('else'), [Symbol.for('define'), Symbol.for('key-exp'), [Symbol.for('rose->sexp'), Symbol.for('key-node')]], [Symbol.for('define'), Symbol.for('computed'), [Symbol.for('not'), [Symbol.for('string?'), Symbol.for('key-exp')]]], [Symbol.for('define'), Symbol.for('val-node'), [Symbol.for('send'), Symbol.for('node'), Symbol.for('get'), [Symbol.for('+'), Symbol.for('i'), 1]]], [Symbol.for('define'), Symbol.for('is-quoted-symbol'), false], [Symbol.for('when'), [Symbol.for('and'), [Symbol.for('quoted-expression?'), Symbol.for('key-exp')], [Symbol.for('symbol?'), [Symbol.for('js/second'), Symbol.for('key-exp')]]], [Symbol.for('set!'), Symbol.for('key-exp'), [Symbol.for('js/second'), Symbol.for('key-exp')]], [Symbol.for('set!'), Symbol.for('key-node'), [Symbol.for('sexp->rose'), Symbol.for('key-exp'), Symbol.for('key-node')]], [Symbol.for('set!'), Symbol.for('is-quoted-symbol'), true], [Symbol.for('set!'), Symbol.for('computed'), false]], [Symbol.for('when'), [Symbol.for('keyword?'), Symbol.for('key-exp')], [Symbol.for('set!'), Symbol.for('key-exp'), [Symbol.for('keyword->symbol_'), Symbol.for('key-exp')]], [Symbol.for('set!'), Symbol.for('key-node'), [Symbol.for('sexp->rose'), Symbol.for('key-exp'), Symbol.for('key-node')]], [Symbol.for('set!'), Symbol.for('is-quoted-symbol'), true], [Symbol.for('set!'), Symbol.for('computed'), false]], [Symbol.for('define'), Symbol.for('compiled-key'), [Symbol.for('if'), Symbol.for('is-quoted-symbol'), [Symbol.for('compile-symbol'), Symbol.for('key-node'), Symbol.for('env'), Symbol.for('options')], [Symbol.for('compile-expression'), Symbol.for('key-node'), Symbol.for('env'), Symbol.for('options')]]], [Symbol.for('define'), Symbol.for('compiled-value'), [Symbol.for('compile-expression'), Symbol.for('val-node'), Symbol.for('env'), Symbol.for('options')]], [Symbol.for('when'), [Symbol.for('and'), [Symbol.for('string?'), Symbol.for('key-exp')], [Symbol.for('regexp-match'), [Symbol.for('regexp'), '^[a-z]+$', 'i'], Symbol.for('key-exp')]], [Symbol.for('set!'), Symbol.for('compiled-key'), [Symbol.for('new'), Symbol.for('Identifier'), Symbol.for('key-exp')]]], [Symbol.for('define'), Symbol.for('shorthand'), [Symbol.for('and'), [Symbol.for('not'), Symbol.for('computed')], [Symbol.for('estree-type?'), Symbol.for('compiled-key'), 'Identifier'], [Symbol.for('estree-type?'), Symbol.for('compiled-value'), 'Identifier'], [Symbol.for('eq?'), [Symbol.for('get-field'), Symbol.for('name'), Symbol.for('compiled-key')], [Symbol.for('get-field'), Symbol.for('name'), Symbol.for('compiled-value')]]]], [Symbol.for('push-right!'), Symbol.for('properties'), [Symbol.for('new'), Symbol.for('Property'), Symbol.for('compiled-key'), Symbol.for('compiled-value'), Symbol.for('computed'), Symbol.for('shorthand')]], [Symbol.for('set!'), Symbol.for('i'), [Symbol.for('+'), Symbol.for('i'), 2]]]]], [Symbol.for('make-expression-or-statement'), [Symbol.for('new'), Symbol.for('ObjectExpression'), Symbol.for('properties')], Symbol.for('options')]];
/**
...
function mapVisitRose(f, node, env = new env_1.LispEnvironment(), stack = [], bindings = new env_1.LispEnvironment()) {
    ...
    function visitLet(node, stack, bindings) {
        ...
        let sym = (0, rose_1.roseToSexp)(node.get(0));
...
function compileJsSwitch(node, env, options = {}) {
    ...
    if (expressionType === 'expression') {
        ...
        const casesCompiled = cases.map(function (x) {
            let op = (0, rose_1.roseToSexp)(x.get(0));
            let testCompiled;

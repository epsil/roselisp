...
function compileFunction(node, env, options = {}, settings = {}) {
    ...
    let body = wrapInBlockStatement(compileStatementOrReturnStatement((0, rose_1.beginWrapRoseSmart1)(bodyStatements).setParent(node), env1, Object.assign(Object.assign({}, inheritedOptions), { expressionType: (returnType === Symbol.for('Void')) ? 'statement' : 'return' })));
    let result = undefined;

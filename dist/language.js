...
function compileRose(node, env, options = {}) {
    ...
    if (Array.isArray(exp)) {
        if (exp.length === 0) {
            ...
            }) && !(0, procedures_1.macroTypeP)(continuationEnv.getType(op, {
                filter: function (x) {
                    return x !== env;
                }
            }))) {
...
function compileDefine(node, env, options = {}) {
    ...
    if (Array.isArray((Array.isArray(exp) && (exp.length >= 3) && (exp[exp.length - 2] === Symbol.for('.')) && (() => {
        ...
        if (inlineLispSourceOption) {
            ...
            const lispCodeExp = compileSexp([Symbol.for('declare'), sym, [Symbol.for('lispSource'), [Symbol.for('quote'), exp]]], env, options);
...
compileRegexpMacro.ftype = 'macro';
/**

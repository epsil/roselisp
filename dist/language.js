...
function compileRequire(node, env, options = {}) {
    const esModuleInterop = options['fesModuleInterop'];
    const languageEnv = options['languageEnvironment'];
    function langFilter(x) {
        return x !== languageEnv;
    }

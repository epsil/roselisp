 ...
 * 3 for a `;;;`-comment, etc.
 */
function isCommentLevel(comment, level) {
    return getCommentLevel(comment) === level;
}
exports.isCommentLevel = isCommentLevel;

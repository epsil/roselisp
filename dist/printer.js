 ...
 */
function printSyntax(node, options = {}) {
    // TODO: Print comments.
    return printSexp((0, rose_1.syntaxToDatum)(node), options);
}
exports.printRose = printSyntax;
...
function printVisitor(node, options) {
    if (!node) {
        ...
        return printVisitor(node(), options);
    }
    else {
...
function printPropertyDefinition(node, options = {}) {
    ...
    return [((toLanguage === 'typescript') && (accessibility === 'private')) ? ['private', space] : empty, staticFlag ? ['static', space] : empty, printNode(key, options), (toLanguage === 'typescript') ? [':', space, 'any'] : empty, value ? [space, '=', space, printNode(value, options)] : empty, fsemicolon ? ';' : empty];
}
printPropertyDefinition.fsource = [Symbol.for('define'), [Symbol.for('print-property-definition'), Symbol.for('node'), [Symbol.for('options'), [Symbol.for('js/obj')]]], [Symbol.for('define'), Symbol.for('fsemicolon'), [Symbol.for('oget'), Symbol.for('options'), Symbol.for(':fsemicolon')]], [Symbol.for('define'), Symbol.for('to-language'), [Symbol.for('oget'), Symbol.for('options'), Symbol.for(':to')]], [Symbol.for('define'), Symbol.for('key'), [Symbol.for('get-estree-field'), 'key', Symbol.for('node')]], [Symbol.for('define'), Symbol.for('value'), [Symbol.for('get-estree-field'), 'value', Symbol.for('node')]], [Symbol.for('define'), Symbol.for('static-flag'), [Symbol.for('get-estree-field'), 'static', Symbol.for('node')]], [Symbol.for('define'), Symbol.for('accessibility'), [Symbol.for('get-estree-field'), 'accessibility', Symbol.for('node')]], [Symbol.for('list'), [Symbol.for('if'), [Symbol.for('and'), [Symbol.for('eq?'), Symbol.for('to-language'), 'typescript'], [Symbol.for('eq?'), Symbol.for('accessibility'), 'private']], [Symbol.for('list'), 'private', Symbol.for('space')], Symbol.for('empty')], [Symbol.for('if'), Symbol.for('static-flag'), [Symbol.for('list'), 'static', Symbol.for('space')], Symbol.for('empty')], [Symbol.for('print-node'), Symbol.for('key'), Symbol.for('options')], [Symbol.for('if'), [Symbol.for('eq?'), Symbol.for('to-language'), 'typescript'], [Symbol.for('list'), ':', Symbol.for('space'), 'any'], Symbol.for('empty')], [Symbol.for('if'), Symbol.for('value'), [Symbol.for('list'), Symbol.for('space'), '=', Symbol.for('space'), [Symbol.for('print-node'), Symbol.for('value'), Symbol.for('options')]], Symbol.for('empty')], [Symbol.for('if'), Symbol.for('fsemicolon'), ';', Symbol.for('empty')]]];
/**
...
function printArrayExpression(node, options = {}) {
    ...
    if (type_ && (toLanguage === 'typescript')) {

...
join.fsource = [Symbol.for('define'), [Symbol.for('join'), Symbol.for('sep'), Symbol.for('docs')], [Symbol.for('define'), Symbol.for('result'), [Symbol.for('quote'), []]], [Symbol.for('for'), [[Symbol.for('i'), [Symbol.for('range'), 0, [Symbol.for('array-list-length'), Symbol.for('docs')]]]], [Symbol.for('unless'), [Symbol.for('='), Symbol.for('i'), 0], [Symbol.for('push-right!'), Symbol.for('result'), Symbol.for('sep')]], [Symbol.for('push-right!'), Symbol.for('result'), [Symbol.for('aget'), Symbol.for('docs'), Symbol.for('i')]]], Symbol.for('result')];
/**
 * `Doc` command `group`.
 *
...
docShouldBreakP.fsource = [Symbol.for('define'), [Symbol.for('doc-should-break?'), Symbol.for('doc')], [Symbol.for('cond'), [[Symbol.for('is-a?'), Symbol.for('doc'), Symbol.for('DocCommand')], [Symbol.for('oget'), [Symbol.for('array-list-last'), [Symbol.for('get-field'), Symbol.for('args'), Symbol.for('doc')]], 'should-break']], [Symbol.for('else'), false]]];
/**
...
docHasCommentsP.fsource = [Symbol.for('define'), [Symbol.for('doc-has-comments?'), Symbol.for('doc')], [Symbol.for('cond'), [[Symbol.for('is-a?'), Symbol.for('doc'), Symbol.for('DocCommand')], [Symbol.for('oget'), [Symbol.for('array-list-last'), [Symbol.for('get-field'), Symbol.for('args'), Symbol.for('doc')]], 'has-comments']], [Symbol.for('else'), false]]];
/**
...
estreeHasCommentsP.fsource = [Symbol.for('define'), [Symbol.for('estree-has-comments?'), Symbol.for('node')], [Symbol.for('>'), [Symbol.for('array-list-length'), [Symbol.for('get-field'), Symbol.for('comments'), Symbol.for('node')]], 0]];
/**
...
printEstree.fsource = [Symbol.for('define'), [Symbol.for('print-estree'), Symbol.for('node'), [Symbol.for('options'), [Symbol.for('js-obj')]]], [Symbol.for('print-to-string'), Symbol.for('node'), Symbol.for('options')]];
/**
 * Print a rose tree.
 */
...
printRose.fsource = [Symbol.for('define'), [Symbol.for('print-rose'), Symbol.for('node'), [Symbol.for('options'), [Symbol.for('js-obj')]]], [Symbol.for('print-sexp'), [Symbol.for('send'), Symbol.for('node'), Symbol.for('get-value')], Symbol.for('options')]];
/**
...
printThrowStatement.fsource = [Symbol.for('define'), [Symbol.for('print-throw-statement'), Symbol.for('node'), [Symbol.for('options'), [Symbol.for('js-obj')]]], [Symbol.for('list'), 'throw', Symbol.for('space'), [Symbol.for('print-node'), [Symbol.for('get-field'), Symbol.for('argument'), Symbol.for('node')], Symbol.for('options')], ';']];
/**

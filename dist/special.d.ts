...
declare namespace setqSpecial_ {
    var fsource: (symbol | (symbol | (number | symbol | symbol[])[] | (symbol | (symbol | (symbol | symbol[])[])[])[])[] | (symbol | (symbol | (symbol | (symbol | (symbol | symbol[])[])[])[])[] | (symbol | (symbol | (number | symbol)[])[])[] | (symbol | (number | symbol | (number | symbol | symbol[])[])[])[][])[])[];
}
/**
 * Evaluate a `(set ...)` form.
 */

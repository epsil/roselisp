...
beginSpecial_.lispSource = [Symbol.for('define'), [Symbol.for('begin-special_'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('begin-helper'), [Symbol.for('rest'), Symbol.for('exp')], Symbol.for('env'), Symbol.for('#u')]];
/**
...
defineValuesSpecial_.lispSource = [Symbol.for('define'), [Symbol.for('define-values-special_'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define'), Symbol.for('ids'), [Symbol.for('second'), Symbol.for('exp')]], [Symbol.for('define'), Symbol.for('val'), [Symbol.for('third'), Symbol.for('exp')]], [Symbol.for('define'), Symbol.for('regular-bindings'), [Symbol.for('quote'), []]], [Symbol.for('define'), Symbol.for('rest-binding'), Symbol.for('#u')], [Symbol.for('define'), Symbol.for('result')], [Symbol.for('cond'), [[Symbol.for('symbol?'), Symbol.for('ids')], [Symbol.for('set!'), Symbol.for('rest-binding'), Symbol.for('ids')]], [[Symbol.for('dotted-list?'), Symbol.for('ids')], [Symbol.for('define'), Symbol.for('binding-list'), [Symbol.for('flatten'), Symbol.for('ids')]], [Symbol.for('set!'), Symbol.for('regular-bindings'), [Symbol.for('drop-right'), Symbol.for('binding-list'), 1]], [Symbol.for('set!'), Symbol.for('rest-binding'), [Symbol.for('array-list-last'), Symbol.for('binding-list')]]], [Symbol.for('else'), [Symbol.for('set!'), Symbol.for('regular-bindings'), Symbol.for('ids')]]], [Symbol.for('set!'), Symbol.for('result'), [Symbol.for('eval_'), Symbol.for('val'), Symbol.for('env')]], [Symbol.for('for'), [[Symbol.for('i'), [Symbol.for('range'), 0, [Symbol.for('array-list-length'), Symbol.for('regular-bindings')]]]], [Symbol.for('eval_'), [Symbol.for('quasiquote'), [Symbol.for('define'), [Symbol.for('unquote'), [Symbol.for('aget'), Symbol.for('regular-bindings'), Symbol.for('i')]], [Symbol.for('quote'), [Symbol.for('unquote'), [Symbol.for('aget'), Symbol.for('result'), Symbol.for('i')]]]]], Symbol.for('env')]], [Symbol.for('when'), Symbol.for('rest-binding'), [Symbol.for('eval_'), [Symbol.for('quasiquote'), [Symbol.for('define'), [Symbol.for('unquote'), Symbol.for('rest-binding')], [Symbol.for('quote'), [Symbol.for('unquote'), [Symbol.for('nthcdr'), [Symbol.for('array-list-length'), Symbol.for('regular-bindings')], Symbol.for('result')]]]]], Symbol.for('env')]], Symbol.for('#u')];
/**
...
setValuesSpecial_.lispSource = [Symbol.for('define'), [Symbol.for('set-values-special_'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define'), Symbol.for('ids'), [Symbol.for('second'), Symbol.for('exp')]], [Symbol.for('define'), Symbol.for('val'), [Symbol.for('third'), Symbol.for('exp')]], [Symbol.for('define'), Symbol.for('regular-bindings'), [Symbol.for('quote'), []]], [Symbol.for('define'), Symbol.for('rest-binding'), Symbol.for('#u')], [Symbol.for('define'), Symbol.for('result')], [Symbol.for('cond'), [[Symbol.for('symbol?'), Symbol.for('ids')], [Symbol.for('set!'), Symbol.for('rest-binding'), Symbol.for('ids')]], [[Symbol.for('dotted-list?'), Symbol.for('ids')], [Symbol.for('define'), Symbol.for('binding-list'), [Symbol.for('flatten'), Symbol.for('ids')]], [Symbol.for('set!'), Symbol.for('regular-bindings'), [Symbol.for('drop-right'), Symbol.for('binding-list'), 1]], [Symbol.for('set!'), Symbol.for('rest-binding'), [Symbol.for('array-list-last'), Symbol.for('binding-list')]]], [Symbol.for('else'), [Symbol.for('set!'), Symbol.for('regular-bindings'), Symbol.for('ids')]]], [Symbol.for('set!'), Symbol.for('result'), [Symbol.for('eval_'), Symbol.for('val'), Symbol.for('env')]], [Symbol.for('for'), [[Symbol.for('i'), [Symbol.for('range'), 0, [Symbol.for('array-list-length'), Symbol.for('regular-bindings')]]]], [Symbol.for('eval_'), [Symbol.for('quasiquote'), [Symbol.for('set!'), [Symbol.for('unquote'), [Symbol.for('aget'), Symbol.for('regular-bindings'), Symbol.for('i')]], [Symbol.for('quote'), [Symbol.for('unquote'), [Symbol.for('aget'), Symbol.for('result'), Symbol.for('i')]]]]], Symbol.for('env')]], [Symbol.for('when'), Symbol.for('rest-binding'), [Symbol.for('eval_'), [Symbol.for('quasiquote'), [Symbol.for('set!'), [Symbol.for('unquote'), Symbol.for('rest-binding')], [Symbol.for('quote'), [Symbol.for('unquote'), [Symbol.for('nthcdr'), [Symbol.for('array-list-length'), Symbol.for('regular-bindings')], Symbol.for('result')]]]]], Symbol.for('env')]], Symbol.for('#u')];
/**
...
forSpecial_.lispSource = [Symbol.for('define'), [Symbol.for('for-special_'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define'), Symbol.for('decls'), [Symbol.for('second'), Symbol.for('exp')]], [Symbol.for('define'), Symbol.for('body'), [Symbol.for('drop'), Symbol.for('exp'), 2]], [Symbol.for('define-values'), [Symbol.for('decl1')], Symbol.for('decls')], [Symbol.for('define-values'), [Symbol.for('sym'), Symbol.for('values-expr')], Symbol.for('decl1')], [Symbol.for('define'), Symbol.for('values'), [Symbol.for('eval_'), Symbol.for('values-expr'), Symbol.for('env')]], [Symbol.for('define'), Symbol.for('result'), Symbol.for('#u')], [Symbol.for('try'), [Symbol.for('for'), [[Symbol.for('value'), Symbol.for('values')]], [Symbol.for('try'), [Symbol.for('set!'), Symbol.for('result'), [Symbol.for('eval_'), [Symbol.for('quasiquote'), [Symbol.for('let'), [[[Symbol.for('unquote'), Symbol.for('sym')], [Symbol.for('unquote'), Symbol.for('value')]]], [Symbol.for('unquote-splicing'), Symbol.for('body')]]], Symbol.for('env')]], [Symbol.for('catch'), Symbol.for('ContinueException'), Symbol.for('e')]]], [Symbol.for('catch'), Symbol.for('BreakException'), Symbol.for('e'), [Symbol.for('set!'), Symbol.for('result'), Symbol.for('#u')]]], Symbol.for('result')];
/**
...
jsWhileSpecial_.lispSource = [Symbol.for('define'), [Symbol.for('js-while-special_'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define'), Symbol.for('test'), [Symbol.for('quasiquote'), [Symbol.for('truep'), [Symbol.for('unquote'), [Symbol.for('second'), Symbol.for('exp')]]]]], [Symbol.for('define'), Symbol.for('body'), [Symbol.for('begin-wrap'), [Symbol.for('drop'), Symbol.for('exp'), 2]]], [Symbol.for('define'), Symbol.for('result'), Symbol.for('#u')], [Symbol.for('try'), [Symbol.for('while'), [Symbol.for('eval_'), Symbol.for('test'), Symbol.for('env')], [Symbol.for('try'), [Symbol.for('set!'), Symbol.for('result'), [Symbol.for('eval_'), Symbol.for('body'), Symbol.for('env')]], [Symbol.for('catch'), Symbol.for('ContinueException'), Symbol.for('e')]]], [Symbol.for('catch'), Symbol.for('BreakException'), Symbol.for('e'), [Symbol.for('set!'), Symbol.for('result'), Symbol.for('#u')]]], Symbol.for('result')];
/**
...
provideSpecial_.lispSource = [Symbol.for('define'), [Symbol.for('provide-special_'), Symbol.for('exp'), Symbol.for('env')], Symbol.for('#u')];
/**
...
requireSpecial_.lispSource = [Symbol.for('define'), [Symbol.for('require-special_'), Symbol.for('exp'), Symbol.for('env')], Symbol.for('#u')];
/**
...
colonSpecial_.lispSource = [Symbol.for('define'), [Symbol.for('colon-special_'), Symbol.for('exp'), Symbol.for('env')], Symbol.for('#u')];
/**
...
defineTypeSpecial_.lispSource = [Symbol.for('define'), [Symbol.for('define-type-special_'), Symbol.for('exp'), Symbol.for('env')], Symbol.for('#u')];
/**
...
letJsObjSpecial_.lispSource = [Symbol.for('define'), [Symbol.for('let-js-obj-special_'), Symbol.for('exp'), Symbol.for('env')], Symbol.for('#u')];
/**
...
defineJsObjSpecial_.lispSource = [Symbol.for('define'), [Symbol.for('define-js-obj-special_'), Symbol.for('exp'), Symbol.for('env')], Symbol.for('#u')];
/**
...
setJsObjSpecial_.lispSource = [Symbol.for('define'), [Symbol.for('set-js-obj-special_'), Symbol.for('exp'), Symbol.for('env')], Symbol.for('#u')];
/**

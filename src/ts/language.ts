 ...
 */
function macroexpandAllUntil(exp: any, env: any, pred: any = undefined, stack: any = [], continuationEnv: any = new LispEnvironment()): any {
  function f(x: any, stack: any, continuationEnv: any): any {
    ...
    function predF1(x: any): any {
      const op: any = x[0];
      const bType: any = continuationEnv.getType(op);
...
function compileJsTry(node: any, env: any, options: any = {}): any {
  ...
  if (catchClause) {
    ...
    const bodyCompiled: any = wrapInBlockStatementSmart(compileStatementOrReturnStatement(body, env, options));
 ...
 * in bottom-up order.
 */
function mapRose(f: any, node: any, env: any = new LispEnvironment(), stack: any = [], continuationEnv: any = new LispEnvironment()): any {
  if (!(node instanceof Rose)) {
 ...
 */
function mapVisitRose(f: any, node: any, env: any = new LispEnvironment(), stack: any = [], continuationEnv: any = new LispEnvironment()): any {
  function skipNode(node: any, stack: any, continuationEnv: any): any {
    return node;
  }
  ...
  function visitNode(node: any, stack: any, continuationEnv: any): any {
  ...
  function visitNonatomic(node: any, stack: any, continuationEnv: any, skip: any = 0): any {
    let result: any = visitFormsNode(node, [...stack, node], continuationEnv, skip);
  ...
  function visitFormsNodeWith(visitor: any, node: any, stack: any, continuationEnv: any, skip: any = 0): any {
    let exp: any = node.getValue();
    if (!Array.isArray(exp)) {
      // `node` is not a list expression; early return.
      return visit(visitor, node, stack, continuationEnv);
    }
    const nodes: any = node.getNodes();
    const resultNodes: any = visitFormsListWith(visitor, nodes, stack, continuationEnv, skip);
  ...
  function visitFormsListWith(visitor: any, nodes: any, stack: any, continuationEnv: any, skip: any = 0): any {
    if (!Array.isArray(nodes)) {
      // `nodes` is not a list; early return.
      return visit(visitor, nodes, stack, continuationEnv);
    }
    ...
    let result: any = nodes.map(function (x: any): any {
      if (i < skip) {
        ...
        let x1: any = visit(visitor, x, stack, continuationEnv);
        if (x !== x1) {
          isModified = true;
        }
        i++;
  ...
  function visitFormsNode(node: any, stack: any, continuationEnv: any, skip: any = 0): any {
  ...
  function visitFormsList(nodes: any, stack: any, continuationEnv: any, skip: any = 0): any {
  ...
  function visitClausesNode(node: any, stack: any, continuationEnv: any, skip: any = 0): any {
  ...
  function visitClausesList(nodes: any, stack: any, continuationEnv: any, skip: any = 0): any {
  ...
  function visitModule(node: any, stack: any, continuationEnv: any): any {
  ...
  function visitBegin(node: any, stack: any, continuationEnv: any): any {
  ...
  function visitLet(node: any, stack: any, continuationEnv: any): any {
    let result: any = node;
    let continuationEnv2: any = extendEnvironment(new LispEnvironment(), continuationEnv);
    const sym: any = node.get(0).getValue();
    const letContinuationEnv: any = node.get(1);
    ...
    const visitedLetContinuationEnv: any = visitClausesNode(letContinuationEnv, [...stack, node], continuationEnv2);
    const visitedBody: any = visitFormsList(body, [...stack, node], continuationEnv2);
    if (!((letContinuationEnv === visitedLetContinuationEnv) && (body === visitedBody))) {
      result = transferComments(node, makeRose([sym, visitedLetContinuationEnv, ...visitedBody]));
    }
    return f(result, stack, continuationEnv);
  }
  ...
  function visitLetValues(node: any, stack: any, continuationEnv: any): any {
    let result: any = node;
    let continuationEnv2: any = extendEnvironment(new LispEnvironment(), continuationEnv);
    const sym: any = node.get(0).getValue();
    const letContinuationEnv: any = node.get(1);
    const body: any = node.drop(2);
    const visitedLetContinuationEnv: any = visitFormsNodeWith(function (x: any): any {
      let xResult: any = x;
      ...
      const visitedIds: any = visitFormsNode(ids, [...stack, node], continuationEnv2);
      const visitedVal: any = visit(visitor, val, [...stack, node], continuationEnv2);
  ...
  function visitCond(node: any, stack: any, continuationEnv: any): any {
    let result: any = node;
    const sym: any = node.get(0).getValue();
    const clauses: any = node.drop(1);
    const visitedClauses: any = visitClausesList(clauses, [...stack, node], continuationEnv);
  ...
  function visitLambda(node: any, stack: any, continuationEnv: any): any {
    let result: any = node;
    let continuationEnv2: any = extendEnvironment(new LispEnvironment(), continuationEnv);
    const sym: any = node.get(0).getValue();
    ...
    const visitedParams: any = visitClausesNode(params, [...stack, node], continuationEnv2);
    const visitedBody: any = visitFormsList(body, [...stack, node], continuationEnv2);
  ...
  function visitDefine(node: any, stack: any, continuationEnv: any): any {
    let result: any = node;
    ...
    let continuationEnv2: any = continuationEnv;
    if (Array.isArray(idExp)) {
      ...
      continuationEnv2 = extendEnvironment(new LispEnvironment(), continuationEnv);
    } else {
      continuationEnv.setLocal(idSym, true, 'variable');
    }
    const body: any = node.drop(2);
    const visitedId: any = Array.isArray(idExp) ? visitClausesNode(id, [...stack, node], continuationEnv2) : visitNode(id, [...stack, node], continuationEnv2);
    const visitedBody: any = visitFormsList(body, [...stack, node], continuationEnv2);
  ...
  function visitDefineValues(node: any, stack: any, continuationEnv: any): any {
  ...
  function visitDefmacro(node: any, stack: any, continuationEnv: any): any {
    let result: any = node;
    ...
    const visitedId: any = visitNode(id, [...stack, node], continuationEnv2);
    const visitedParams: any = visitFormsNode(params, [...stack, node], continuationEnv2);
    const visitedBody: any = visitFormsList(body, [...stack, node], continuationEnv2);
  ...
  function visitDefineMacro(node: any, stack: any, continuationEnv: any): any {
    let result: any = node;
  ...
  function visitAnn(node: any, stack: any, continuationEnv: any): any {
  ...
  function visitWhen(node: any, stack: any, continuationEnv: any): any {
    return visitNonatomic(node, stack, continuationEnv, 1);
  }
  ...
  function visitUnless(node: any, stack: any, continuationEnv: any): any {
    return visitNonatomic(node, stack, continuationEnv, 1);
  }
  ...
  function visitQuasiquote(node: any, stack: any, continuationEnv: any): any {
    function visitQuasiquoteForm(node: any, stack: any, continuationEnv: any): any {
      let result: any = node;
      const sym: any = node.get(0);
      let val: any = node.get(1);
      // Visit `unquote` and `unquote-splicing` expressions, if any.
      const visitedVal: any = visit(quasiquoteVisitor, val, stack, continuationEnv);
      if (val !== visitedVal) {
    ...
    function visitQuotedList(node: any, stack: any, continuationEnv: any): any {
 ...
 */
function mapSexp(f: any, exp: any, env: any = new LispEnvironment(), stack: any = [], continuationEnv: any = new LispEnvironment()): any {
  const f1: any = function (x: any, stack: any, continuationEnv: any): any {
    {
      let exp: any = x.getValue();
      ...
      let result: any = f(exp, stack1, continuationEnv);
      if (result === exp) {
        return x;
      } else {
  ...
  let result: any = mapRose(f1, node, env, stack, continuationEnv);

 ...
 */
function makeExpression(node: any): any {
 ...
 */
function makeStatement(node: any): any {
  if (estreeTypeP(node, 'ExpressionStatement')) {
    return node;
  } else {
 ...
 */
function makeReturnStatement(node: any): any {

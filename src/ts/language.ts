...
function compileTypeExp(exp: any, env: any, options: any = {}): any {
  if (typeof exp === 'symbol') {
    ...
    let restParam: any = plistGet_(plist, Symbol.for(':rest'));
    let pos: any = 0;

      ...
      if ((typeof op === 'symbol') && env.hasp(op, {
        ...
        if (undefinedTypeP(opType)) {
          ...
          if (compilerTypeP(compilationType)) {
            ...
            // Compilation macro.
            result = compileSyntax(insertSexpIntoRose(compilationF(exp, env), node1, node1), env, options);
...
function compileArraySet(node: any, env: any, options: any = {}): any {
  ...
  return compileSyntax(insertSexpIntoRose([Symbol.for('set!'), [Symbol.for('array-ref'), arr, ...indices], value], node), env, options);
}
...
function compileCond(node: any, env: any, options: any = {}): any {
  ...
  function wrap(exps: any): any {
    if (exps.length === 1) {
      ...
      return datumToSyntax(false, [Symbol.for('begin'), ...exps]);
    }
  }
  wrap.fsource = [Symbol.for('define'), [Symbol.for('wrap'), Symbol.for('exps')], [Symbol.for('if'), [Symbol.for('='), [Symbol.for('js/length'), Symbol.for('exps')], 1], [Symbol.for('js/first'), Symbol.for('exps')], [Symbol.for('datum->syntax'), false, [Symbol.for('quasiquote'), [Symbol.for('begin'), [Symbol.for('unquote-splicing'), Symbol.for('exps')]]]]]];
  const clauses: any = node.drop(1).slice(0, -1);
  const finalClause: any = node.last();
  const finalExp: any = taggedListP(finalClause, Symbol.for('else')) ? datumToSyntax(false, [(expressionType === 'expression') ? Symbol.for('begin') : Symbol.for('js/block'), ...finalClause.drop(1)]) : datumToSyntax(false, [Symbol.for('if'), finalClause.get(0), wrap(finalClause.drop(1))]);
  const finalExpCompiled: any = transferAndCompileComments(finalClause, compileSyntax(finalExp, env, options), options);
  let result: any = clauses.reduceRight(function (alternate: any, clause: any): any {
    const conditional: any = compileSyntax(datumToSyntax(false, [Symbol.for('if'), clause.get(0), transferComments(clause, wrap(clause.drop(1)))]), env, options);
...
compileCond.fsource = [Symbol.for('define'), [Symbol.for('compile-cond'), Symbol.for('node'), Symbol.for('env'), [Symbol.for('options'), [Symbol.for('js/obj')]]], [Symbol.for('define'), Symbol.for('expression-type'), [Symbol.for('oget'), Symbol.for('options'), Symbol.for(':expression-type')]], [Symbol.for('define'), [Symbol.for('wrap'), Symbol.for('exps')], [Symbol.for('if'), [Symbol.for('='), [Symbol.for('js/length'), Symbol.for('exps')], 1], [Symbol.for('js/first'), Symbol.for('exps')], [Symbol.for('datum->syntax'), false, [Symbol.for('quasiquote'), [Symbol.for('begin'), [Symbol.for('unquote-splicing'), Symbol.for('exps')]]]]]], [Symbol.for('define'), Symbol.for('clauses'), [Symbol.for('~>'), Symbol.for('node'), [Symbol.for('send'), Symbol.for('_'), Symbol.for('drop'), 1], [Symbol.for('drop-right'), Symbol.for('_'), 1]]], [Symbol.for('define'), Symbol.for('final-clause'), [Symbol.for('send'), Symbol.for('node'), Symbol.for('last')]], [Symbol.for('define'), Symbol.for('final-exp'), [Symbol.for('if'), [Symbol.for('tagged-list?'), Symbol.for('final-clause'), [Symbol.for('quote'), Symbol.for('else')]], [Symbol.for('datum->syntax'), false, [Symbol.for('quasiquote'), [[Symbol.for('unquote'), [Symbol.for('if'), [Symbol.for('eq?'), Symbol.for('expression-type'), 'expression'], [Symbol.for('quote'), Symbol.for('begin')], [Symbol.for('quote'), Symbol.for('js/block')]]], [Symbol.for('unquote-splicing'), [Symbol.for('send'), Symbol.for('final-clause'), Symbol.for('drop'), 1]]]]], [Symbol.for('datum->syntax'), false, [Symbol.for('quasiquote'), [Symbol.for('if'), [Symbol.for('unquote'), [Symbol.for('send'), Symbol.for('final-clause'), Symbol.for('get'), 0]], [Symbol.for('unquote'), [Symbol.for('wrap'), [Symbol.for('send'), Symbol.for('final-clause'), Symbol.for('drop'), 1]]]]]]]], [Symbol.for('define'), Symbol.for('final-exp-compiled'), [Symbol.for('transfer-and-compile-comments'), Symbol.for('final-clause'), [Symbol.for('compile-syntax'), Symbol.for('final-exp'), Symbol.for('env'), Symbol.for('options')], Symbol.for('options')]], [Symbol.for('define'), Symbol.for('result'), [Symbol.for('foldr'), [Symbol.for('lambda'), [Symbol.for('clause'), Symbol.for('alternate')], [Symbol.for('define'), Symbol.for('conditional'), [Symbol.for('compile-syntax'), [Symbol.for('datum->syntax'), false, [Symbol.for('quasiquote'), [Symbol.for('if'), [Symbol.for('unquote'), [Symbol.for('send'), Symbol.for('clause'), Symbol.for('get'), 0]], [Symbol.for('unquote'), [Symbol.for('transfer-comments'), Symbol.for('clause'), [Symbol.for('wrap'), [Symbol.for('send'), Symbol.for('clause'), Symbol.for('drop'), 1]]]]]]], Symbol.for('env'), Symbol.for('options')]], [Symbol.for('set-field!'), Symbol.for('alternate'), Symbol.for('conditional'), Symbol.for('alternate')], Symbol.for('conditional')], Symbol.for('final-exp-compiled'), Symbol.for('clauses')]], [Symbol.for('transfer-and-compile-comments'), Symbol.for('node'), Symbol.for('result'), Symbol.for('options')]];
...
function compileDefine(node: any, env: any, options: any = {}): any {
  ...
  if (Array.isArray((Array.isArray(exp) && (exp.length >= 3) && (exp[exp.length - 2] === Symbol.for('.')) && ((): any => {
    ...
    const functionName: any = printEstree(compileSymbol(datumToSyntax(false, nameSym), env, makeExpressionOptions(options)), options);
  ...
  if (regularArgs) {
    for (let arg of regularArgs) {
      if (colonFormP(arg)) {
        ...
        let result: any = ((arg.length === 4) ? new AssignmentPattern(new Identifier(printEstree(compileExpression(datumToSyntax(false, sym), env1, inheritedOptions), inheritedOptions)), compileExpression(datumToSyntax(false, (Array.isArray(arg) && (arg.length >= 3) && (arg[arg.length - 2] === Symbol.for('.')) && ((): any => {
          let x: any = lastCdr(arg);
          return Array.isArray(x) && (x.length === 0);
        })()) ? ((): any => {
          let i: any = 3;
          ...
          return result;
        })() : arg[3]), env1, inheritedOptions)) : new Identifier(printEstree(compileExpression(datumToSyntax(false, sym), env1, inheritedOptions), inheritedOptions))).setType(compileType(typ, env1, options));
        params.push(result);
      } else if (Array.isArray(arg)) {
        makeTypeBinding(env1, arg[0], Symbol.for('Any'), langFilter);
        params.push(new AssignmentPattern(new Identifier(printEstree(compileExpression(datumToSyntax(false, arg[0]), env1, inheritedOptions), inheritedOptions)), compileExpression(datumToSyntax(false, (Array.isArray(arg) && (arg.length >= 3) && (arg[arg.length - 2] === Symbol.for('.')) && ((): any => {
          let x: any = lastCdr(arg);
          return Array.isArray(x) && (x.length === 0);
        })()) ? ((): any => {
          let i: any = 1;
        ...
        params.push(new Identifier(printEstree(compileExpression(datumToSyntax(false, arg), env1, inheritedOptions), inheritedOptions)));
      }
    }
  }
  if (restArg) {
...
function compileDefineValues(node: any, env: any, options: any = {}): any {
  ...
  let i: any = 0;
  if (typeof variables === 'symbol') {
    declaratorId = new Identifier(printEstree(compileSymbol(datumToSyntax(false, variables), env, inheritedOptions), inheritedOptions));
    ...
    varDecls = regularVars.map(function (x: any): any {
      if (x === holeMarker) {
        ...
        return new Identifier(printEstree(compileSymbol(datumToSyntax(false, x), env, inheritedOptions), inheritedOptions));
      }
    });
    if (restVar) {
      const idx: any = i;
      ...
      varDecls.push(new RestElement(new Identifier(printEstree(compileSymbol(datumToSyntax(false, restVar), env, inheritedOptions), inheritedOptions))));
    }
...
function compileSetValues(node: any, env: any, options: any = {}): any {
  ...
  let left: any;
  let right: any;
  declaration = compileDefineValues(datumToSyntax(node, [Symbol.for('define-values'), ...node.drop(1)]), env, inheritedOptions);
...
function compileDefineFields(node: any, env: any, options: any = {}): any {
  ...
  const expressionStatement: any = compileSetFields(datumToSyntax(node, [Symbol.for('set!-fields'), fields, obj]), env, makeStatementOptions(options));
...
function compileSetFields(node: any, env: any, options: any = {}): any {
  const expressionType: any = options['expressionType'];
  return makeExpressionOrStatement(new AssignmentExpression('=', new ObjectPattern(syntaxToList(node.get(1)).map(function (x: any): any {
    let exp: any = syntaxToDatum(x);
    if (Array.isArray(exp)) {
...
function compileQuasiquoteHelper(node: any, env: any, options: any = {}): any {
  ...
  if (!Array.isArray(exp)) {
    ...
    return new ArrayExpression(syntaxToList(node).map(function (x: any): any {
      let exp: any = syntaxToDatum(x);
...
function compileRequire(node: any, env: any, options: any = {}): any {
  ...
  if (fcommonjs) {
    ...
    if (taggedListP(xExp, Symbol.for('only-in'))) {
      for (let x of xNode.drop(2)) {
        ...
        if (Array.isArray(exp)) {
          ...
          let x2Str: any = x2;
          if (typeof x1 === 'symbol') {
            x1Str = printEstree(compileSymbol(datumToSyntax(false, x1), env, options, {
              literalSymbol: true
            }), options);
          }
          if (typeof x2 === 'symbol') {
            x2Str = printEstree(compileSymbol(datumToSyntax(false, x2), env, options, {
              literalSymbol: true
            }), options);
          }
      ...
      if (typeof xExp === 'symbol') {
        xExp = printEstree(compileSymbol(datumToSyntax(false, xExp), env, options, {
          literalSymbol: true
        }), options);
      }
    ...
    if (typeof yExp === 'symbol') {
      yExp = printEstree(compileSymbol(datumToSyntax(false, yExp), env, options, {
        literalSymbol: true
      }), options);
    }
      ...
      for (let x of otherExpressions) {
        ...
        if (taggedListP(exp, Symbol.for('rename-out'))) {
          for (let pair of exp.slice(1)) {
            ...
            if (typeof x1 === 'symbol') {
              x1 = printEstree(compileSymbol(datumToSyntax(false, x1), env, options, {
                literalSymbol: true
              }), options);
            }
            if (typeof x2 === 'symbol') {
              x2 = printEstree(compileSymbol(datumToSyntax(false, x2), env, options, {
                literalSymbol: true
              }), options);
            }
            if (!seen.includes(x2)) {
...
function compileSet(node: any, env: any, options: any = {}): any {
  ...
  if (formp(valExp, add1_, env) && (((Array.isArray(valExp) && (valExp.length >= 3) && (valExp[valExp.length - 2] === Symbol.for('.')) && ((): any => {
    ...
    result = new AssignmentExpression('=', (typeof syntaxToDatum(symNode) === 'symbol') ? compileSymbol(symNode, env, makeExpressionOptions(options)) : compileExpression(symNode, env, options), compileExpression(valNode, env, options));
  }
  return makeExpressionOrStatement(result, options);
}
...
function compileClassHelper(node: any, env: any, options: any = {}): any {
  ...
  if (Array.isArray(bodyExp[0]) && !formp(bodyExp[0], define_, env1)) {
    ...
    if (superClasses.length > 0) {
      superClass = new Identifier(printEstree(compileExpression(datumToSyntax(false, superClasses[0]), env1, inheritedOptions), inheritedOptions));
    }
  }

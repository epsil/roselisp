...
lookupJsValue.fsource = [Symbol.for('define'), [Symbol.for('lookup-js-value'), Symbol.for('name')], [Symbol.for('define'), Symbol.for('str'), [Symbol.for('if'), [Symbol.for('symbol?'), Symbol.for('name')], [Symbol.for('symbol->string'), Symbol.for('name')], Symbol.for('name')]], [Symbol.for('define'), Symbol.for('value'), undefined], [Symbol.for('define'), Symbol.for('found'), false], [Symbol.for('when'), [Symbol.for('and'), [Symbol.for('string?'), Symbol.for('str')], [Symbol.for('regexp-match'), Symbol.for('js-identifier-regexp'), Symbol.for('str')]], [Symbol.for('try'), [Symbol.for('set!'), Symbol.for('value'), [Symbol.for('js/eval'), Symbol.for('str')]], [Symbol.for('set!'), Symbol.for('found'), true], [Symbol.for('catch'), Symbol.for('Error'), Symbol.for('e')]]], [Symbol.for('values'), Symbol.for('value'), Symbol.for('found')]];

...
quoteSpecial_.fsource = [Symbol.for('define'), [Symbol.for('quote-special_'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('text-of-quotation'), Symbol.for('exp')]];
...
function setSpecial_(exp: any, env: any): any {
  ...
  if (formp(sym, env, aget_)) {
    ...
    if (((): any => {
      ...
      env.set(sym, val, Symbol.for('Any'));
    }
    return val;
  }
}
...
function fsetSpecial_(exp: any, env: any): any {
  ...
  env.set(sym, val, [Symbol.for('->*'), Symbol.for(':rest'), Symbol.for('Any'), Symbol.for('Any')]);
  return val;
}

fsetSpecial_.fsource = [Symbol.for('define'), [Symbol.for('fset-special_'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define'), Symbol.for('params'), [Symbol.for('rest'), Symbol.for('exp')]], [Symbol.for('define'), Symbol.for('sym'), [Symbol.for('eval_'), [Symbol.for('first'), Symbol.for('params')], Symbol.for('env')]], [Symbol.for('define'), Symbol.for('val'), [Symbol.for('eval_'), [Symbol.for('second'), Symbol.for('params')], Symbol.for('env')]], [Symbol.for('send'), Symbol.for('env'), Symbol.for('set'), Symbol.for('sym'), Symbol.for('val'), [Symbol.for('quote'), [Symbol.for('->*'), Symbol.for(':rest'), Symbol.for('Any'), Symbol.for('Any')]]], Symbol.for('val')];

/**
 * Evaluate a `(module ...)` form.
 */
function moduleSpecial_(exp: any, env: any): any {
  return tcall(evalT, [Symbol.for('begin'), ...exp.slice(3)], env);
}
...
beginSpecial_.fsource = [Symbol.for('define'), [Symbol.for('begin-special_'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('begin-helper'), [Symbol.for('rest'), Symbol.for('exp')], Symbol.for('env'), undefined]];
...
function beginHelper(expressions: any, env: any, val: any): any {
  if (expressions.length === 0) {
    ...
    return tcall(beginHelper, expressions.slice(1), env, tcall(evalT, expressions[0], env));
  }
}
...
function letStarSpecial_(exp: any, env: any): any {
  ...
  for (let varExp of varExps) {
    if (typeof varExp === 'symbol') {
      bindings.push([varExp, undefined, Symbol.for('Any')]);
    } else {
      bindings.push([varExp[0], undefined, Symbol.for('Any')]);
  ...
  return tcall(evalT, beginExp, combinedEnv);
}
...
defineValuesSpecial_.fsource = [Symbol.for('define'), [Symbol.for('define-values-special_'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define'), Symbol.for('ids'), [Symbol.for('second'), Symbol.for('exp')]], [Symbol.for('define'), Symbol.for('val'), [Symbol.for('third'), Symbol.for('exp')]], [Symbol.for('define'), Symbol.for('regular-bindings'), [Symbol.for('quote'), []]], [Symbol.for('define'), Symbol.for('rest-binding'), undefined], [Symbol.for('define'), Symbol.for('result')], [Symbol.for('cond'), [[Symbol.for('symbol?'), Symbol.for('ids')], [Symbol.for('set!'), Symbol.for('rest-binding'), Symbol.for('ids')]], [[Symbol.for('dotted-list?'), Symbol.for('ids')], [Symbol.for('define'), Symbol.for('binding-list'), [Symbol.for('flatten'), Symbol.for('ids')]], [Symbol.for('set!'), Symbol.for('regular-bindings'), [Symbol.for('drop-right'), Symbol.for('binding-list'), 1]], [Symbol.for('set!'), Symbol.for('rest-binding'), [Symbol.for('array-list-last'), Symbol.for('binding-list')]]], [Symbol.for('else'), [Symbol.for('set!'), Symbol.for('regular-bindings'), Symbol.for('ids')]]], [Symbol.for('set!'), Symbol.for('result'), [Symbol.for('eval_'), Symbol.for('val'), Symbol.for('env')]], [Symbol.for('for'), [[Symbol.for('i'), [Symbol.for('range'), 0, [Symbol.for('array-list-length'), Symbol.for('regular-bindings')]]]], [Symbol.for('eval_'), [Symbol.for('quasiquote'), [Symbol.for('define'), [Symbol.for('unquote'), [Symbol.for('aget'), Symbol.for('regular-bindings'), Symbol.for('i')]], [Symbol.for('quote'), [Symbol.for('unquote'), [Symbol.for('aget'), Symbol.for('result'), Symbol.for('i')]]]]], Symbol.for('env')]], [Symbol.for('when'), Symbol.for('rest-binding'), [Symbol.for('eval_'), [Symbol.for('quasiquote'), [Symbol.for('define'), [Symbol.for('unquote'), Symbol.for('rest-binding')], [Symbol.for('quote'), [Symbol.for('unquote'), [Symbol.for('nthcdr'), [Symbol.for('array-list-length'), Symbol.for('regular-bindings')], Symbol.for('result')]]]]], Symbol.for('env')]], undefined];
...
setValuesSpecial_.fsource = [Symbol.for('define'), [Symbol.for('set-values-special_'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define'), Symbol.for('ids'), [Symbol.for('second'), Symbol.for('exp')]], [Symbol.for('define'), Symbol.for('val'), [Symbol.for('third'), Symbol.for('exp')]], [Symbol.for('define'), Symbol.for('regular-bindings'), [Symbol.for('quote'), []]], [Symbol.for('define'), Symbol.for('rest-binding'), undefined], [Symbol.for('define'), Symbol.for('result')], [Symbol.for('cond'), [[Symbol.for('symbol?'), Symbol.for('ids')], [Symbol.for('set!'), Symbol.for('rest-binding'), Symbol.for('ids')]], [[Symbol.for('dotted-list?'), Symbol.for('ids')], [Symbol.for('define'), Symbol.for('binding-list'), [Symbol.for('flatten'), Symbol.for('ids')]], [Symbol.for('set!'), Symbol.for('regular-bindings'), [Symbol.for('drop-right'), Symbol.for('binding-list'), 1]], [Symbol.for('set!'), Symbol.for('rest-binding'), [Symbol.for('array-list-last'), Symbol.for('binding-list')]]], [Symbol.for('else'), [Symbol.for('set!'), Symbol.for('regular-bindings'), Symbol.for('ids')]]], [Symbol.for('set!'), Symbol.for('result'), [Symbol.for('eval_'), Symbol.for('val'), Symbol.for('env')]], [Symbol.for('for'), [[Symbol.for('i'), [Symbol.for('range'), 0, [Symbol.for('array-list-length'), Symbol.for('regular-bindings')]]]], [Symbol.for('eval_'), [Symbol.for('quasiquote'), [Symbol.for('set!'), [Symbol.for('unquote'), [Symbol.for('aget'), Symbol.for('regular-bindings'), Symbol.for('i')]], [Symbol.for('quote'), [Symbol.for('unquote'), [Symbol.for('aget'), Symbol.for('result'), Symbol.for('i')]]]]], Symbol.for('env')]], [Symbol.for('when'), Symbol.for('rest-binding'), [Symbol.for('eval_'), [Symbol.for('quasiquote'), [Symbol.for('set!'), [Symbol.for('unquote'), Symbol.for('rest-binding')], [Symbol.for('quote'), [Symbol.for('unquote'), [Symbol.for('nthcdr'), [Symbol.for('array-list-length'), Symbol.for('regular-bindings')], Symbol.for('result')]]]]], Symbol.for('env')]], undefined];
...
definePublicSpecial_.fsource = [Symbol.for('define'), [Symbol.for('define-public-special_'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define-special_'), Symbol.for('exp'), Symbol.for('env')]];
...
defineGeneratorSpecial_.fsource = [Symbol.for('define'), [Symbol.for('define-generator-special_'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define-special_'), Symbol.for('exp'), Symbol.for('env')]];
...
defineAsyncSpecial_.fsource = [Symbol.for('define'), [Symbol.for('define-async-special_'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define-special_'), Symbol.for('exp'), Symbol.for('env')]];
...
function defmacroSpecial_(exp: any, env: any): any {
  ...
  env.set(name, macroFn, [Symbol.for('->macro'), Symbol.for(':rest'), Symbol.for('Any'), Symbol.for('Any')]);
  // name
  return macroFn;
}

defmacroSpecial_.fsource = [Symbol.for('define'), [Symbol.for('defmacro-special_'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define'), Symbol.for('name'), [Symbol.for('second'), Symbol.for('exp')]], [Symbol.for('when'), [Symbol.for('list?'), Symbol.for('name')], [Symbol.for('set!'), Symbol.for('name'), [Symbol.for('first'), Symbol.for('name')]]], [Symbol.for('define'), Symbol.for('macro-fn'), [Symbol.for('defmacro->fn'), Symbol.for('exp'), Symbol.for('env')]], [Symbol.for('send'), Symbol.for('env'), Symbol.for('set'), Symbol.for('name'), Symbol.for('macro-fn'), [Symbol.for('quote'), [Symbol.for('->macro'), Symbol.for(':rest'), Symbol.for('Any'), Symbol.for('Any')]]], Symbol.for('macro-fn')];
...
defmacroToFn.fsource = [Symbol.for('define'), [Symbol.for('defmacro->fn'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define'), Symbol.for('macro-fn'), [Symbol.for('defmacro->lambda-form'), Symbol.for('exp')]], [Symbol.for('eval_'), Symbol.for('macro-fn'), Symbol.for('env')]];
...
defineMacroSpecial_.fsource = [Symbol.for('define'), [Symbol.for('define-macro-special_'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define'), Symbol.for('name'), [Symbol.for('car'), [Symbol.for('second'), Symbol.for('exp')]]], [Symbol.for('define'), Symbol.for('macro-fn'), [Symbol.for('define-macro->fn'), Symbol.for('exp'), Symbol.for('env')]], [Symbol.for('send'), Symbol.for('env'), Symbol.for('set'), Symbol.for('name'), Symbol.for('macro-fn'), [Symbol.for('quote'), [Symbol.for('->macro'), Symbol.for(':rest'), Symbol.for('Any'), Symbol.for('Any')]]], Symbol.for('name')];
...
defineMacroToFn.fsource = [Symbol.for('define'), [Symbol.for('define-macro->fn'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define'), Symbol.for('macro-fn'), [Symbol.for('define-macro->lambda-form'), Symbol.for('exp')]], [Symbol.for('eval_'), Symbol.for('macro-fn'), Symbol.for('env')]];
...
forSpecial_.fsource = [Symbol.for('define'), [Symbol.for('for-special_'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define'), Symbol.for('decls'), [Symbol.for('second'), Symbol.for('exp')]], [Symbol.for('define'), Symbol.for('body'), [Symbol.for('drop'), Symbol.for('exp'), 2]], [Symbol.for('define-values'), [Symbol.for('decl1')], Symbol.for('decls')], [Symbol.for('define-values'), [Symbol.for('sym'), Symbol.for('values-expr')], Symbol.for('decl1')], [Symbol.for('define'), Symbol.for('values'), [Symbol.for('eval_'), Symbol.for('values-expr'), Symbol.for('env')]], [Symbol.for('define'), Symbol.for('result'), undefined], [Symbol.for('try'), [Symbol.for('for'), [[Symbol.for('value'), Symbol.for('values')]], [Symbol.for('try'), [Symbol.for('set!'), Symbol.for('result'), [Symbol.for('eval_'), [Symbol.for('quasiquote'), [Symbol.for('let'), [[[Symbol.for('unquote'), Symbol.for('sym')], [Symbol.for('unquote'), Symbol.for('value')]]], [Symbol.for('unquote-splicing'), Symbol.for('body')]]], Symbol.for('env')]], [Symbol.for('catch'), Symbol.for('ContinueException'), Symbol.for('e')]]], [Symbol.for('catch'), Symbol.for('BreakException'), Symbol.for('e'), [Symbol.for('set!'), Symbol.for('result'), undefined]]], Symbol.for('result')];
...
breakSpecial_.fsource = [Symbol.for('define'), [Symbol.for('break-special_'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('throw'), [Symbol.for('new'), Symbol.for('BreakException')]]];
...
continueSpecial_.fsource = [Symbol.for('define'), [Symbol.for('continue-special_'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('throw'), [Symbol.for('new'), Symbol.for('ContinueException')]]];
...
yieldSpecial_.fsource = [Symbol.for('define'), [Symbol.for('yield-special_'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define'), Symbol.for('val'), [Symbol.for('eval_'), [Symbol.for('second'), Symbol.for('exp')], Symbol.for('env')]], Symbol.for('val')];
...
returnSpecial_.fsource = [Symbol.for('define'), [Symbol.for('return-special_'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define'), Symbol.for('val'), [Symbol.for('eval_'), [Symbol.for('second'), Symbol.for('exp')], Symbol.for('env')]], [Symbol.for('throw'), [Symbol.for('new'), Symbol.for('ReturnException'), Symbol.for('val')]]];
...
throwSpecial_.fsource = [Symbol.for('define'), [Symbol.for('throw-special_'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define'), Symbol.for('val'), [Symbol.for('eval_'), [Symbol.for('second'), Symbol.for('exp')], Symbol.for('env')]], [Symbol.for('throw'), Symbol.for('val')]];
...
asyncSpecial_.fsource = [Symbol.for('define'), [Symbol.for('async-special_'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('async'), [Symbol.for('lambda'), Symbol.for('args'), [Symbol.for('apply'), [Symbol.for('eval_'), [Symbol.for('second'), Symbol.for('exp')], Symbol.for('env')], Symbol.for('args')]]]];
...
function condSpecial_(exp: any, env: any): any {
  if (exp.length <= 1) {
    ...
    return tcall(condHelper, (condition === Symbol.for('else')) || tcall(evalT, [Symbol.for('truep'), condition], env), thenExpr, clauses, env);
  }
}

condSpecial_.fsource = [Symbol.for('define'), [Symbol.for('cond-special_'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('cond'), [[Symbol.for('<='), [Symbol.for('array-list-length'), Symbol.for('exp')], 1], false], [Symbol.for('else'), [Symbol.for('define'), Symbol.for('clause'), [Symbol.for('second'), Symbol.for('exp')]], [Symbol.for('define'), Symbol.for('clauses'), [Symbol.for('drop'), Symbol.for('exp'), 2]], [Symbol.for('define'), Symbol.for('condition'), [Symbol.for('first'), Symbol.for('clause')]], [Symbol.for('define'), Symbol.for('then-expr'), [Symbol.for('begin-wrap'), [Symbol.for('rest'), Symbol.for('clause')]]], [Symbol.for('tcall'), Symbol.for('cond-helper'), [Symbol.for('or'), [Symbol.for('eq?'), Symbol.for('condition'), [Symbol.for('quote'), Symbol.for('else')]], [Symbol.for('tcall'), Symbol.for('eval-t'), [Symbol.for('quasiquote'), [Symbol.for('truep'), [Symbol.for('unquote'), Symbol.for('condition')]]], Symbol.for('env')]], Symbol.for('then-expr'), Symbol.for('clauses'), Symbol.for('env')]]]];
...
function condHelper(condition: any, thenExpr: any, clauses: any, env: any): any {
  if (condition) {
    return tcall(evalT, thenExpr, env);
...
andSpecial_.fsource = [Symbol.for('define'), [Symbol.for('and-special_'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define'), Symbol.for('params'), [Symbol.for('rest'), Symbol.for('exp')]], [Symbol.for('define'), Symbol.for('result'), true], [Symbol.for('for'), [[Symbol.for('operand'), Symbol.for('params')]], [Symbol.for('set!'), Symbol.for('result'), [Symbol.for('eval_'), Symbol.for('operand'), Symbol.for('env')]], [Symbol.for('unless'), [Symbol.for('eval_'), [Symbol.for('quasiquote'), [Symbol.for('truep'), [Symbol.for('quote'), [Symbol.for('unquote'), Symbol.for('result')]]]], Symbol.for('env')], [Symbol.for('return'), false]]], Symbol.for('result')];
...
orSpecial_.fsource = [Symbol.for('define'), [Symbol.for('or-special_'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define'), Symbol.for('params'), [Symbol.for('rest'), Symbol.for('exp')]], [Symbol.for('define'), Symbol.for('result'), false], [Symbol.for('for'), [[Symbol.for('operand'), Symbol.for('params')]], [Symbol.for('set!'), Symbol.for('result'), [Symbol.for('eval_'), Symbol.for('operand'), Symbol.for('env')]], [Symbol.for('when'), [Symbol.for('eval_'), [Symbol.for('quasiquote'), [Symbol.for('truep'), [Symbol.for('quote'), [Symbol.for('unquote'), Symbol.for('result')]]]], Symbol.for('env')], [Symbol.for('return'), Symbol.for('result')]]], Symbol.for('result')];
...
dotSpecial_.fsource = [Symbol.for('define'), [Symbol.for('dot-special_'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define'), Symbol.for('obj'), [Symbol.for('eval_'), [Symbol.for('second'), Symbol.for('exp')], Symbol.for('env')]], [Symbol.for('define'), Symbol.for('method'), [Symbol.for('third'), Symbol.for('exp')]], [Symbol.for('define'), Symbol.for('field')], [Symbol.for('define'), Symbol.for('match')], [Symbol.for('cond'), [[Symbol.for('and'), [Symbol.for('symbol?'), Symbol.for('method')], [Symbol.for('set!'), Symbol.for('match'), [Symbol.for('regexp-match'), [Symbol.for('regexp'), '^-(.*)$'], [Symbol.for('symbol->string'), Symbol.for('method')]]]], [Symbol.for('set!'), Symbol.for('field'), [Symbol.for('second'), Symbol.for('match')]], [Symbol.for('eval_'), [Symbol.for('quasiquote'), [Symbol.for('get-field'), [Symbol.for('unquote'), [Symbol.for('string->symbol'), Symbol.for('field')]], [Symbol.for('unquote'), Symbol.for('obj')]]], Symbol.for('env')]], [Symbol.for('else'), [Symbol.for('send-special_'), Symbol.for('exp'), Symbol.for('env')]]]];
...
getFieldSpecial_.fsource = [Symbol.for('define'), [Symbol.for('get-field-special_'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define'), Symbol.for('field'), [Symbol.for('second'), Symbol.for('exp')]], [Symbol.for('define'), Symbol.for('field-name'), [Symbol.for('symbol->string'), Symbol.for('field')]], [Symbol.for('define'), Symbol.for('obj'), [Symbol.for('third'), Symbol.for('exp')]], [Symbol.for('~>'), [Symbol.for('eval_'), Symbol.for('obj'), Symbol.for('env')], [Symbol.for('oget'), Symbol.for('_'), Symbol.for('field-name')]]];
...
setFieldSpecial_.fsource = [Symbol.for('define'), [Symbol.for('set-field-special_'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define'), Symbol.for('field'), [Symbol.for('second'), Symbol.for('exp')]], [Symbol.for('define'), Symbol.for('obj'), [Symbol.for('third'), Symbol.for('exp')]], [Symbol.for('define'), Symbol.for('val'), [Symbol.for('fourth'), Symbol.for('exp')]], [Symbol.for('oset!'), [Symbol.for('eval_'), Symbol.for('obj'), Symbol.for('env')], [Symbol.for('symbol->string'), Symbol.for('field')], [Symbol.for('eval_'), Symbol.for('val'), Symbol.for('env')]]];
...
provideSpecial_.fsource = [Symbol.for('define'), [Symbol.for('provide-special_'), Symbol.for('exp'), Symbol.for('env')], undefined];
...
requireSpecial_.fsource = [Symbol.for('define'), [Symbol.for('require-special_'), Symbol.for('exp'), Symbol.for('env')], undefined];
...
colonSpecial_.fsource = [Symbol.for('define'), [Symbol.for('colon-special_'), Symbol.for('exp'), Symbol.for('env')], undefined];
...
defineTypeSpecial_.fsource = [Symbol.for('define'), [Symbol.for('define-type-special_'), Symbol.for('exp'), Symbol.for('env')], undefined];
...
letFieldsSpecial_.fsource = [Symbol.for('define'), [Symbol.for('let-fields-special_'), Symbol.for('exp'), Symbol.for('env')], undefined];
...
defineFieldsSpecial_.fsource = [Symbol.for('define'), [Symbol.for('define-fields-special_'), Symbol.for('exp'), Symbol.for('env')], undefined];
...
setFieldsSpecial_.fsource = [Symbol.for('define'), [Symbol.for('set-fields-special_'), Symbol.for('exp'), Symbol.for('env')], undefined];
...
letEnvSpecial_.fsource = [Symbol.for('define'), [Symbol.for('let-env-special_'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define'), Symbol.for('params'), [Symbol.for('rest'), Symbol.for('exp')]], [Symbol.for('define'), Symbol.for('body'), [Symbol.for('rest'), Symbol.for('params')]], [Symbol.for('define'), Symbol.for('let-env'), [Symbol.for('eval_'), [Symbol.for('first'), Symbol.for('params')], Symbol.for('env')]], [Symbol.for('define'), Symbol.for('combined-env'), [Symbol.for('new'), Symbol.for('EnvironmentStack'), Symbol.for('let-env'), Symbol.for('env')]], [Symbol.for('eval_'), [Symbol.for('quasiquote'), [Symbol.for('begin'), [Symbol.for('unquote-splicing'), Symbol.for('body')]]], Symbol.for('combined-env')]];
...
macropSpecial_.fsource = [Symbol.for('define'), [Symbol.for('macrop-special_'), Symbol.for('val')], [Symbol.for('eval_'), [Symbol.for('quasiquote'), [Symbol.for('macrop'), [Symbol.for('unquote'), Symbol.for('val')]]], [Symbol.for('current-environment')]]];
...
nlambdaSpecial_.fsource = [Symbol.for('define'), [Symbol.for('nlambda-special_'), Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define'), Symbol.for('f'), [Symbol.for('lambda-special_'), Symbol.for('exp'), Symbol.for('env')]], [Symbol.for('set-field!'), Symbol.for('fexpr'), Symbol.for('f'), true], Symbol.for('f')];

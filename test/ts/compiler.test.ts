...
describe('Global environment', function (): any {
  it('(compile \'(module m scheme (define lst `(,symbol? ,boolean?))) :finline-functions #t)', function (): any {
    return assertEqual(compile([Symbol.for('module'), Symbol.for('m'), Symbol.for('scheme'), [Symbol.for('define'), Symbol.for('lst'), [Symbol.for('quasiquote'), [[Symbol.for('unquote'), Symbol.for('symbol?')], [Symbol.for('unquote'), Symbol.for('boolean?')]]]]], Symbol.for(':finline-functions'), true), 'let [symbolp, booleanp] = (() => {\n' +
  ...
  it('(compile \'(module m scheme (define one-plus-one (apply + \'(1 1)))) :finline-functions #t)', function (): any {
    return assertEqual(compile([Symbol.for('module'), Symbol.for('m'), Symbol.for('scheme'), [Symbol.for('define'), Symbol.for('one-plus-one'), [Symbol.for('apply'), Symbol.for('+'), [Symbol.for('quote'), [1, 1]]]]], Symbol.for(':finline-functions'), true), 'let [_add] = (() => {\n' +
      '  function add_(...args) {\n' +
      '    let result = 0;\n' +
      '    for (let arg of args) {\n' +
      '      result = result + arg;\n' +
  ...
  it('(compile \'(module m scheme (define one-minus-one (apply - \'(1 1)))) :finline-functions #t)', function (): any {
    return assertEqual(compile([Symbol.for('module'), Symbol.for('m'), Symbol.for('scheme'), [Symbol.for('define'), Symbol.for('one-minus-one'), [Symbol.for('apply'), Symbol.for('-'), [Symbol.for('quote'), [1, 1]]]]], Symbol.for(':finline-functions'), true), 'let [_sub] = (() => {\n' +
      '  function sub_(...args) {\n' +
      '    let len = args.length;\n' +
      '    if (len === 0) {\n' +
      '      return 0;\n' +
  ...
  it('(compile \'(module m scheme (define one-minus-one (apply - \'(1 1)))))', function (): any {
    return assertEqual(compile([Symbol.for('module'), Symbol.for('m'), Symbol.for('scheme'), [Symbol.for('define'), Symbol.for('one-minus-one'), [Symbol.for('apply'), Symbol.for('-'), [Symbol.for('quote'), [1, 1]]]]]), 'import {\n' +
      '  _sub\n' +
      '} from \'roselisp\';\n' +
      '\n' +
      'let oneMinusOne = _sub(1, 1);');
  ...
  it('(compile \'(module m scheme (define one-times-one (apply * \'(1 1)))) :finline-functions #t)', function (): any {
    return assertEqual(compile([Symbol.for('module'), Symbol.for('m'), Symbol.for('scheme'), [Symbol.for('define'), Symbol.for('one-times-one'), [Symbol.for('apply'), Symbol.for('*'), [Symbol.for('quote'), [1, 1]]]]], Symbol.for(':finline-functions'), true), 'let [_mul] = (() => {\n' +
      '  function mul_(...args) {\n' +
      '    let result = 1;\n' +
      '    for (let arg of args) {\n' +
      '      result = result * arg;\n' +
  ...
  it('(compile \'(module m scheme (define one-divided-by-one (apply / \'(1 1)))) :finline-functions #t)', function (): any {
    return assertEqual(compile([Symbol.for('module'), Symbol.for('m'), Symbol.for('scheme'), [Symbol.for('define'), Symbol.for('one-divided-by-one'), [Symbol.for('apply'), Symbol.for('/'), [Symbol.for('quote'), [1, 1]]]]], Symbol.for(':finline-functions'), true), 'let [_div] = (() => {\n' +
      '  function div_(...args) {\n' +
      '    if (args.length === 1) {\n' +
      '      return 1 / args[0];\n' +
      '    } else {\n' +
  ...
  it('(compile \'(module m scheme (define foo-bar (apply string-append \'("foo" "bar")))) :finline-functions #t)', function (): any {
    return assertEqual(compile([Symbol.for('module'), Symbol.for('m'), Symbol.for('scheme'), [Symbol.for('define'), Symbol.for('foo-bar'), [Symbol.for('apply'), Symbol.for('string-append'), [Symbol.for('quote'), ['foo', 'bar']]]]], Symbol.for(':finline-functions'), true), 'let [stringAppend] = (() => {\n' +
  ...
  it('(compile \'(module m lisp (define (my-map f x) (map f x)) (define bar (my-map first \'((1) (2) (3))))) :finline-functions #t)', function (): any {
    return assertEqual(compile([Symbol.for('module'), Symbol.for('m'), Symbol.for('lisp'), [Symbol.for('define'), [Symbol.for('my-map'), Symbol.for('f'), Symbol.for('x')], [Symbol.for('map'), Symbol.for('f'), Symbol.for('x')]], [Symbol.for('define'), Symbol.for('bar'), [Symbol.for('my-map'), Symbol.for('first'), [Symbol.for('quote'), [[1], [2], [3]]]]]], Symbol.for(':finline-functions'), true), 'let [first] = (() => {\n' +
      '  function first_(lst) {\n' +
      '    return lst[0];\n' +
      '  }\n' +
      '  return [first_];\n' +
  ...
  it('(compile \'(module m lisp (define (my-cdr x) (cdr x))) :finline-functions #t)', function (): any {
    return assertEqual(compile([Symbol.for('module'), Symbol.for('m'), Symbol.for('lisp'), [Symbol.for('define'), [Symbol.for('my-cdr'), Symbol.for('x')], [Symbol.for('cdr'), Symbol.for('x')]]], Symbol.for(':finline-functions'), true), 'function myCdr(x) {\n' +
  ...
  return it('(compile \'(module m lisp (define (my-intersection x y) (intersection x y))) :finline-functions #t)', function (): any {
    return assertEqual(compile([Symbol.for('module'), Symbol.for('m'), Symbol.for('lisp'), [Symbol.for('define'), [Symbol.for('my-intersection'), Symbol.for('x'), Symbol.for('y')], [Symbol.for('intersection'), Symbol.for('x'), Symbol.for('y')]]], Symbol.for(':finline-functions'), true), 'let [intersection] = (() => {\n' +
...
describe('compile-modules', function (): any {
  it('(module ... (define ...) ...)', function (): any {
    return assertEqual(compileModules([[Symbol.for('module'), Symbol.for('m'), Symbol.for('scheme'), [Symbol.for('define'), [Symbol.for('I'), Symbol.for('x')], Symbol.for('x')]]], compilationEnvironment, {
      language: 'javascript',
      optimize: true
    }), ['function I(x) {\n' +
      '  return x;\n' +
  ...
  it('import macro from another module', function (): any {
    return assertEqual(compileModules([[Symbol.for('module'), Symbol.for('a'), Symbol.for('scheme'), [Symbol.for('defmacro'), Symbol.for('foo'), [Symbol.for('x')], Symbol.for('x')], [Symbol.for('provide'), Symbol.for('foo')]], [Symbol.for('module'), Symbol.for('b'), Symbol.for('scheme'), [Symbol.for('require'), [Symbol.for('only-in'), './a', Symbol.for('foo')]], [Symbol.for('declare-macro'), Symbol.for('foo')], [Symbol.for('define'), [Symbol.for('bar'), Symbol.for('x')], [Symbol.for('foo'), Symbol.for('x')]]]], compilationEnvironment, {
      language: 'javascript',
      optimize: true
  ...
  it('import macro from a module defined later', function (): any {
    return assertEqual(compileModules([[Symbol.for('module'), Symbol.for('a'), Symbol.for('scheme'), [Symbol.for('require'), [Symbol.for('only-in'), './b', Symbol.for('bar')]], [Symbol.for('declare-macro'), Symbol.for('bar')], [Symbol.for('define'), [Symbol.for('foo'), Symbol.for('x')], [Symbol.for('bar'), Symbol.for('x')]]], [Symbol.for('module'), Symbol.for('b'), Symbol.for('scheme'), [Symbol.for('defmacro'), Symbol.for('bar'), [Symbol.for('x')], Symbol.for('x')], [Symbol.for('provide'), Symbol.for('bar')]]], compilationEnvironment, {
      language: 'javascript',
      optimize: true
    }), ['import {\n' +
      '  bar\n' +
  ...
  it('import function for use in a macro', function (): any {
    return assertEqual(compileModules([[Symbol.for('module'), Symbol.for('a'), Symbol.for('scheme'), [Symbol.for('require'), [Symbol.for('only-in'), './b', Symbol.for('baz')]], [Symbol.for('defmacro'), Symbol.for('bar'), [Symbol.for('x')], [Symbol.for('baz'), Symbol.for('x')]], [Symbol.for('define'), [Symbol.for('foo'), Symbol.for('x')], [Symbol.for('bar'), Symbol.for('x')]]], [Symbol.for('module'), Symbol.for('b'), Symbol.for('scheme'), [Symbol.for('define'), [Symbol.for('baz'), Symbol.for('x')], Symbol.for('x')], [Symbol.for('provide'), Symbol.for('baz')]]], compilationEnvironment, {
      language: 'javascript',
      optimize: true
    }), ['import {\n' +
      '  baz\n' +
  ...
  return it('import renamed macro from another module', function (): any {
    return assertEqual(compileModules([[Symbol.for('module'), Symbol.for('a'), Symbol.for('scheme'), [Symbol.for('defmacro'), Symbol.for('foo'), [Symbol.for('x')], Symbol.for('x')], [Symbol.for('provide'), Symbol.for('foo')]], [Symbol.for('module'), Symbol.for('b'), Symbol.for('scheme'), [Symbol.for('require'), [Symbol.for('only-in'), './a', [Symbol.for('foo'), Symbol.for('foo1')]]], [Symbol.for('declare-macro'), Symbol.for('foo1')], [Symbol.for('define'), [Symbol.for('bar'), Symbol.for('x')], [Symbol.for('foo1'), Symbol.for('x')]]]], compilationEnvironment, {
      language: 'javascript',
      optimize: true
    }), ['function foo(exp, env) {\n' +
      '  const [x] = exp.slice(1);\n' +
...
describe('--fsemicolon false', function (): any {
  return it('(compile \'(begin x y z) :fsemicolon #f)', function (): any {
    return assertEqual(compile([Symbol.for('begin'), Symbol.for('x'), Symbol.for('y'), Symbol.for('z')], Symbol.for(':fsemicolon'), false), 'x\n' +
      '\n' +
      'y\n' +
      '\n' +
      'z');
...
describe('compile-with-environment', function (): any {
  ...
  it(';; multi-line\n' +
    ';; comment\n' +
    '(foo)', function (): any {
    return assertEqual(compileWithEnvironment(readSyntax(';; multi-line\n' +
      ';; comment\n' +
      '(foo)'), compilationEnvironment, {
      expressionType: 'statement',
      language: 'javascript',
  ...
  it(';; multiple\n' +
    ...
    ';; comments\n' +
    '(foo)', function (): any {
    return assertEqual(compileWithEnvironment(readSyntax(';; multiple\n' +
      '\n' +
      ';; comments\n' +
      '(foo)'), compilationEnvironment, {
      expressionType: 'statement',
  ...
  it('(+\n' +
    ...
    ' ;; bar\n' +
    ' bar)', function (): any {
    return assertEqual(compileWithEnvironment(readSyntax('(+\n' +
      '            ;; foo\n' +
      '            foo\n' +
      '            ;; bar\n' +
  ...
  it('(list foo\n' +
    ...
    '      ;; baz\n' +
    '      baz)', function (): any {
    return assertEqual(compileWithEnvironment(readSyntax('(list foo\n' +
      '      ;; bar\n' +
      '      bar\n' +
      '      ;; baz\n' +
  ...
  xit('(module m lisp ... (define *lisp-map* \'()))', function (): any {
    return assertEqual(compileWithEnvironment(readSyntax('(module m lisp\n' +
  ...
  it('(: f (-> Number Number)), lambda, comments, TS', function (): any {
    return assertEqual(compileWithEnvironment(readSyntax('(begin\n' +
      '  ;; NN type alias.\n' +
...
describe('definition->macro', function (): any {
  it('(definition->macro \'(define (inc x) (+ x 1)) \'(1))', function (): any {
    return assertEqual(definitionToMacro([Symbol.for('define'), [Symbol.for('inc'), Symbol.for('x')], [Symbol.for('+'), Symbol.for('x'), 1]], [1]), [Symbol.for('+'), 1, 1]);
  });
  it('(definition->macro \'(define (logical-or x) (or x x)) \'(#t))', function (): any {
    return assertEqual(definitionToMacro([Symbol.for('define'), [Symbol.for('logical-or'), Symbol.for('x')], [Symbol.for('or'), Symbol.for('x'), Symbol.for('x')]], [true]), [Symbol.for('or'), true, true]);
  });
  it('(definition->macro \'(define (repeat x) (string-append x x)) \'("1"))', function (): any {
    return assertEqual(definitionToMacro([Symbol.for('define'), [Symbol.for('repeat'), Symbol.for('x')], [Symbol.for('string-append'), Symbol.for('x'), Symbol.for('x')]], ['1']), [Symbol.for('string-append'), '1', '1']);
  });
  it('(definition->macro \'(define (square x) (* x x)) \'(1))', function (): any {
    return assertEqual(definitionToMacro([Symbol.for('define'), [Symbol.for('square'), Symbol.for('x')], [Symbol.for('*'), Symbol.for('x'), Symbol.for('x')]], [1]), [Symbol.for('*'), 1, 1]);
  });
  it('(definition->macro \'(define (square x) (* x x)) \'(x))', function (): any {
    return assertEqual(definitionToMacro([Symbol.for('define'), [Symbol.for('square'), Symbol.for('x')], [Symbol.for('*'), Symbol.for('x'), Symbol.for('x')]], [Symbol.for('x')]), [Symbol.for('*'), Symbol.for('x'), Symbol.for('x')]);
  });
  return xit('(definition->macro \'(define (square x) (* x x)) \'((+ 1 1)))', function (): any {
    return assertEqual(definitionToMacro([Symbol.for('define'), [Symbol.for('square'), Symbol.for('x')], [Symbol.for('*'), Symbol.for('x'), Symbol.for('x')]], [[Symbol.for('+'), 1, 1]]), [[Symbol.for('lambda'), [Symbol.for('x')], [Symbol.for('*'), Symbol.for('x'), Symbol.for('x')]], [Symbol.for('+'), 1, 1]]);
  });
});
...
describe('define-macro->lambda-form', function (): any {
  it('(define-macro->lambda-form \'(define-macro (foo x) x) (js/obj :exp \'exp :env \'env))', function (): any {
    return assertEqual(defineMacroToLambdaForm([Symbol.for('define-macro'), [Symbol.for('foo'), Symbol.for('x')], Symbol.for('x')], {
      exp: Symbol.for('exp'),
      env: Symbol.for('env')
    }), [Symbol.for('lambda'), [Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define-values'), [Symbol.for('x')], [Symbol.for('rest'), Symbol.for('exp')]], Symbol.for('x')]);
  });
  it('(define-macro->lambda-form \'(define-macro (foo &whole expression x) x) (js/obj :env \'env))', function (): any {
    return assertEqual(defineMacroToLambdaForm([Symbol.for('define-macro'), [Symbol.for('foo'), Symbol.for('&whole'), Symbol.for('expression'), Symbol.for('x')], Symbol.for('x')], {
      env: Symbol.for('env')
    }), [Symbol.for('lambda'), [Symbol.for('expression'), Symbol.for('env')], [Symbol.for('define-values'), [Symbol.for('x')], [Symbol.for('rest'), Symbol.for('expression')]], Symbol.for('x')]);
  });
  it('(define-macro->lambda-form \'(define-macro (foo &whole exp &environment env) exp))', function (): any {
    return assertEqual(defineMacroToLambdaForm([Symbol.for('define-macro'), [Symbol.for('foo'), Symbol.for('&whole'), Symbol.for('exp'), Symbol.for('&environment'), Symbol.for('env')], Symbol.for('exp')]), [Symbol.for('lambda'), [Symbol.for('exp'), Symbol.for('env')], Symbol.for('exp')]);
  });
  it('(define-macro->lambda-form \'(define-macro (foo &whole exp &environment env x) x))', function (): any {
    return assertEqual(defineMacroToLambdaForm([Symbol.for('define-macro'), [Symbol.for('foo'), Symbol.for('&whole'), Symbol.for('exp'), Symbol.for('&environment'), Symbol.for('env'), Symbol.for('x')], Symbol.for('x')]), [Symbol.for('lambda'), [Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define-values'), [Symbol.for('x')], [Symbol.for('rest'), Symbol.for('exp')]], Symbol.for('x')]);
  });
  it('(define-macro->lambda-form \'(define-macro (foo &rest x) x) (js/obj :exp \'exp :env \'env))', function (): any {
    return assertEqual(defineMacroToLambdaForm([Symbol.for('define-macro'), [Symbol.for('foo'), Symbol.for('&rest'), Symbol.for('x')], Symbol.for('x')], {
      exp: Symbol.for('exp'),
      env: Symbol.for('env')
    }), [Symbol.for('lambda'), [Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define-values'), Symbol.for('x'), [Symbol.for('rest'), Symbol.for('exp')]], Symbol.for('x')]);
  });
  return it('(define-macro->lambda-form \'(define-macro (foo x &rest y) x) (js/obj :exp \'exp :env \'env))', function (): any {
    return assertEqual(defineMacroToLambdaForm([Symbol.for('define-macro'), [Symbol.for('foo'), Symbol.for('x'), Symbol.for('&rest'), Symbol.for('y')], Symbol.for('x')], {
      exp: Symbol.for('exp'),
      env: Symbol.for('env')
    }), [Symbol.for('lambda'), [Symbol.for('exp'), Symbol.for('env')], [Symbol.for('define-values'), [Symbol.for('x'), Symbol.for('.'), Symbol.for('y')], [Symbol.for('rest'), Symbol.for('exp')]], Symbol.for('x')]);
  });
});
